...
class DsrMainHelper
{
  public:
    /**
     * Create an DsrMainHelper that makes life easier for people who want to
     * install DSR routing to nodes.
     */
    DsrMainHelper();
    ~DsrMainHelper();
    /**
     * \brief Construct an DsrMainHelper from another previously initialized
     * instance (Copy Constructor). \param o object to copy from
     */
