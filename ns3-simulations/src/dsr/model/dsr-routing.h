...
class DsrRouting : public IpL4Protocol
{
  ...
  private:
    ...
    uint32_t m_sendRetries; ///< # of retries have been sent for network
                            ///< acknowledgment
    ...
    Time m_nodeTraversalTime; ///< Time estimated for packet to travel between
                              ///< two nodes
    ...
    Ptr<dsr::DsrRouteCache> m_routeCache; ///< A "drop-front" queue used by the routing layer to
                                          ///< cache routes found.
