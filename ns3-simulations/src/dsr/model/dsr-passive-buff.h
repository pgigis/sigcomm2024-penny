...
class DsrPassiveBuffer : public Object
{
  public:
    ...
    /// destination address in queue. \param entry Buffer Entry \return true on
    /// success adding the Entry.
  ...
  private:
    ...
    /// \return true if an Entry source and Next hop are equal to the Link
    /// parameters
