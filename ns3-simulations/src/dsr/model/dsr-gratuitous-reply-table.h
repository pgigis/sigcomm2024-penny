...
{
/**
 * The gratuitous table entries, it maintains the already sent gratuitous route
 * reply entries. When the node "promiscuously" received a packet destined for
 * other nodes, and inferred a shorter route for the data packet, it will
 * construct a route reply and send back to the source
 */
