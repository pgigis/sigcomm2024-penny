...
class Ipv6StaticRouting : public Ipv6RoutingProtocol
{
  public:
     ...
     * destination \param metric metric of route in case of multiple routes to
     * same destination
     */
     ...
     * \param outputInterfaces the list of output interface indices over which the
     * packet should be sent (excluding the inputInterface).
     */
