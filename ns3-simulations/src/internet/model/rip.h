 ...
 * \defgroup rip RIP
 *
 * The RIP protocol (\RFC{2453}) is a unicast-only IPv4 IGP (Interior Gateway
 ...
 * sending data flows.
 *
 * RIP implements the Bellman-Ford algorithm (although the RFC does not state
...
class Rip : public Ipv4RoutingProtocol
{
  ...
  private:
    /// Container for the network routes - pair RipRoutingTableEntry *, EventId
    /// (update event)
