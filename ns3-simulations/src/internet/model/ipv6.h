...
class Ipv6 : public Object
{
  public:
     ...
     *
     * \returns smart pointer to Ipv6RoutingProtocol object, or null pointer if
     * none
     */
     ...
     * \param address Ipv6InterfaceAddress address to associate with the
     * underlying IPv6 interface \param addOnLinkRoute add on-link route to the
     * network (default true) \returns true if the operation succeeded
     */
     ...
     * \returns the Ipv6InterfaceAddress associated to the interface and
     * addressIndex
     */
     ...
     *
     * If set to true, IPv6 forwarding is enabled for input datagrams on this
     * device
     */
    ...
    /**
     * \brief Register the IPv6 Extensions. Does nothing if the Extensions have
     * been already registered.
     */
    virtual void RegisterExtensions() = 0;

    /**
     * \brief Register the IPv6 Options. Does nothing if the Options have been
     * already registered.
     */
