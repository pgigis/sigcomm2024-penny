...
class IpL4Protocol : public Object
{
  public:
     ...
     * stack. \param icmpSource the source address of the icmp message \param
     * icmpTtl the ttl of the icmp message \param icmpType the 'type' field of the
     * icmp message \param icmpCode the 'code' field of the icmp message \param
     * icmpInfo extra information dependent on the icmp message generated by
     * Icmpv4L4Protocol \param payloadSource the source address of the packet
     * which triggered the icmp message \param payloadDestination the destination
     * address of the packet which triggered the icmp message. \param payload the
     * first 8 bytes of the packet payload which triggered the icmp message.
     */
     ...
     * icmp message \param icmpCode the 'code' field of the icmp message \param
     * icmpInfo extra information dependent on the icmp message generated by
     * Icmpv6L4Protocol \param payloadSource the source address of the packet
     * which triggered the icmp message \param payloadDestination the destination
     * address of the packet which triggered the icmp message. \param payload the
     * first 8 bytes of the packet payload which triggered the icmp message.
     */
