...
class TcpLp : public TcpNewReno
{
  public:
     ...
     * It determines the state of TcpLp and adjusts the congestion window
     * accordingly.
     *
  ...
  protected:
    /**
     * \brief Invokes Congestion Avoidance of TcpNewReno if TcpLp is not within
     * inference.
     *
     * \param tcb internal congestion state
     * \param segmentsAcked count of segments acked
  ...
  private:
    ...
    /**
     * \brief Estimates minimum and maximum One-Way Delays and calculates the
