...
class Ipv4RoutingTableEntry
{
  public:
    ...
    Ipv4RoutingTableEntry(const Ipv4RoutingTableEntry* route);
    /**
     * \return True if this route is a host route (mask of all ones); false
     * otherwise
     */
    bool IsHost() const;
    /**
     * \return True if this route is not a host route (mask is not all ones);
     * false otherwise
     *
     ...
     * parameters. \param dest Ipv4Address of the destination \param nextHop
     * Ipv4Address of the next hop \param interface Outgoing interface
     */
    ...
    /**
     * \return An Ipv4RoutingTableEntry object corresponding to the input
     * parameters. \param dest Ipv4Address of the destination \param interface
     * Outgoing interface
     */
    static Ipv4RoutingTableEntry CreateHostRouteTo(Ipv4Address dest, uint32_t interface);
    /**
     * \return An Ipv4RoutingTableEntry object corresponding to the input
     * parameters. \param network Ipv4Address of the destination network \param
     * networkMask Ipv4Mask of the destination network mask \param nextHop
     * Ipv4Address of the next hop \param interface Outgoing interface
     */
     ...
     * \return An Ipv4RoutingTableEntry object corresponding to the input
     * parameters. \param network Ipv4Address of the destination network \param
     * networkMask Ipv4Mask of the destination network mask \param interface
     * Outgoing interface
     */
    static Ipv4RoutingTableEntry CreateNetworkRouteTo(Ipv4Address network,
                                                      Ipv4Mask networkMask,
 ...
 * \ingroup ipv4Routing
 *
 * \brief A record of an IPv4 multicast route for Ipv4GlobalRouting and
 * Ipv4StaticRouting
 */
class Ipv4MulticastRoutingTableEntry
{
  public:
    ...
    /**
     * \return Ipv4MulticastRoutingTableEntry corresponding to the input
     * parameters. \param origin Source address for the multicast route \param
     * group Group destination address for the multicast route \param
     * inputInterface Input interface that multicast datagram must be received on
     * \param outputInterfaces vector of output interfaces to copy and forward the
     * datagram to
     */
