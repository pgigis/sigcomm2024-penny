...
class Ipv4 : public Object
{
  public:
     ...
     *
     * \returns smart pointer to Ipv4RoutingProtocol object, or null pointer if
     * none
     */
     ...
     * underlying Ipv4 interface \returns true if the operation succeeded
     */
     ...
     *
     * \param device output NetDevice (optionally provided, only to constrain the
     * search) \param dst Destination address to match, if device is provided
  ...
  private:
     ...
     * another interface \param model true for Weak Es Model
     */
     ...
     *
     * RFC1122 term for whether host accepts datagram with a dest. address on
     * another interface \returns true for Weak Es Model activated
     */
