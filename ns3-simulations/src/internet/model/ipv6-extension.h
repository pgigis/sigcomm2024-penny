...
class Ipv6Extension : public Object
{
  public:
     ...
     * \param length the total length of all options (as specified in the
     * extension header) \param ipv6Header the IPv6 header of packet received
     * \param dst destination address of the packet received (i.e. us)
     * \param nextHeader the next header
     * \param stopProcessing true if the packet must not be further processed
     * \param isDropped true if the packet must be dropped
...
class Ipv6ExtensionFragment : public Ipv6Extension
{
  public:
     ...
     * \param fragmentSize the maximal size of the fragment (unfragmentable part +
     * fragmentation header + fragmentable part). \param listFragments the list of
     * fragments.
     */
 ...
 * implement a subclass of this class and add it to an
...
class Ipv6ExtensionRoutingDemux : public Object
{
  public:
     ...
     * \param typeRouting the number of the routing extension to retrieve
     * \return a pointer to a new routing extension header matching IPv6 routing
     * extension
     */
