...
class Ipv6Interface : public Object
{
  public:
    ...
    /**
     * \brief Checks if the address is a Solicited Multicast address for this
     * interface. \param address the address to check. \return true if it is a
  ...
  private:
    ...
    /**
     * \brief Base value used for computing the random reachable time value (in
     * millisecond).
     */
