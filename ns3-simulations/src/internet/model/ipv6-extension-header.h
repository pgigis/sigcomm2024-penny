 ...
 * OptionField::GetSerializedSize () to your
 * IPv6ExtensionHeader::GetSerializedSize () return value. Call
 * OptionField::Serialize and OptionField::Deserialize at the end of your
 * corresponding IPv6ExtensionHeader methods.
 */
class OptionField
{
  public:
