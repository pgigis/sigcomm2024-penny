...
class Ipv4Header : public Header
{
  ...
  public:
     ...
     * Mind that IPv4 "fragment offset" field is 13 bits long and is measured in
     * 8-bytes words. Hence, the function does enforce that the offset is a
     * multiple of 8. \param offsetBytes the ipv4 fragment offset measured in
