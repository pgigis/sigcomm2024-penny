...
class Ipv6RoutingProtocol : public Object
{
  public:
     ...
     *
     * Protocols are expected to implement this method to be notified of the state
     * change of an interface in a node. \param interface the index of the
     * interface we are being notified about
     */
     ...
     * a new address is added to an interface. Typically used to add a 'network
     * route' on an interface. Can be invoked on an up or down interface. \param
     * interface the index of the interface we are being notified about \param
     ...
     *
     * Protocols are expected to implement this method to be notified whenever
     * a new address is removed from an interface. Typically used to remove the
     * 'network route' of an interface. Can be invoked on an up or down interface.
    ...
    /**
     * \brief Typically, invoked directly or indirectly from
     * ns3::Ipv6::SetRoutingProtocol \param ipv6 the ipv6 object this routing
     * protocol is being associated with
     */
