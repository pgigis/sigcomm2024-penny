...
class Icmpv6Echo : public Icmpv6Header
{
  ...
  private:
    /**
     * \brief ID of the packet (to distinguish response between many ping
     * program).
     */
    uint16_t m_id;
...
class Icmpv6OptionLinkLayerAddress : public Icmpv6OptionHeader
{
  public:
    /**
     * \brief Constructor.
     * \param source source hardware address or target hardware address for the
     * option
     */
     ...
     * \brief Constructor.
     * \param source source hardware address or target hardware address for the
     * option \param addr hardware address
     */
