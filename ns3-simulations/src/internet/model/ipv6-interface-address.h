...
class Ipv6InterfaceAddress
{
  public:
    ...
    enum State_e
    {
        TENTATIVE,            /**< Address is tentative, no packet can be sent unless DAD
                                 finished */
        ...
        TENTATIVE_OPTIMISTIC, /**< Address is tentative but we are optimistic so we
                                 can send packet even if DAD is not yet finished */
