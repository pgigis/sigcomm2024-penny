    ...
    static TypeId tid =
        TypeId("ns3::Icmpv6L4Protocol")
            ...
            .AddAttribute("DAD",
                          ...
                          MakeBooleanChecker())
            .AddAttribute("SolicitationJitter",
                          "The jitter in ms a node is allowed to wait before sending any "
                          "solicitation. Some "
                          "jitter aims to prevent collisions. By default, the model will "
                          "wait for a duration "
                          "in ms defined by a uniform random-variable between 0 and "
                          "SolicitationJitter",
            ...
            .AddAttribute("RsMaxRetransmissionCount",
                          ...
                          "Note: RFC 7559 suggest a zero value (infinite). The default is "
                          "4 to avoid "
...
Icmpv6L4Protocol::SendRS(Ipv6Address src, Ipv6Address dst, Address hardwareAddress)
{
    ...
    if (!src.IsAny())
    {
        ...
        {
            NS_LOG_INFO("Preventing RS from being sent or rescheduled because the "
                        "source address "
