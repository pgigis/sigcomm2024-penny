...
class TcpRateOps : public Object
{
  public:
     ...
     * (S)ACK carries some implicit information, such as how many segments have
     * been lost or delivered. These values will be this function input.
     *
    ...
    struct TcpRateSample
    {
        ...
        int32_t m_delivered{0};        //!< The amount of data marked as delivered over
        ...
        Time m_sendElapsed{Seconds(0.0)}; //!< Send time interval calculated from
                                          //!< the most recent packet delivered
        Time m_ackElapsed{Seconds(0.0)};  //!< ACK time interval calculated from the
                                          //!< most recent packet delivered
        uint32_t m_bytesLoss{0};          //!< The amount of data marked as lost from the
                                          //!< most recent ack received
    ...
    struct TcpRateConnection
    {
        ...
        Time m_firstSentTime{Seconds(0)}; //!< The send time of the packet that was
                                          //!< most recently marked as delivered
        ...
        int32_t m_rateDelivered{0};       //!< The amount of data delivered considered to
...
class TcpRateLinux : public TcpRateOps
{
  public:
     ...
     *
     * \param [in] sample The rate sample that will be passed to congestion
     * control algorithms.
     */
