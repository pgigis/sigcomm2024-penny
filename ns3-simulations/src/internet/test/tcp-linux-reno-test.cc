...
class TcpLinuxRenoTestSuite : public TestSuite
{
  public:
        ...
        : TestSuite("tcp-linux-reno-test", UNIT)
    {
        ...
        // size (i.e 1500 bytes) and delayed acknowledgement of 1 and 2 Test the
        // behavior of Congestion Avoidance phase with standard segment size (1500
        // bytes) and delayed acknowledgement of 1 and 2. This should result in the
        // same pattern of segment exchanges as above.
