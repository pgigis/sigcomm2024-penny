...
NetworkNumberAllocatorTestCase::NetworkNumberAllocatorTestCase()
    : TestCase("Make sure the network number allocator is working on some of "
               "network prefixes.")
{
}
...
static Ipv4AddressGeneratorTestSuite g_ipv4AddressGeneratorTestSuite; //!< Static variable for test
                                                                      //!< initialization
