 ...
 * and then to interrogate the method ShouldDrop, dropping the packet
 * accordingly to the returned value.
 */
 ...
 *
 * Set the flags with SetFlagToKill and the number of the packets with such
 * flags which should be killed.
 *
 * \see SetFlagToKill
 * \see SetKillRepeat
 *
