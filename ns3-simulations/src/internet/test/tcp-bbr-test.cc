...
/**
 * \brief Tests whether BBR sets correct value of pacing and cwnd gain based on
 * different state.
 */
...
class TcpBbrTestSuite : public TestSuite
{
  public:
        ...
        : TestSuite("tcp-bbr-test", UNIT)
    {
        ...
        AddTestCase(new TcpBbrCheckGainValuesTest(TcpBbr::BBR_STARTUP,
                                                  4,
                                                  "BBR should enter to STARTUP phase and "
                                                  "set cwnd and pacing gain accordingly"),
                    TestCase::QUICK);

        AddTestCase(new TcpBbrCheckGainValuesTest(TcpBbr::BBR_DRAIN,
                                                  4,
        ...
        AddTestCase(
            new TcpBbrCheckGainValuesTest(TcpBbr::BBR_PROBE_BW,
                                          4,
