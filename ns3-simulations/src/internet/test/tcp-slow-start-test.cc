 ...
 * congestion window. With the knowledge of the number of segments, we can
 * calculate if the value of the cWnd is right. Also, with a fixed delay for
 * each packet, we can know if the timing is correct.
 *
