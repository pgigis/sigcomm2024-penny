  ...
  public:
        ...
        : TestSuite("tcp-bic-test", UNIT)
    {
        ...
        AddTestCase(new TcpBicDecrementTest(
                    ...
                    TestCase::QUICK);
        AddTestCase(new TcpBicDecrementTest(5 * 1446,
                                            1446,
                                            false,
                                            10,
                                            "Bic decrement test: not in fast convergence & "
                                            "cwnd less than lowWindow"),
                    TestCase::QUICK);
        AddTestCase(new TcpBicDecrementTest(15 * 1446,
                                            1446,
                                            false,
                                            10,
                                            "Bic decrement test: not in fast convergence & "
                                            "cwnd greater than lowWindow"),
                    TestCase::QUICK);
    }
};
