...
class Ipv4AddressHelper
{
  public:
     ...
     * counter to the last base value used.  For example, if the network number
     * was set to 192.168.0.0 with a mask of 255.255.255.0 and a base address of
     ...
     * 192.168.0.4, etc., until the 253rd call which would assert due to an
     * address overflow.
     *
