...
class Ipv4InterfaceContainer
{
  public:
    /**
     * \brief Container Const Iterator for pairs of Ipv4 smart pointer / Interface
     * Index.
     */
     ...
     * \param interface interface index of the Ipv4Interface to add to the
     * container
     */
     ...
     * entry std::pair.
     *
     * \param ipInterfacePair the pair of a pointer to Ipv4 object and interface
     * index of the Ipv4Interface to add to the container
     */
     ...
     * of an entry std::pair.
     *
     * \param ipv4Name std:string referring to the saved name of an Ipv4 Object
     * that has been previously named using the Object Name Service. \param
     ...
     *   Ptr<Ipv4Interface> iface =  DynamicCast<Ipv4L3Protocol>
     * (ipv4)->GetInterface (index); \endcode
     */
