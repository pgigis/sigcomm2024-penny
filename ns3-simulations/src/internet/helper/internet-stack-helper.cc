...
static InterfaceStreamMapIpv4 g_interfaceStreamMapIpv4; //!< A mapping of Ipv4/interface pairs to
                                                        //!< ascii streams
...
static InterfaceStreamMapIpv6 g_interfaceStreamMapIpv6; //!< A mapping of Ipv6/interface pairs to
                                                        //!< pcap files
