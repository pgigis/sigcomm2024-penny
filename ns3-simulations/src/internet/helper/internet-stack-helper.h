 ...
 *
 * This section documents the API of the ns-3 internet module. For a generic
 ...
 *  - Ipv4 routing (a list routing object, a global routing object, and a static
 * routing object)
                            ...
                            public AsciiTraceHelperForIpv6
{
  public:
    ...
    /**
     * Aggregate implementations of the ns3::Ipv4, ns3::Ipv6, ns3::Udp, and
     * ns3::Tcp classes onto the provided node.  This method will do nothing if
     * the stacks are already installed, and will not overwrite existing stacks
     * parameters.
     *
     ...
     * ns3::Ipv4, ns3::Ipv6, ns3::Udp, and, ns3::Tcp classes.  This method will do
     * nothing if the stacks are already installed, and will not overwrite
     * existing stacks parameters.
     *
  ...
  private:
     ...
     * @param interface Interface ID on the Ipv4 on which you want to enable
     * tracing.
     ...
     * @param interface Interface ID on the Ipv6 on which you want to enable
     * tracing.
     * @param explicitFilename Treat the prefix as an explicit filename if true
     */
    ...
    /**
     * \brief create an object from its TypeId and aggregates it to the node. Does
     * nothing if an object of the same type is already aggregated to the node.
     * \param node the node
