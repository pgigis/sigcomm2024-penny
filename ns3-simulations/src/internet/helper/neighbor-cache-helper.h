 ...
 *
 * This class is used to populate neighbor cache. Permanent entries will be
 * added on the scope of a channel, a NetDeviceContainer, an InterfaceContainer
 * or globally.
 */
class NeighborCacheHelper
{
  public:
    /**
     * @brief Construct a helper class to make life easier while creating neighbor
     * cache
     */
    NeighborCacheHelper();
    ~NeighborCacheHelper();
    ...
    /**
     * \brief Remove entries generated from NeighborCacheHelper from ARP cache and
     * NDISC cache
     */
    void FlushAutoGenerated() const;

    /**
     * \brief Enable/disable dynamic neighbor cache, auto-generated neighbor cache
     * will update by IP addresses changed when dynamic neighbor cache enabled.
     * User should ensure that the NeighborCacheHelper object persists for the
     * duration of the simulation when dynamic neighbor cache is enabled. \param
     * enable enable state
     */
  ...
  private:
    ...
    /**
     * \brief Update neighbor caches when an address is removed from a
     * Ipv4Interface with auto generated neighbor cache. \param interface the
     * Ipv4Interface that address removed from. \param ifAddr the removed IPv4
     * interface address.
     */
    ...
    /**
     * \brief Update neighbor caches when an address is added to a Ipv4Interface
     * with auto generated neighbor cache. \param interface the Ipv4Interface that
     * address added to. \param ifAddr the added IPv4 interface address.
     */
    ...
    /**
     * \brief Update neighbor caches when an address is removed from a
     * Ipv6Interface with auto generated neighbor cache. \param interface the
     * Ipv6Interface that address removed from. \param ifAddr the removed IPv6
     * interface address.
     */
    ...
    /**
     * \brief Update neighbor cache when an address is added to a Ipv6Interface
     * with auto generated neighbor cache. \param interface the Ipv6Interface that
     * address added to. \param ifAddr the added IPv6 interface address.
     */
    void UpdateCacheByIpv6AddressAdded(const Ptr<Ipv6Interface> interface,
                                       const Ipv6InterfaceAddress ifAddr) const;

    bool m_globalNeighborCache{false}; //!< flag will set true if neighbor caches
                                       //!< were generated for all devices
