                              ...
                              Address macAddress) const
{
    ...
    if (!arpCache)
    {
        NS_LOG_LOGIC("ArpCache doesn't exist, might be a point-to-point NetDevice "
                     "without ArpCache");
        return;
    }
                              ...
                              Address macAddress) const
{
    ...
    if (!ndiscCache)
    {
        NS_LOG_LOGIC("NdiscCache doesn't exist, might be a point-to-point "
                     "NetDevice without NdiscCache");
        return;
    }
