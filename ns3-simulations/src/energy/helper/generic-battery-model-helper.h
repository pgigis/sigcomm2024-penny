...
class GenericBatteryModelHelper : public EnergySourceHelper
{
  public:
     ...
     *
     * \param c The node container.
     * \param bm The battery model that will be install to the nodes in the node
     * container. \returns An EnergySourceContainer which contains all the
     * EnergySources.
     */
    EnergySourceContainer Install(NodeContainer c, BatteryModel bm) const;

    /**
     * This function takes an existing energy source and transform its values to
     * form a group of connected identical cells. The values of the newly formed
     * cell block depends on the connection of the cells defined by the user
     * (number of cells connected in series, number of cells connected in
     * parallel).
     *
    ...
    /**
     * This function takes an existing energy source container and transform the
     * values of each of its containing energy sources to form groups of connected
     * identical cells. The values of the newly formed cell blocks for each energy
     * source depends on the connection of the cells defined by the user (number
     * of cells connected in series, number of cells connected in parallel).
     *
