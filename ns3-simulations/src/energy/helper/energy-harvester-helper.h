...
class EnergyHarvesterHelper
{
  public:
    ...
    /**
     * \param source Pointer to the energy source where EnergyHarvester will be
     * installed. \returns An EnergyHarvesterContainer which contains all the
     * EnergyHarvesters.
     *
    ...
    /**
     * \param sourceContainer List of nodes where EnergyHarvester will be
     * installed. \returns An EnergyHarvesterContainer which contains all the
     * EnergyHarvester.
     *
     ...
     * \returns An EnergyHarvesterContainer which contains all the
     * EnergyHarvesters.
     *
  ...
  private:
    /**
     * \param source Pointer to node where the energy harvester is to be
     * installed. \returns Pointer to the created EnergyHarvester.
     *
     * Child classes of EnergyHarvesterHelper only have to implement this
     * function, to create and aggregate an EnergyHarvester object onto a single
     * node. Rest of the installation process (eg. installing EnergyHarvester on
     * set of nodes) is implemented in the EnergyHarvesterHelper base class.
     */
