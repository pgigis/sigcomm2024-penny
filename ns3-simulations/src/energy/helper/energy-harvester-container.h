...
class EnergyHarvesterContainer : public Object
{
  ...
  public:
     ...
     *
     * Creates a EnergyHarvesterContainer by concatenating
     * EnergyHarvesterContainer b to EnergyHarvesterContainer a.
     *
     * \note Can be used to concatenate 2 Ptr<EnergyHarvester> directly. C++
     * will be calling EnergyHarvesterContainer constructor with
     * Ptr<EnergyHarvester> first.
     */
     ...
     * in the container.
     *
     * \returns An iterator which refers to the first EnergyHarvester in
     * container.
     *
