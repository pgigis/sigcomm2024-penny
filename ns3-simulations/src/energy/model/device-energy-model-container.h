...
class DeviceEnergyModelContainer
{
  ...
  public:
     ...
     *
     * Creates a DeviceEnergyModelContainer by concatenating
     * DeviceEnergyModelContainer b to DeviceEnergyModelContainer a.
     *
     * \note Can be used to concatenate 2 Ptr<DeviceEnergyModel> directly. C++
     * will be calling DeviceEnergyModelContainer constructor with
     * Ptr<DeviceEnergyModel> first.
     */
     ...
     * in the container.
     *
     * \returns An iterator which refers to the first DeviceEnergyModel in
     * container.
     *
     ...
     * in the container.
     *
     * \returns An iterator which refers to the last DeviceEnergyModel in
     * container.
     *
     * DeviceEnergyModels can be retrieved from the container in two ways. First,
     * directly by an index into the container, and second, using an iterator.
