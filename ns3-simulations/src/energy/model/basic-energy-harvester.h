...
class BasicEnergyHarvester : public EnergyHarvester
{
  public:
     ...
     * determines the amount of power that can be harvested by this energy
     * harvester.
     */
  ...
  private:
    ...
    /**
     * \returns m_harvestedPower The power currently provided by the Basic Energy
     * Harvester. Implements DoGetPower defined in EnergyHarvester.
     */
