...
class EnergyHarvester : public Object
{
  public:
     ...
     *
     * This method is called by the energy source connected to the harvester in
     * order to determine the amount of energy that the harvester provided since
     * last update.
     */
  ...
  private:
    ...
    /**
     * This method is called by the GetPower method and it needs to be implemented
     * by the subclasses of the energy harvester. It returns the actual amount of
     * power that is currently provided by the energy harvester.
     *
     * This method should be used to connect the logic behind the particular
     * implementation of the energy harvester with the energy source.
     *
     * \returns Amount of power currently provided by the harvester.
     */
  ...
  private:
    /**
     * Pointer to node containing this EnergyHarvester. Used by helper class to
     * make sure energy harvesters are installed onto the corresponding node.
     */
    Ptr<Node> m_node;

    /**
     * Pointer to the Energy Source to which this EnergyHarvester is connected.
     * Used by helper class to make sure energy harvesters are installed onto the
