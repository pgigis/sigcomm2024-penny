...
class EnvironmentVariable
{
  public:
     ...
     * Note: empty environment variables are not portable (unsupported on
     * Windows).
     *
     * \param [in] variable The environment variable to set.  Note this may not
     * contain the `=` character. \param [in] value The value to set.  Note this
     * must not be an empty string on Windows. \returns \c true if the variable
     ...
     * To set a variable to the empty string use `Set(variable, "")`.
     *
     * \param [in] variable The environment variable to unset.  Note this may not
     * contain the `=` character. \returns \c true if the variable was unset
     * successfully.
     */
