...
// callbacks class and function templates having ObjectBase as template type
// parameter that are required to be instantiated more often (accorging to the
// ClangBuildAnalyzer tool). These classes and functions are explicitly
// instantiated in object-base.cc
