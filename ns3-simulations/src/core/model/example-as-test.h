 ...
 *     static ns3::ExampleAsTestSuite
 * g_modExampleOne("mymodule-example-mod-example-one", "mod-example",
 * NS_TEST_SOURCEDIR, "--arg-one"); static ns3::ExampleAsTestSuite
 * g_modExampleTwo("mymodule-example-mod-example-two", "mod-example",
 * NS_TEST_SOURCEDIR, "--arg-two"); \endcode
 *
