...
class UniformRandomVariable : public RandomVariableStream
{
  public:
     ...
     * \note The upper limit is included in the output range, unlike
     ...
     * \note The upper limit is excluded from the output range, unlike
     * GetInteger().
     */
 ...
 * (); x->SetAttribute ("Mean", DoubleValue (mean)); x->SetAttribute ("Bound",
 * DoubleValue (bound));
 *
 *   double value = x->GetValue ();
 * \endcode
 ...
 *
 *   \f[
 *      \sigma^2 = x_m \frac{1}{(\alpha - 1)(\alpha - 2)} \mbox { for $\alpha >
 * 2$} \f]
 *
...
class ParetoRandomVariable : public RandomVariableStream
{
  public:
    ...
    /**
     * \brief Returns the scale parameter for the Pareto distribution returned by
     * this RNG stream. \return The scale parameter for the Pareto distribution
     * returned by this RNG stream.
     */
    double GetScale() const;

    /**
     * \brief Returns the shape parameter for the Pareto distribution returned by
     * this RNG stream. \return The shape parameter for the Pareto distribution
     * returned by this RNG stream.
     */
    double GetShape() const;

    /**
     * \brief Returns the upper bound on values that can be returned by this RNG
     * stream. \return The upper bound on values that can be returned by this RNG
     * stream.
     */
    double GetBound() const;
  ...
  private:
    /** The scale parameter for the Pareto distribution returned by this RNG
     * stream. */
    double m_scale;

    /** The shape parameter for the Pareto distribution returned by this RNG
     * stream. */
    double m_shape;
 ...
 *                                  \left( \Gamma\left(1 +
 * \frac{1}{k}\right)\right)^2 \right] \f]
 *
...
class WeibullRandomVariable : public RandomVariableStream
{
  public:
    ...
    /**
     * \brief Returns the scale parameter for the Weibull distribution returned by
     * this RNG stream. \return The scale parameter for the Weibull distribution
     * returned by this RNG stream.
     */
    double GetScale() const;

    /**
     * \brief Returns the shape parameter for the Weibull distribution returned by
     * this RNG stream. \return The shape parameter for the Weibull distribution
     * returned by this RNG stream.
     */
    double GetShape() const;
  ...
  private:
    /** The scale parameter for the Weibull distribution returned by this RNG
     * stream. */
    double m_scale;

    /** The shape parameter for the Weibull distribution returned by this RNG
     * stream. */
    double m_shape;
 ...
 * the \c Bound parameter, \f$b\f$, _i.e._ its values are confined to the
 * interval \f$[\mu - b, \mu + b]\f$.  This preserves the mean but decreases the
 * variance.
 *
 * \par Example
 *
...
class NormalRandomVariable : public RandomVariableStream
{
  public:
    ...
    /**
     * \brief Returns the mean value for the normal distribution returned by this
     * RNG stream. \return The mean value for the normal distribution returned by
     * this RNG stream.
     */
    double GetMean() const;

    /**
     * \brief Returns the variance value for the normal distribution returned by
     * this RNG stream. \return The variance value for the normal distribution
     * returned by this RNG stream.
     */
  ...
  private:
    ...
    /** The variance value for the normal distribution returned by this RNG
     * stream. */
    double m_variance;
    ...
    /** The algorithm produces two values at a time. Cache parameters for possible
     * reuse.*/
    double m_v2;
    /** The algorithm produces two values at a time. Cache parameters for possible
     * reuse.*/
 ...
 *      v_2^{\prime} & = & 2 (1 - u_2) - 1     \\
 *      r^{\prime 2} & = & v_1^{\prime 2}  + v_2^{\prime 2}     \\
 *      y^{\prime} & = & v_1^{\prime}\sqrt{\frac{-2 \log(r^{\prime
 * 2})}{r^{\prime 2}}}     \\ x^{\prime} & = & \exp\left(\mu + y^{\prime}
 * \sigma\right)  . \f}
 *
 * which now involves the distances \f$u_1\f$ and \f$u_2\f$ are from 1.
 */
class LogNormalRandomVariable : public RandomVariableStream
{
  public:
    ...
    /**
     * \brief Returns the mu value for the log-normal distribution returned by
     * this RNG stream. \return The mu value for the log-normal distribution
     * returned by this RNG stream.
     */
    double GetMu() const;

    /**
     * \brief Returns the sigma value for the log-normal distribution returned by
     * this RNG stream. \return The sigma value for the log-normal distribution
     * returned by this RNG stream.
     */
  ...
  private:
    ...
    /** The sigma value for the log-normal distribution returned by this RNG
     * stream. */
    double m_sigma;
 ...
 * variables](https://dl.acm.org/doi/10.1145/358407.358414), ACM Transactions on
 * Mathematical Software, Vol. 26, No. 3, Sept. 2000.
 *
 * \par Example
 *
 * Here is an example of how to use this class:
...
class GammaRandomVariable : public RandomVariableStream
{
  public:
    ...
    /**
     * \brief Returns the alpha value for the gamma distribution returned by this
     * RNG stream. \return The alpha value for the gamma distribution returned by
     * this RNG stream.
     */
    double GetAlpha() const;

    /**
     * \brief Returns the beta value for the gamma distribution returned by this
     * RNG stream. \return The beta value for the gamma distribution returned by
     * this RNG stream.
     */
  ...
  private:
    /**
     * \brief Returns a random double from a normal distribution with the
     * specified mean, variance, and bound. \param [in] mean Mean value for the
     * normal distribution. \param [in] variance Variance value for the normal
     * distribution. \param [in] bound Bound on values returned. \return A
 ...
 * \\ \quad x \in [0, +\infty) \f]
 *
 * with mean \f$ \mu = k \lambda \f$ and variance \f$ \sigma^2 = k \lambda^2
 * \f$.
 *
...
class ErlangRandomVariable : public RandomVariableStream
{
  public:
    ...
    /**
     * \brief Returns the k value for the Erlang distribution returned by this RNG
     * stream. \return The k value for the Erlang distribution returned by this
     * RNG stream.
     */
    uint32_t GetK() const;

    /**
     * \brief Returns the lambda value for the Erlang distribution returned by
     * this RNG stream. \return The lambda value for the Erlang distribution
     * returned by this RNG stream.
     */
  ...
  private:
    /**
     * \brief Returns a random double from an exponential distribution with the
     * specified mean and upper bound. \param [in] mean Mean value of the random
     * variables. \param [in] bound Upper bound on values returned. \return A
     * floating point random value.
     */
 ...
 * (); x->SetAttribute ("Mean", DoubleValue (mean)); x->SetAttribute ("Min",
 * DoubleValue (min)); x->SetAttribute ("Max", DoubleValue (max));
 *
 *   double value = x->GetValue ();
 * \endcode
 *
 ...
 *   \f[
 *      x = \left\{ \begin{array}{rl}
 *          a + \sqrt{(1 - u) (b - a) (c - a)} &\mbox{ if $(1 - u) \le (c -
 * a)/(b - a)$} \\ b - \sqrt{u (b - a) (b - c) } &\mbox{ otherwise} \end{array}
 *          \right.
 *   \f]
 *
...
class TriangularRandomVariable : public RandomVariableStream
{
  public:
    ...
    /**
     * \brief Returns the mean value for the triangular distribution returned by
     * this RNG stream. \return The mean value for the triangular distribution
     * returned by this RNG stream.
     */
    double GetMean() const;

    /**
     * \brief Returns the lower bound for the triangular distribution returned by
     * this RNG stream. \return The lower bound for the triangular distribution
     * returned by this RNG stream.
     */
    double GetMin() const;
  ...
  private:
    /** The mean value for the triangular distribution returned by this RNG
     * stream. */
    double m_mean;
...
class ZipfRandomVariable : public RandomVariableStream
{
  public:
    ...
    /**
     * \brief Returns the n value for the Zipf distribution returned by this RNG
     * stream. \return The n value for the Zipf distribution returned by this RNG
     * stream.
     */
    uint32_t GetN() const;

    /**
     * \brief Returns the alpha value for the Zipf distribution returned by this
     * RNG stream. \return The alpha value for the Zipf distribution returned by
     * this RNG stream.
     */
    double GetAlpha() const;
...
class ZetaRandomVariable : public RandomVariableStream
{
  public:
    ...
    /**
     * \brief Returns the alpha value for the zeta distribution returned by this
     * RNG stream. \return The alpha value for the zeta distribution returned by
     * this RNG stream.
     */
    double GetAlpha() const;
...
/**
 * \ingroup randomvariable
 * \brief The Random Number Generator (RNG) that returns a predetermined
 * sequence.
 *
...
class EmpiricalRandomVariable : public RandomVariableStream
{
  public:
     ...
     * \param [in] interpolate If \c true set to interpolation, otherwise
     * sampling. \returns The previous interpolate flag value.
     */
