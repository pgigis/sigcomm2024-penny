...
class TypeId
{
  public:
    ...
    enum AttributeFlag
    {
        ...
        ATTR_SGC = ATTR_GET | ATTR_SET | ATTR_CONSTRUCT, /**< The attribute can be read,
                                                            and written at any time */
    };
    ...
    enum SupportLevel
    {
        ...
        OBSOLETE    /**< Attribute or trace source is not used anymore; simulation
                       fails. */
    };
     ...
     *
     * \param [in] i Index into attribute array
     * \returns The full name associated to the attribute whose index is
     * \pname{i}.
     */
     ...
     * \param [in] help Some help text which describes the purpose of this
     *        attribute
     * \param [in] flags Flags which describe how this attribute can be read
     * and/or written. \param [in] initialValue The initial value for this
     * attribute. \param [in] accessor An instance of the associated
     * AttributeAccessor subclass. \param [in] checker An instance of the
     * associated AttributeChecker subclass. \param [in] supportLevel
     * Support/deprecation status of the attribute. \param [in] supportMsg Upgrade
     * hint if this attribute is no longer supported.  If the attribute is \c
     * DEPRECATED the attribute behavior still exists, but user code should be
     * updated following guidance in the hint.. If the attribute is \c OBSOLETE,
     * the hint should indicate which class the attribute functional has been
     * moved to, or that the functionality is no longer supported. \returns This
     * TypeId instance
     */
    TypeId AddAttribute(std::string name,
                        std::string help,
    ...
    /**
     * Find a TraceSource by name, retrieving the associated
