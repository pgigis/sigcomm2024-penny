 ...
 * \defgroup makeboundcallback MakeBoundCallback from functions bound with up to
 * three arguments.
 *
 ...
 * \tparam isComparable whether this callback component can be compared to
...
class CallbackImpl : public CallbackImplBase
{
  public:
     ...
     * \param components the callback components (callable object and bound
     * arguments)
     */
...
class Callback : public CallbackBase
{
  ...
  public:
     ...
     *
     * \internal
     * We leverage SFINAE to have the compiler discard this constructor when the
     * type of the first argument is a class derived from CallbackBase (i.e., a
     * Callback).
     */
    template <typename T,
  ...
  private:
     ...
     *
     * \internal
     * The integer sequence is 0..N-1, where N is the number of arguments left
     * unbound.
     */
 ...
 *
 * Build Callbacks for class method members which take varying numbers of
