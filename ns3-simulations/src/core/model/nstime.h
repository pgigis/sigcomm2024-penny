 ...
 *  - Min(Time,Time)
 *
 * This class also controls the resolution of the underlying time
 * representation. The resolution is the smallest representable time interval.
...
class Time
{
  ...
  private:
     ...
     *  \param [in] convert Whether to convert existing Time objects to the new
     * resolution.
     */
 ...
 * \param [in] lhs The first value
 * \param [in] rhs The second value
 * \returns \c true if the first input value is less than or equal to the second
 * input value.
 */
inline bool
operator<=(const Time& lhs, const Time& rhs)
 ...
 * \param [in] lhs The first value
 * \param [in] rhs The second value
 * \returns \c true if the first input value is greater than or equal to the
 * second input value.
 */
inline bool
operator>=(const Time& lhs, const Time& rhs)
 ...
 * \param [in] lhs The first value
 * \param [in] rhs The second value
 * \returns \c true if the first input value is less than the second input
 * value.
 */
inline bool
operator<(const Time& lhs, const Time& rhs)
 ...
 * \param [in] lhs The first value
 * \param [in] rhs The second value
 * \returns \c true if the first input value is greater than the second input
 * value.
 */
inline bool
operator>(const Time& lhs, const Time& rhs)
 ...
 *
 *     int64_t i = ratio.GetHigh ();      // Get just the integer part,
 * resulting in truncation
 *
 *     double ratioD = double (ratio);    // Convert to double, with loss of
 * precision \endcode
 *
 * \param [in] lhs The first value
 * \param [in] rhs The second value
