 ...
 * information in a highly robust, energy efficient, simple, and scalable
 * manner.
 *
 ...
 *
 * The Trickle Timer is mainly used to self-regulate the transmission of
 * periodic information (e.g., Router Advertisements) in wireless networks - and
 * particularly in LLNs. In these contexts the frequency of the timer is
 * adjusted according to, e.g., RS multicast messages. Moreover, the redundancy
 * constant can be used to avoid congestion in high density networks.
 *
 * Please refer to \RFC{6206} for a full description and discussion of the
 * Trickle Timer.
 */
class TrickleTimer
{
