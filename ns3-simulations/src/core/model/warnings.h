 ...
 * \ingroup core
 * \def NS_WARNING_POP
 * Pops the diagnostic warning list from the stack, restoring it to the previous
 * state. \sa NS_WARNING_PUSH
 */

/**
 * \ingroup core
 * \def NS_WARNING_PUSH
 * Push the diagnostic warning list to the stack, allowing it to be restored
 * later. \sa NS_WARNING_POP
 */
 ...
 * Save the current warning list and disables the ones about deprecated
 * functions and classes.
 *
 * This macro can be used to silence deprecation warnings and should be used as
 * a last resort to silence the compiler for very specific lines of code. The
 * typical pattern is: \code NS_WARNING_PUSH_DEPRECATED;
