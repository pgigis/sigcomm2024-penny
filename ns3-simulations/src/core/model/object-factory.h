...
class ObjectFactory
{
  public:
     ...
     * name-value pairs \param [in] typeId The name of the TypeId this factory
     * should create. \param [in] args A sequence of name-value pairs of
     * additional attributes to set.
     *
     * The args sequence can be made of any number of pairs, each consisting of a
     * name (of std::string type) followed by a value (of const AttributeValue &
     * type).
     */
     ...
     *
     * \tparam Args \deduced Template type parameter pack for the sequence of
     * name-value pairs \param [in] name The name of the attribute to set. \param
     * [in] value The value of the attribute to set. \param [in] args A sequence
     * of name-value pairs of additional attributes to set.
     *
     * The args sequence can be made of any number of pairs, each consisting of a
     * name (of std::string type) followed by a value (of const AttributeValue &
     * type).
