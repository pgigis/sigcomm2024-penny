 ...
 *      <td class="markdownTableBodyLeft"> `std::priority_queue<,std::vector>`
 * </td> <td class="markdownTableBodyLeft"> Logarithmic  </td> <td
 * class="markdownTableBodyLeft"> Logarithmic </td> <td
 * class="markdownTableBodyLeft"> 24 bytes </td> <td
 * class="markdownTableBodyLeft"> 0 </td>
 * </tr>
 * </table>
 *
 ...
 * Typically, EventId::Ref is called before Insert and SimpleRefCount::Unref is
 * called after a call to one of the Remove methods.
 */
