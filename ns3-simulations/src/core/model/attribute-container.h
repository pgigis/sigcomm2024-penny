...
class AttributeContainerValue : public AttributeValue
{
  public:
     ...
     * \param c Instance of CONTAINER with which to initialize
     * AttributeContainerValue.
     */
     ...
     *
     * \tparam T \deduced the type of the given variable (normally, the argument
     * type of a set method or the type of a data member) \param value the given
     * variable \return true if the given variable was set
     */
    template <typename T>
 ...
 * ns3::AttributeContainerChecker is returned from that function. This is the
 * same pattern as ObjectPtrContainer.
 */
template <class A, char Sep, template <class...> class C>
