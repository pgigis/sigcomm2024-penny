...
main(int argc, char* argv[])
{
    ...
    // obj->SetAttribute ("OnTime", StringValue
    // ("ns3::UniformRandomVariable[A=0.]")); Missing right bracket
    // obj->SetAttribute ("OnTime", StringValue
    // ("ns3::UniformRandomVariable[Min=0.")); Comma delimiter fails
    // obj->SetAttribute ("OnTime", StringValue
    // ("ns3::UniformRandomVariable[Min=0.,Max=1.]")); Incomplete specification
    // obj->SetAttribute ("OnTime", StringValue
    // ("ns3::UniformRandomVariable[Min=0.|Max=]")); Incomplete specification
    // obj->SetAttribute ("OnTime", StringValue
    ...
    // ("ns3::UniformRandomVariable[A=0.]")); Missing right bracket
    // formattingHelper.SetAttribute ("OnTime", StringValue
    // ("ns3::UniformRandomVariable[Min=30.")); Comma delimiter fails
    // formattingHelper.SetAttribute ("OnTime", StringValue
