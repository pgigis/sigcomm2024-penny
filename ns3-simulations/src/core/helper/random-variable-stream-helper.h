...
class RandomVariableStreamHelper
{
  public:
     ...
     * \code
     *    .AddAttribute ("Speed",
     *                "A random variable used to pick the speed of a random
     * waypoint model.",
     ...
     * \param path (possibly wildcarded) path to a RandomVariableStream
     * PointerValue \param stream stream number to set; must be non-negative
     */
