 ...
 * The ns3::AttributeConstructionList is typically createad by an
 * ns3::ObjectFactory and populated by ns3::ObjectFactory::Set.
 *
 ...
 *           <td>Multiple \pname{name}=\pname{value} pairs should be delimited
 * by ';'</td>
 *         </tr>
 *       </table>
 *     </dd>
 ...
 *         <td> The directory where ns3::CommandLine should write its Usage
 * message.</td>
 *       </tr>
 *     </table>
 *   </dd>
 ...
 *       <tr>
 *         <td class="paramname">;</td>
 *         <td>Multiple \pname{name}=\pname{value} pairs should be delimited by
 * ';'</td>
 *       </tr>
 *     </table>
 *   </dd>
 ...
 *
 * Enable logging from specific \pname{component}s, with specified
 * \pname{option}s. See the \ref logging module, or the Logging chapter in the
 * manual for details on what symbols can be used for specifying log level and
 * prefix options.
 *
 * <dl class="params">
 *   <dt>%Parameters</dt>
 ...
 *         <td>Log level and or prefix to enable. Multiple options should be
 * delimited with '|'</td>
 *       </tr>
 *       <tr>
 *         <td class="paramname">:</td>
 *         <td>Multiple logging components can be enabled simultaneously,
 * delimited by ':'</td>
 *       </tr>
 *     </table>
 *   </dd>
 ...
 *
 * See ns3::SystemPath::MakeTemporaryDirectoryName for details on how this
 * environment variable is used to create a temporary directory, and how that
 ...
 *       <tr>
 *         <td class="paramname">path</td>
 *         <td>The absolute path in which to create the temporary
 * directory.</td>
 *       </tr>
 *     </table>
 *   </dd>
