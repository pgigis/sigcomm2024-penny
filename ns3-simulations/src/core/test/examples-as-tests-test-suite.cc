 ...
 *
 * Runs several examples as tests in order to test ExampleAsTestSuite and
 * ExampleAsTestCase.
 */
namespace ns3
{
 ...
 * Tests multiple examples in a single TestSuite using AddTestCase to add the
 * examples to the suite.
 */
 ...
 *
 * Tests ExampleTestSuite which runs a single example as test suite as specified
