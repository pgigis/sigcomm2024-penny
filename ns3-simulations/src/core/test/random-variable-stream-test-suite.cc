...
class TestCaseBase : public TestCase
{
  public:
     ...
     * \param [in] underflow If \c true the lowest bin should contain the
     * underflow, \param [in] overflow If \c true the highest bin should contain
     * the overflow. \returns A vector of the bin edges, including the top of the
     * highest bin. This vector has one more entry than the number of bins in the
     * histogram.
     */
    ...
    /**
     * Factory class to create new instances of a particular random variable
     * stream.
     *
     ...
     *   NS_GLOBAL_VALUE="RngSeed=3" ./test.py -s
     * random-variable-stream-generators or equivalently (to see log output):
     *   NS_LOG="RandomVariableStreamGenerators" NS_GLOBAL_VALUE="RngSeed=3" ./ns3
     * run "test-runner
...
UniformTestCase::DoRun()
{
    ...
    // [UNIFORM_INTEGER_MAX, UNIFORM_INTEGER_MAX] should return
    // UNIFORM_INTEGER_MAX
...
/**
 * \ingroup rng-tests
 * Test case for antithetic uniform distribution random variable stream
 * generator
 */
...
/**
 * \ingroup rng-tests
 * Test case for antithetic exponential distribution random variable stream
 * generator
 */
...
/**
 * \ingroup rng-tests
 * Test case for antithetic Weibull distribution random variable stream
 * generator
 */
...
/**
 * \ingroup rng-tests
 * Test case for antithetic log-normal distribution random variable stream
 * generator
 */
...
/**
 * \ingroup rng-tests
 * Test case for antithetic empirical distribution random variable stream
 * generator
 */
