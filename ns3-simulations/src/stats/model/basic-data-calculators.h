...
// including this header file from implicitly instantiating
// CounterCalculator<uint32_t>. This would cause some examples on Windows to
// crash at runtime with the following error message: "Trying to allocate twice
// the same UID: ns3::CounterCalculator<uint32_t>"
