 ...
 *
 * The statistics module includes some useful features to ease data collection
 * from experiments. In particular the following features are included: <ul>
 * <li> The core framework and two basic data collectors: A counter, and a
 * min/max/avg/total observer.</li> <li> Extensions of those to easily work with
 * times and packets.</li> <li> Plaintext output formatted for OMNet++.</li>
 * <li> Database output using SQLite, a standalone, lightweight, high
 * performance SQL engine.</li> <li> Mandatory and open ended metadata for
