...
class DataOutputCallback
{
  public:
     ...
     * \param variable Name of the variable for which statistics are being
     * provided \param statSum Pointer to a StatisticalSummary object
     */
    ...
    /**
     * Associates the integer value with the variable name for a specific output
     * format \param key Key value of a DataCalculator \param variable Name of the
     * variable for which statistics are being provided \param val Value to be
     * stored
     */
    virtual void OutputSingleton(std::string key, std::string variable, int val) = 0;

    /**
     * Associates the uint32_t value with the variable name for a specific output
     * format \param key Key value of a DataCalculator \param variable Name of the
     * variable for which statistics are being provided \param val Value to be
     * stored
     */
    ...
    /**
     * Associates the double value with the variable name for a specific output
     * format \param key Key value of a DataCalculator \param variable Name of the
     * variable for which statistics are being provided \param val Value to be
     * stored
     */
    ...
    /**
     * Associates the string value with the variable name for a specific output
     * format \param key Key value of a DataCalculator \param variable Name of the
     * variable for which statistics are being provided \param val Value to be
     * stored
     */
    ...
    /**
     * Associates the Time value with the variable name for a specific output
     * format \param key Key value of a DataCalculator \param variable Name of the
     * variable for which statistics are being provided \param val Value to be
     * stored
     */
