...
class RerrHeader : public Header
{
  public:
    ...
    /**
     * \brief Delete pair (address + sequence number) from REER header, if the
     * number of unreachable destinations > 0 \param un unreachable pair (address
     * + sequence number) \return true on success
     */
