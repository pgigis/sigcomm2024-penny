...
class RoutingTableEntry
{
  public:
    ...
    /**
     * Inserts precursors in output parameter prec if they do not yet exist in
     * vector \param prec vector of precursor addresses
     */
...
class RoutingTable
{
  public:
     ...
     * blacklistTimeout period) \param neighbor neighbor address link to which
