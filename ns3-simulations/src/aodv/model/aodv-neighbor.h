...
class Neighbors
{
  public:
     ...
     * return 0. \param addr the IP address of the neighbor node \returns the
     * expire time for the neighbor node
     */
     ...
     * entry \param addr the IP address to check \param expire the expire time for
     * the address
     */
