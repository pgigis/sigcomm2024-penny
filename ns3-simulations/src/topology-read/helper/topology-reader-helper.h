 ...
 * \ingroup topology
 *
 * \brief Helper class which makes it easier to configure and use a generic
 * TopologyReader.
 */
class TopologyReaderHelper
{
  public:
    ...
    /**
     * \brief Sets the input file type. Supported file types are "Orbis", "Inet",
     * "Rocketfuel". \param [in] fileType The input file type.
     */
