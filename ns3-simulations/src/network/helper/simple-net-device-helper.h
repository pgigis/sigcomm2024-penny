...
class SimpleNetDeviceHelper
{
  public:
     ...
     * SimpleNetDeviceHelper::SetChannelAttribute, an ns3::SimpleNetDevice with
     * the attributes configured by SimpleNetDeviceHelper::SetDeviceAttribute and
     * then adds the device to the node and attaches the channel to the device.
     *
    ...
    /**
     * This method creates an ns3::SimpleNetDevice with the attributes configured
     * by SimpleNetDeviceHelper::SetDeviceAttribute and then adds the device to
    ...
    /**
     * This method creates an ns3::SimpleChannel with the attributes configured by
     * SimpleNetDeviceHelper::SetChannelAttribute.  For each Ptr<node> in the
     * provided container: it creates an ns3::SimpleNetDevice (with the attributes
     * configured by SimpleNetDeviceHelper::SetDeviceAttribute); adds the device
     ...
     * SimpleNetDeviceHelper::SetDeviceAttribute); adds the device to the node;
  ...
  private:
    ...
    bool m_pointToPointMode;        //!< Install PointToPoint SimpleNetDevice or
                                    //!< Broadcast ones
