...
class ApplicationContainer
{
  public:
     ...
     * \endcode
     *
     * \returns an iterator which refers to the first Application in the
     * container.
     */
     ...
     * their Application::SetStartTime() methods with the provided start Time,
     * plus a jitter value drawn from the provided random variable.
     *
     * \param start The Time at which each of the applications should start.
