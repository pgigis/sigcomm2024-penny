...
class NetDeviceContainer
{
  public:
     ...
     * Ptr<NetDevice> will be passed to this constructor instead of
     * NetDeviceContainer&. C++ will notice the implicit conversion path that goes
     * through the NetDeviceContainer (Ptr<NetDevice> dev) constructor above.
     * Using this conversion one may provide optionally provide arguments of
     * Ptr<NetDevice> to these constructors.
     */
