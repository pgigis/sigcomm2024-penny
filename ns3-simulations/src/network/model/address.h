 ...
 * type, a class must implement three public functions: \code static T
 * ConvertFrom(const Address& address); Address ConvertTo() const; operator
 * Address() const; \endcode
 *
