 ...
 *                        |-------------------^ m_zeroAreaStart
 *                        |-----------------------------^ m_end - (m_zeroAreaEnd
 * - m_zeroAreaStart) Virtual byte buffer: |xxxxxxxxxxxx0000000000000.........|
 *                        |--------^ m_start
 *                        |--------------------^ m_zeroAreaStart
 *                        |---------------------------------^ m_zeroAreaEnd
 *                        |------------------------------------------^ m_end
  ...
  public:
    ...
    class Iterator
    {
      public:
         ...
         *
         * Write the data in buffer and advance the iterator position
         * by four bytes. The data is written in least significant byte order and
         * the input data is expected to be in host order.
         */
         ...
         *
         * Write the data in buffer and advance the iterator position
         * by eight bytes. The data is written in least significant byte order and
         * the input data is expected to be in host order.
         */
         ...
         * Read data and advance the Iterator by the number of bytes
         * read.
         * The data is read in least significant byte format and returned in host
         * format.
         */
    ...
    /**
     * Copy the specified amount of data from the buffer to the given output
     * stream.
     *
     * @param os the output stream
     * @param size the maximum amount of bytes to copy. If zero, nothing is
     * copied.
     */
