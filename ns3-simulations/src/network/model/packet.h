  ...
  public:
    ...
    class Item
    {
      public:
        ...
        /**
         * \brief Read the requested tag and store it in the user-provided tag
         * instance.
         *
...
class Packet : public SimpleRefCount<Packet>
{
  public:
    ...
    /**
     * \brief Returns the the size in bytes of the packet (including the
     * zero-filled initial payload).
     *
    ...
    /**
     * \brief Deserialize but does _not_ remove the header from the internal
     * buffer.
     * s
     ...
     *
     * \param trailer a reference to the trailer to remove from the internal
     * buffer. \returns the number of bytes removed from the end of the packet.
     */
    uint32_t RemoveTrailer(Trailer& trailer);
    /**
     * \brief Deserialize but does _not_ remove a trailer from the internal
     * buffer.
     *
     ...
     *
     * \returns one if all data were serialized, zero if buffer size was too
     * small.
     */
    ...
    /**
     * \brief Returns an iterator over the set of byte tags included in this
     * packet
     *
