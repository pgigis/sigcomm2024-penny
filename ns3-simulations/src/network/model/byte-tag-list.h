...
class ByteTagList
{
  public:
    ...
    class Iterator
    {
      public:
        ...
        struct Item
        {
            ...
            int32_t start; //!< offset to the start of the tag from the virtual byte
                           //!< buffer
        ...
        /**
         * \brief Returns the offset from the start of the virtual byte buffer to
         * the ByteTagList
         *
      ...
      private:
         ...
         * \param end End tag
         * \param offsetStart offset to the start of the tag from the virtual byte
         * buffer \param offsetEnd offset to the end of the tag from the virtual
         * byte buffer \param adjustment adjustment to byte tag offsets
         */
        ...
        int32_t m_offsetStart; //!< Offset to the start of the tag from the virtual
                               //!< byte buffer
        int32_t m_offsetEnd;   //!< Offset to the end of the tag from the virtual
                               //!< byte buffer
     ...
     * \param start offset which uniquely identifies the first byte tagged by this
     * tag. \param end offset which uniquely identifies the last byte tagged by
     * this tag. \returns a buffer which can be used to write the tag data.
     *
     *
     */
     ...
     * \returns an iterator
     *
     * The returned iterator will allow you to loop through the set of tags
     * present in this list: the boundaries of each tag as reported by their start
     * and end offsets will be included within the input offsetStart and
     * offsetEnd.
     */
