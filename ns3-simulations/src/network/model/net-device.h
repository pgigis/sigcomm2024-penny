 ...
 *     + set the number of device transmission queues (and optionally create
 * them) through the netdevice queue interface, if the device is multi-queue
...
class NetDevice : public Object
{
  public:
     ...
     * (broadcast/multicast/unicast/otherhost) \returns true if the callback could
     * handle the packet successfully, false otherwise.
     */
