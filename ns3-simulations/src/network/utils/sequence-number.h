...
class SequenceNumber
{
  public:
    ...
    /**
     * \brief Constructs a SequenceNumber from an assignment of another sequence
     * number \param value sequence number to copy \returns reference to the
     * assignee
     */
  ...
  operator NUMERIC_TYPE () const
  {
    ...
    /**
     * \brief Subtraction operator for subtracting numeric value from sequence
     * number \param delta value to subtract from sequence number \returns
    ...
    /**
     * \brief Subtraction operator for subtracting sequence number from sequence
     * number \param other sequence number to subtract from this sequence number
