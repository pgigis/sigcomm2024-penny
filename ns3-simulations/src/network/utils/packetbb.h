...
class PbbTlvBlock
{
  public:
    ...
    /**
     * \brief Pretty-prints the contents of this block, with specified
     * indentation. \param os a stream object to print to. \param level level of
     * indentation.
     *
...
class PbbPacket : public SimpleRefCount<PbbPacket, Header>
{
  public:
     ...
     *        includes last).
     * \param first an Iterator pointing to the first message to erase
     * (inclusive). \param last an Iterator pointing to the element past the last
     * message to erase. \return an iterator pointing to the next message in the
     * block.
     */
