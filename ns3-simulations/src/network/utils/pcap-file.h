...
class PcapFile
{
  ...
  public:
    ...
    /**
     * \return true if the 'fail' bit is set in the underlying iostream, false
     * otherwise.
     */
    bool Fail() const;
    /**
     * \return true if the 'eof' bit is set in the underlying iostream, false
     * otherwise.
     */
    bool Eof() const;
    /**
     ...
     * selected as a binary file (fstream::binary is automatically ored with the
     * mode field).
     *
    ...
    /**
     * \brief Returns the magic number of the pcap file as defined by the
     * magic_number field in the pcap global header.
     *
    ...
    /**
     * \brief Returns the major version of the pcap file as defined by the
     * version_major field in the pcap global header.
     *
     * See http://wiki.wireshark.org/Development/LibpcapFileFormat
     *
    ...
    /**
     * \brief Returns the minor version of the pcap file as defined by the
     * version_minor field in the pcap global header.
     *
     * See http://wiki.wireshark.org/Development/LibpcapFileFormat
     *
    ...
    /**
     * \brief Returns the time zone offset of the pcap file as defined by the
     * thiszone field in the pcap global header.
     *
     * See http://wiki.wireshark.org/Development/LibpcapFileFormat
     *
     ...
     * \param sec [out] Time stamp of first different packet, seconds. Undefined
     * if files don't differ. \param usec [out] Time stamp of first different
     * packet, microseconds. Undefined if files don't differ. \param packets
     * [out] Number of first different packet. Total number of parsed packets if
     * files don't differ.
  ...
  private:
    ...
    struct PcapFileHeader
    {
        ...
        uint16_t m_versionMajor; //!< Major version identifying the version of pcap
                                 //!< used in this file
        uint16_t m_versionMinor; //!< Minor version identifying the version of pcap
                                 //!< used in this file
        int32_t m_zone;          //!< Time zone correction to be applied to timestamps of
                                 //!< packets
    ...
    struct PcapRecordHeader
    {
        ...
        uint32_t m_tsUsec;  //!< microseconds part of timestamp (nsecs for
                            //!< PCAP_NSEC_MAGIC)
