...
class DataRate
{
  public:
     ...
     *
     * Construct a data rate from a string.  Many different unit strings are
     * supported Supported unit strings: bps, b/s, Bps, B/s \n kbps, kb/s, Kbps,
     * Kb/s, kBps, kB/s, KBps, KB/s, Kib/s, KiB/s \n Mbps, Mb/s, MBps, MB/s,
 ...
 *
 * Calculates the number of bits that have been transmitted over a period of
 * time \param lhs rate \param rhs time \return the number of bits over the
 * period of time
 */
 ...
 *
 * Calculates the number of bits that have been transmitted over a period of
 * time \param lhs time \param rhs rate \return the number of bits over the
 * period of time
 */
