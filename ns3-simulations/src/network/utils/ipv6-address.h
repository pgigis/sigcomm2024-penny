...
class Ipv6Address
{
  public:
     ...
     * \param address the C-string containing the IPv6 address (e.g.
     * 2001:660:4701::1).
     */
     ...
     * \param buf the output buffer to which this address gets overwritten with
     * this Ipv6Address
     */
    ...
    /**
     * \return true if address is initialized (i.e., set to something), false
     * otherwise
     */
    ...
    /**
     * \brief Get the "all-1" IPv6 address
     * (ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff). \return all-1 Ipv6Address
     * representation
     */
  ...
  private:
    ...
    bool m_initialized; //!< IPv6 address has been explicitly initialized to a
                        //!< valid value.
...
class Ipv6Prefix
{
  public:
    ...
    /**
     * \brief Get the minimum prefix length, i.e., 128 - the length of the largest
     * sequence trailing zeroes. \return minimum prefix length
     */
