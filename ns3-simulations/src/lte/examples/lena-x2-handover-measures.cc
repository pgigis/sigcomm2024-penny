...
/**
 * Sample simulation script for an automatic X2-based handover based on the RSRQ
 * measures. It instantiates two eNodeB, attaches one UE to the 'source' eNB.
...
main(int argc, char* argv[])
{
    ...
    // X2-based Handover
    // lteHelper->HandoverRequest (Seconds (0.100), ueLteDevs.Get (0),
