...
class LteRrcSap
{
  public:
    ...
    struct ReportConfigEutra
    {
        ...
        enum
        {
            ...
            EVENT_A3, ///< Event A3: Neighbour becomes amount of offset better than
                      ///< PCell.
            EVENT_A4, ///< Event A4: Neighbour becomes better than absolute
                      ///< threshold.
            EVENT_A5  ///< Event A5: PCell becomes worse than absolute `threshold1`
                      ///< AND Neighbour becomes better than another absolute
                      ///< `threshold2`.
    ...
    struct AsConfig
    {
        ...
        SystemInformationBlockType1 sourceSystemInformationBlockType1; ///< source system
                                                                       ///< information block type 1
        SystemInformationBlockType2 sourceSystemInformationBlockType2; ///< source system
    ...
    struct PhysicalConfigDedicatedSCell
    {
        ...
        bool crossCarrierSchedulingConfig;         ///< currently implemented as boolean
                                                   ...
                                                   ///< crossCarrierScheduling is out of
