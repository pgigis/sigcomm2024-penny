...
class RrcAsn1Header : public Asn1Header
{
  ...
  protected:
     ...
     *
     * \param nonCriticalExtensionConfiguration
     ...
     *
     * \param radioResourceConfigDedicated LteRrcSap::RadioResourceConfigDedicated
     * * \param bIterator buffer iterator \returns buffer iterator
     */
    ...
    /**
     * This function prints RadioResourceConfigDedicated IE, for debugging
     * purposes.
     * @param os The output stream to use (i.e. std::cout)
...
/**
 * This class manages the serialization/deserialization of RrcConnectionRequest
 * IE
 */
class RrcConnectionRequestHeader : public RrcUlCcchMessage
{
  public:
    ...
    /**
     * Receives a RrcConnectionRequest IE and stores the contents into the class
     * attributes
...
class RrcConnectionSetupHeader : public RrcDlCcchMessage
{
  public:
    ...
    /**
     * Receives a RrcConnectionSetup IE and stores the contents into the class
     * attributes
     * @param msg The information element to parse
     */
...
/**
 * This class manages the serialization/deserialization of
 * RrcConnectionSetupComplete IE
 */
class RrcConnectionSetupCompleteHeader : public RrcUlDcchMessage
{
  public:
    ...
    /**
     * Receives a RrcConnectionSetupCompleted IE and stores the contents into the
     * class attributes
     * @param msg The information element to parse
     */
    ...
    /**
     * Returns a RrcConnectionSetupCompleted IE from the values in the class
     * attributes
...
class RrcConnectionReconfigurationCompleteHeader : public RrcUlDcchMessage
{
  public:
    ...
    /**
     * Receives a RrcConnectionReconfigurationCompleted IE and stores the contents
    ...
    /**
     * Returns a RrcConnectionReconfigurationCompleted IE from the values in the
     * class attributes
...
class RrcConnectionReconfigurationHeader : public RrcDlDcchMessage
{
  public:
    ...
    /**
     * Receives a RrcConnectionReconfiguration IE and stores the contents into the
     * class attributes
     * @param msg The information element to parse
     */
    ...
    /**
     * Returns a RrcConnectionReconfiguration IE from the values in the class
     * attributes
  ...
  private:
    ...
    bool m_haveRadioResourceConfigDedicated;              ///< have radio resource config
                                                          ///< dedicated?
...
class HandoverPreparationInfoHeader : public RrcAsn1Header
{
  public:
    ...
    /**
     * Receives a HandoverPreparationInfo IE and stores the contents into the
     * class attributes
     * @param msg The information element to parse
     */
    ...
    /**
     * Returns a HandoverPreparationInfo IE from the values in the class
     * attributes
...
/**
 * This class manages the serialization/deserialization of
 * RRCConnectionReestablishmentRequest IE
 */
class RrcConnectionReestablishmentRequestHeader : public RrcUlCcchMessage
{
  public:
    ...
    /**
     * Receives a RrcConnectionReestablishmentRequest IE and stores the contents
     * into the class attributes
     * @param msg The information element to parse
     */
    ...
    /**
     * Returns a RrcConnectionReestablishmentRequest IE from the values in the
     * class attributes
...
/**
 * This class manages the serialization/deserialization of
 * RrcConnectionReestablishment IE
 */
class RrcConnectionReestablishmentHeader : public RrcDlCcchMessage
{
  public:
    ...
    /**
     * Receives a RrcConnectionReestablishment IE and stores the contents into the
     * class attributes
     * @param msg The information element to parse
     */
    ...
    /**
     * Returns a RrcConnectionReestablishment IE from the values in the class
     * attributes
...
/**
 * This class manages the serialization/deserialization of
 * RrcConnectionReestablishmentComplete IE
 */
class RrcConnectionReestablishmentCompleteHeader : public RrcUlDcchMessage
{
  public:
    ...
    /**
     * Receives a RrcConnectionReestablishmentComplete IE and stores the contents
     * into the class attributes
     * @param msg The information element to parse
     */
    ...
    /**
     * Returns a RrcConnectionReestablishmentComplete IE from the values in the
     * class attributes
...
/**
 * This class manages the serialization/deserialization of
 * RrcConnectionReestablishmentReject IE
 */
class RrcConnectionReestablishmentRejectHeader : public RrcDlCcchMessage
{
  public:
    ...
    /**
     * Receives a RrcConnectionReestablishmentReject IE and stores the contents
     * into the class attributes
     * @param msg The information element to parse
     */
    ...
    /**
     * Returns a RrcConnectionReestablishmentReject IE from the values in the
     * class attributes
  ...
  private:
    LteRrcSap::RrcConnectionReestablishmentReject
        m_rrcConnectionReestablishmentReject; ///< RRC connection reestablishmnet
                                              ///< reject
};

/**
 * This class manages the serialization/deserialization of RrcConnectionRelease
 * IE
 */
class RrcConnectionReleaseHeader : public RrcDlDcchMessage
{
  public:
    ...
    /**
     * Receives a RrcConnectionRelease IE and stores the contents into the class
     * attributes
     * @param msg The information element to parse
     */
...
/**
 * This class manages the serialization/deserialization of RrcConnectionReject
 * IE
 */
class RrcConnectionRejectHeader : public RrcDlCcchMessage
{
  public:
    ...
    /**
     * Receives a RrcConnectionReject IE and stores the contents into the class
     * attributes
     * @param msg The information element to parse
     */
...
class MeasurementReportHeader : public RrcUlDcchMessage
{
  public:
    ...
    /**
     * Receives a MeasurementReport IE and stores the contents into the class
     * attributes
     * @param msg The information element to parse
     */
