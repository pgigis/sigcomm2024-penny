...
LteEnbNetDevice::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::LteEnbNetDevice")
            ...
            .AddAttribute("LteAnr",
                          "The automatic neighbour relation function associated "
                          "to this EnbNetDevice",
                          PointerValue(),
            ...
            .AddAttribute("UlBandwidth",
                          "Uplink Transmission Bandwidth Configuration in number "
                          "of Resource Blocks",
                          UintegerValue(25),
            ...
            .AddAttribute("DlBandwidth",
                          "Downlink Transmission Bandwidth Configuration in "
            ...
            .AddAttribute("DlEarfcn",
                          "Downlink E-UTRA Absolute Radio Frequency Channel "
                          "Number (EARFCN) "
            ...
            .AddAttribute(
                "CsgId",
                "The Closed Subscriber Group (CSG) identity that this "
                "eNodeB belongs to",
                UintegerValue(0),
                MakeUintegerAccessor(&LteEnbNetDevice::SetCsgId, &LteEnbNetDevice::GetCsgId),
                MakeUintegerChecker<uint32_t>())
            .AddAttribute("CsgIndication",
                          "If true, only UEs which are members of the CSG (i.e. "
                          "same CSG ID) "
                          "can gain access to the eNodeB, therefore enforcing "
                          "closed access mode. "
                          "Otherwise, the eNodeB operates as a non-CSG cell and "
                          "implements open access mode.",
                          BooleanValue(false),
