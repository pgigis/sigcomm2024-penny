...
class LteSpectrumValueHelper
{
  public:
     ...
     *
     * \return a pointer to a newly allocated SpectrumValue representing the TX
     ...
     *  create a SpectrumValue that models the power spectral density of AWGN
     *
     * \param noiseFigure  the noise figure in dB  w.r.t. a reference temperature
     * of 290K \param spectrumModel the SpectrumModel instance to be used
     *
     * \return a pointer to a newly allocated SpectrumValue representing the noise
     * Power Spectral Density in W/Hz for each Resource Block
     */
