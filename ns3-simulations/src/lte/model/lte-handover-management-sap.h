...
class LteHandoverManagementSapUser
{
  public:
     ...
     * handover algorithm through the
     * LteHandoverManagementSapProvider::ReportUeMeas SAP function.
     *
     ...
     * received through the LteHandoverManagementSapProvider::ReportUeMeas
     * function.
     */
...
/**
 * \brief Template for the implementation of the
 * LteHandoverManagementSapProvider as a member of an owner class of type C to
 * which all methods are forwarded.
 */
template <class C>
