...
class LteMiErrorModel
{
  public:
    /**
     * \brief find the mmib (mean mutual information per bit) for different
     * modulations of the specified TB \param sinr the perceived sinr values in
     * the whole bandwidth in Watt \param map the active RBs for the TB \param mcs
     * the MCS of the TB \return the mmib
     */
    ...
    /**
     * \brief run the error-model algorithm for the specified PCFICH+PDCCH
     * channels \param sinr the perceived sinr values in the whole bandwidth in
     * Watt \return the decodification error of the PCFICH+PDCCH channels
     */
