    ...
    static TypeId tid =
        TypeId("ns3::LteFfrSoftAlgorithm")
            ...
            .AddAttribute("UlCommonSubBandwidth",
                          "Uplink Medium (Common) SubBandwidth Configuration in "
                          "number of Resource "
                          "Block Groups",
                          UintegerValue(6),
            ...
            .AddAttribute("UlEdgeSubBandwidth",
                          "Uplink Edge SubBandwidth Configuration in number of Resource "
                          "Block Groups",
                          UintegerValue(6),
                          MakeUintegerAccessor(&LteFfrSoftAlgorithm::m_ulEdgeSubBandwidth),
                          MakeUintegerChecker<uint8_t>())
            .AddAttribute("DlCommonSubBandwidth",
                          "Downlink Medium (Common) SubBandwidth Configuration "
                          "in number of "
            ...
            .AddAttribute("DlEdgeSubBandwidth",
                          "Downlink Edge SubBandwidth Configuration in number of Resource "
                          "Block Groups",
                          UintegerValue(0),
                          MakeUintegerAccessor(&LteFfrSoftAlgorithm::m_dlEdgeSubBandwidth),
                          MakeUintegerChecker<uint8_t>())
            .AddAttribute("CenterRsrqThreshold",
                          "If the RSRQ of is worse than this threshold, UE "
                          "should be served in "
                          "Medium sub-band",
                          UintegerValue(30),
            ...
            .AddAttribute("EdgeRsrqThreshold",
                          "If the RSRQ of is worse than this threshold, UE "
                          "should be served in Edge sub-band",
                          UintegerValue(20),
            ...
            .AddAttribute("MediumAreaPowerOffset",
                          "PdschConfigDedicated::Pa value for Medium Sub-band, "
                          "default value dB0",
                          UintegerValue(5),
                          MakeUintegerAccessor(&LteFfrSoftAlgorithm::m_mediumAreaPowerOffset),
                          MakeUintegerChecker<uint8_t>())
            .AddAttribute("EdgeAreaPowerOffset",
                          "PdschConfigDedicated::Pa value for Edge Sub-band, default value "
                          "dB0",
                          UintegerValue(5),
...
LteFfrSoftAlgorithm::InitializeDownlinkRbgMaps()
{
    ...
    NS_ASSERT_MSG((m_dlCommonSubBandwidth + m_dlEdgeSubBandOffset + m_dlEdgeSubBandwidth) <=
                      m_dlBandwidth,
                  "(DlCommonSubBandwidth + DlEdgeSubBandOffset+DlEdgeSubBandwidth) higher "
                  "than DlBandwidth");
...
LteFfrSoftAlgorithm::InitializeUplinkRbgMaps()
{
    ...
    NS_ASSERT_MSG((m_ulCommonSubBandwidth + m_ulEdgeSubBandOffset + m_ulEdgeSubBandwidth) <=
                      m_ulBandwidth,
                  "(UlCommonSubBandwidth + UlEdgeSubBandOffset+UlEdgeSubBandwidth) higher "
                  "than UlBandwidth");
