...
/**
 * \ingroup ff-api
 * \brief Implements the SCHED SAP and CSCHED SAP for a Frequency Domain
 * Maximize Throughput scheduler
 *
...
class FdMtFfMacScheduler : public FfMacScheduler
{
  ...
  private:
    ...
    // HARQ attributes
    bool m_harqOn; ///< m_harqOn when false inhibit tte HARQ mechanisms (by
                   ///< default active)
