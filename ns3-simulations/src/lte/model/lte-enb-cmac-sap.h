...
class LteEnbCmacSapProvider
{
  public:
    ...
    /**
     * Allocate a random access preamble for non-contention based random access
     * (e.g., for handover).
     *
     * \param rnti the RNTI of the UE who will perform non-contention based random
     * access
     *
 ...
 * See Femto Forum MAC Scheduler Interface Specification v 1.11, Figure 1
 *
 * This is the MAC SAP User, i.e., the part of the SAP that contains the RRC
...
class LteEnbCmacSapUser
{
  public:
    ...
    /**
     * Notify the RRC of a UE config updated requested by the MAC (normally, by
     * the scheduler)
     *
     * \param params
     */
     ...
     * are assigned to the required UEs.
     *
