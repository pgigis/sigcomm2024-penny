    ...
    static TypeId tid =
        TypeId("ns3::LteFfrDistributedAlgorithm")
            ...
            .AddAttribute("CalculationInterval",
                          "Time interval between calculation of Edge sub-band, "
            ...
            .AddAttribute(
                ...
                "If the difference between the power of the signal received by "
                "UE from "
                "the serving cell and the power of the signal received from the "
                "adjacent cell is "
                "less "
                "than a RsrpDifferenceThreshold value, the cell weight is "
                "incremented",
                UintegerValue(20),
