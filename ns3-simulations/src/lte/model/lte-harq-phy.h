...
/**
 * \ingroup lte
 * \brief The LteHarqPhy class implements the HARQ functionalities related to
 *PHY layer (i.e., decodification buffers for incremental redundancy management)
 *
 */
class LteHarqPhy : public SimpleRefCount<LteHarqPhy>
{
  public:
    ...
    /**
     * \brief Return the cumulated MI of the HARQ procId in case of
     * retransmissions for DL (asynchronous) \param harqProcId the HARQ proc id
    ...
    /**
     * \brief Return the cumulated MI of the HARQ procId in case of
     * retransmissions for UL (synchronous) \param rnti the RNTI of the
     * transmitter \return the MI accumulated
     */
    ...
    /**
     * \brief Update the MI value associated to the decodification of an HARQ
     * process for DL (asynchronous) \param rnti the RNTI of the transmitter
     * \param mi the new MI
     * \param infoBytes the no. of bytes of info
     * \param codeBytes the total no. of bytes txed
     */
