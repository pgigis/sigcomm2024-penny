    ...
    static TypeId tid =
        TypeId("ns3::ComponentCarrier")
            ...
            .AddAttribute("CsgIndication",
                          "If true, only UEs which are members of the CSG (i.e. same CSG "
                          "ID) "
                          "can gain access to the eNodeB, therefore enforcing closed "
                          "access mode. "
                          "Otherwise, the eNodeB operates as a non-CSG cell and implements "
                          "open access mode.",
                          BooleanValue(false),
            ...
            .AddAttribute(
                "PrimaryCarrier",
                "If true, this Carrier Component will be the Primary "
                "Carrier Component (PCC) "
