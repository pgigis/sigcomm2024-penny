 ...
 * SAP that contains the MAC methods called by the eNodeB CCM instance.
 */
...
class LteCcmMacSapUser : public LteMacSapUser
{
  public:
    ...
    /**
     * \brief Notifies component carrier manager about physical resource block
     * occupancy \param prbOccupancy The physical resource block occupancy \param
