...
/**
 * This abstract base class defines the API to interact with the Radio Link
 * Control (LTE_RLC) in LTE, see 3GPP TS 36.322
 *
 */
class LteRlc : public Object // SimpleRefCount<LteRlc>
{
  ...
  protected:
    ...
    uint8_t m_lcid;                             ///< LCID
    uint16_t m_packetDelayBudgetMs{UINT16_MAX}; //!< the packet delay budget in ms of the
