 ...
 * \ingroup lte
 *
 * This application implements the Packet Data Network (PDN) Gateway Entity
 * (PGW) according to the 3GPP TS 23.401 document.
 *
 ...
 * the PGW node and the internet hosts. It supports the following functions and
 * messages:
 *
 ...
 *
 * Others functions enumerated in section 4.4.3.3 of 3GPP TS 23.401 are not
 * supported.
 */
class EpcPgwApplication : public Application
{
  ...
  private:
    ...
    /**
     * \brief Callback to trace received data packets at Tun NetDevice from
     * internet.
     */
