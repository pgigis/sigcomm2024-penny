 ...
 *
 * The X2 SAP follows the specification 3GPP TS 36.423: "X2 application protocol
 * (X2AP)"
 *
...
class EpcX2Sap
{
  public:
    ...
    struct UlHighInterferenceInformationItem
    {
        ...
        std::vector<bool> ulHighInterferenceIndicationList; ///< UL high interference indication
                                                            ///< list
    };
    ...
    struct CellInformationItem
    {
        ...
        std::vector<UlInterferenceOverloadIndicationItem>
            ulInterferenceOverloadIndicationList; ///< UL interference overload
                                                  ///< indication list
        std::vector<UlHighInterferenceInformationItem>
            ulHighInterferenceInformationList;             ///< UL high interference
                                                           ///< information list
    ...
    struct SnStatusTransferParams
    {
        ...
        std::vector<ErabsSubjectToStatusTransferItem>
            erabsSubjectToStatusTransferList; ///< ERABs subject to status transfer
                                              ///< list
    };
     ...
     *
     * Forward UE data during the handover procedure from source eNB
     * (sourceCellId) to target eNB (targetCellId) using a GTP-U tunnel (gtpTeid)
     */
    struct UeDataParams
    {
        uint16_t sourceCellId; ///< source cell ID
