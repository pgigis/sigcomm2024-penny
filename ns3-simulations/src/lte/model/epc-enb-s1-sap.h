...
class EpcEnbS1SapProvider
{
  public:
    ...
    /**
     * \brief Triggers epc-enb-application to send ERAB Release Indication message
     * towards MME \param imsi the UE IMSI \param rnti the UE RNTI \param bearerId
...
class EpcEnbS1SapUser
{
  public:
    ...
    struct DataRadioBearerSetupRequestParameters
    {
        ...
        uint32_t gtpTeid;                  /**< S1-bearer GTP tunnel endpoint identifier,
                                              see 36.423 9.2.1 */
