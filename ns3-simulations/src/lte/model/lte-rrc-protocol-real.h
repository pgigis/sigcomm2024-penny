...
class LteUeRrcProtocolReal : public Object
{
    ...
    /// allow LteRlcSpecificLteRlcSapUser<LteUeRrcProtocolReal> class friend
    /// access
    friend class LteRlcSpecificLteRlcSapUser<LteUeRrcProtocolReal>;
    /// allow LtePdcpSpecificLtePdcpSapUser<LteUeRrcProtocolReal> class friend
    /// access
...
class LteEnbRrcProtocolReal : public Object
{
    ...
    /// allow LtePdcpSpecificLtePdcpSapUser<LteEnbRrcProtocolReal> class friend
    /// access
    friend class LtePdcpSpecificLtePdcpSapUser<LteEnbRrcProtocolReal>;
    /// allow LteRlcSpecificLteRlcSapUser<LteEnbRrcProtocolReal> class friend
    /// access
