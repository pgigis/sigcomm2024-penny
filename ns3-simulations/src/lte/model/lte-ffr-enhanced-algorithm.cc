    ...
    static TypeId tid =
        TypeId("ns3::LteFfrEnhancedAlgorithm")
            ...
            .AddAttribute("UlSubBandOffset",
                          "Uplink SubBand Offset for this cell in number of Resource Block "
                          "Groups",
                          UintegerValue(0),
                          MakeUintegerAccessor(&LteFfrEnhancedAlgorithm::m_ulSubBandOffset),
                          MakeUintegerChecker<uint8_t>())
            .AddAttribute("UlReuse3SubBandwidth",
                          "Uplink Reuse 3 SubBandwidth Configuration in number "
            ...
            .AddAttribute("UlCqiThreshold",
                          "If the UL-CQI for RBG of is higher than this threshold, "
                          "transmission on "
                          "RBG is possible",
                          UintegerValue(15),
            ...
            .AddAttribute("CenterAreaTpc",
                          ...
                          "Absolute mode is used, default value 1 is mapped to -1 "
                          "according to"
...
LteFfrEnhancedAlgorithm::InitializeDownlinkRbgMaps()
{
    ...
    NS_ASSERT_MSG(m_dlSubBandOffset + m_dlReuse3SubBandwidth + m_dlReuse1SubBandwidth <=
                      m_dlBandwidth,
                  "DlSubBandOffset + DlReuse3SubBandwidth + DlReuse1SubBandwidth "
...
LteFfrEnhancedAlgorithm::InitializeUplinkRbgMaps()
{
    ...
    NS_ASSERT_MSG(m_ulSubBandOffset + m_ulReuse3SubBandwidth + m_ulReuse1SubBandwidth <=
                      m_ulBandwidth,
                  "UlSubBandOffset + UlReuse3SubBandwidth + UlReuse1SubBandwidth "
