...
class LteSpectrumPhy : public SpectrumPhy
{
  public:
     ...
     *
     * When UE context at eNodeB is removed and if UL TB is expected to be
     * received but not transmitted due to break in radio link. The TB with
     * different rnti or lcid remains during the transmission of a new TB and
     * causes problems with m_ulPhyReception trace, since the UE context was
     * already removed. TB has to be removed when ue context at eNodeB is removed
     *
  ...
  private:
    ...
    LtePhyRxDataEndErrorCallback m_ltePhyRxDataEndErrorCallback; ///< the LTE phy receive data end
                                                                 ///< error callback
    LtePhyRxDataEndOkCallback m_ltePhyRxDataEndOkCallback; ///< the LTE phy receive data end ok
                                                           ///< callback

    LtePhyRxCtrlEndOkCallback m_ltePhyRxCtrlEndOkCallback; ///< the LTE phy receive control end ok
                                                           ///< callback
    LtePhyRxCtrlEndErrorCallback m_ltePhyRxCtrlEndErrorCallback; ///< the LTE phy receive control
                                                                 ///< end error callback
    ...
    bool m_dataErrorModelEnabled; ///< when true (default) the phy error model is
                                  ///< enabled
    bool m_ctrlErrorModelEnabled; ///< when true (default) the phy error model is
                                  ///< enabled for DL ctrl frame
    ...
    LtePhyDlHarqFeedbackCallback m_ltePhyDlHarqFeedbackCallback; ///< the LTE phy DL HARQ feedback
                                                                 ///< callback
    LtePhyUlHarqFeedbackCallback m_ltePhyUlHarqFeedbackCallback; ///< the LTE phy UL HARQ feedback
                                                                 ///< callback
