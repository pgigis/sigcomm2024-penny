 ...
 *
 * Note: Implementation is using many common scheduler functionalities in its
 * original version implemented by Marco Miozzo<mmiozzo@cttc.es> in PF and RR
 * schedulers. *
 */
...
struct CqasFlowPerf_t
{
    ...
    unsigned int lastTtiBytesTransmitted; ///< Total bytes send by eNB in last
                                          ///< tti for this UE
...
/**
 * \ingroup ff-api
 * \brief Implements the SCHED SAP and CSCHED SAP for the Channel and QoS Aware
 * Scheduler
 *
