...
class LteEnbPhySapProvider
{
  public:
    ...
    /**
     * \brief Send SendLteControlMessage (PDCCH map, CQI feedbacks) using the
     * ideal control channel \param msg the Ideal Control Message to send
     */
...
class LteEnbPhySapUser
{
  public:
    ...
    /**
     * \brief Receive SendLteControlMessage (PDCCH map, CQI feedbacks) using the
     * ideal control channel \param msg the Ideal Control Message to receive
     */
