...
class LteUeRrc : public Object
{
  ...
  private:
    ...
    /**
     * Part of the RRC protocol. Implement the LteUeRrcSapProvider::CompleteSetup
     * interface. \param params the LteUeRrcSapProvider::CompleteSetupParameters
     */
    void DoCompleteSetup(LteUeRrcSapProvider::CompleteSetupParameters params);
    /**
     * Part of the RRC protocol. Implement the
     * LteUeRrcSapProvider::RecvSystemInformation interface. \param msg the
     * LteRrcSap::SystemInformation
     */
    void DoRecvSystemInformation(LteRrcSap::SystemInformation msg);
    /**
     * Part of the RRC protocol. Implement the
     * LteUeRrcSapProvider::RecvRrcConnectionSetup interface. \param msg the
     * LteRrcSap::RrcConnectionSetup
     */
    void DoRecvRrcConnectionSetup(LteRrcSap::RrcConnectionSetup msg);
    /**
     * Part of the RRC protocol. Implement the
     * LteUeRrcSapProvider::RecvRrcConnectionReconfiguration interface. \param msg
     * the LteRrcSap::RrcConnectionReconfiguration
     */
    void DoRecvRrcConnectionReconfiguration(LteRrcSap::RrcConnectionReconfiguration msg);
    /**
     * Part of the RRC protocol. Implement the
     * LteUeRrcSapProvider::RecvRrcConnectionReestablishment interface. \param msg
    ...
    /**
     * Part of the RRC protocol. Implement the
     * LteUeRrcSapProvider::RecvRrcConnectionRelease interface. \param msg
     * LteRrcSap::RrcConnectionRelease
     */
    void DoRecvRrcConnectionRelease(LteRrcSap::RrcConnectionRelease msg);
    /**
     * Part of the RRC protocol. Implement the
     * LteUeRrcSapProvider::RecvRrcConnectionReject interface. \param msg the
    ...
    /// List of cell ID of acceptable cells for cell selection that have been
    /// detected.
    ...
    /**
     * \brief Internal storage of the latest measurement results from all detected
     *        detected Secondary carrier component, indexed by the carrier
     * component ID where the measurement was taken from.
     *
     * Each *measurement result* comprises of RSRP (in dBm) and RSRQ (in dB).
     *
     * In IDLE mode, the measurement results are used by the *initial cell
    ...
    struct PendingTrigger_t
    {
        ...
        EventId timer;                   ///< The pending reporting event, scheduled at the end of
                                         ///< the time-to-trigger.
    };
    ...
    /**
     * Time limit (given by m_t310) before the radio link is considered to have
     * failed. It is set upon detecting physical layer problems i.e. upon
     * receiving N310 consecutive out-of-sync indications from lower layers.
     * Calling LteUeRrc::RadioLinkFailureDetected() when it expires. It is
     * cancelled upon receiving N311 consecutive in-sync indications. Upon expiry,
     * the UE transitions to RRC_IDLE and no RRC connection re-establishment is
     * initiated.
     */
    EventId m_radioLinkFailureDetected;

    uint8_t m_noOfSyncIndications; ///< number of in-sync or out-of-sync
                                   ///< indications coming from PHY layer

    bool m_leaveConnectedMode; ///< true if UE NAS ask UE RRC to leave connected
                               ///< mode, e.g., after RLF, i.e. T310 has expired

    uint16_t m_previousCellId; ///< the cell id of the previous cell UE was
                               ///< attached to

    uint8_t m_connEstFailCountLimit; ///< the counter value for T300 timer
                                     ///< expiration received from the eNB
