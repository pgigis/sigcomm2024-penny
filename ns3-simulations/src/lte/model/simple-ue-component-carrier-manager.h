 ...
 *
 * Selecting this component carrier selection algorithm is equivalent to
 * disabling automatic triggering of component carrier selection. This is the
 * default choice.
 *
 */
class SimpleUeComponentCarrierManager : public LteUeComponentCarrierManager
{
  ...
  protected:
    ...
    // inherited from LteCcsAlgorithm as a Component Carrier Management SAP
    // implementation
    /**
