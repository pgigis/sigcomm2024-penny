    ...
    static TypeId tid =
        TypeId("ns3::LteRlcAm")
            ...
            .AddAttribute("PollRetransmitTimer",
                          "Value of the t-PollRetransmit timer (See section 7.3 "
                          "of 3GPP TS 36.322)",
            ...
            .AddAttribute("StatusProhibitTimer",
                          "Value of the t-StatusProhibit timer (See section 7.3 "
                          "of 3GPP TS 36.322)",
                          TimeValue(MilliSeconds(10)),
                          MakeTimeAccessor(&LteRlcAm::m_statusProhibitTimerValue),
                          MakeTimeChecker())
            .AddAttribute("ReportBufferStatusTimer",
                          "How much to wait to issue a new Report Buffer Status "
                          "since the last time "
            ...
            .AddAttribute("TxOpportunityForRetxAlwaysBigEnough",
                          "If true, always pretend that the size of a "
                          "TxOpportunity is big enough "
                          "for retransmission. If false (default and realistic "
                          "behavior), no retx "
                          "is performed unless the corresponding TxOpportunity "
                          "is big enough.",
                          BooleanValue(false),
