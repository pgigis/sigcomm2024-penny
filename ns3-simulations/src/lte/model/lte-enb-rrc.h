 ...
 * (CTTC) Copyright (c) 2018 Fraunhofer ESK : RLF extensions
 *
...
class UeManager : public Object
{
  ...
  public:
    ...
    /**
     * take the necessary actions in response to the reception of an X2 HANDOVER
     * REQUEST ACK message
     *
     * \param params
     */
    ...
    /**
     * Take the necessary actions in response to the reception of an X2 HO
    ...
    /**
     * Take the necessary actions in response to the reception of an X2 SN STATUS
     * TRANSFER message
     *
    ...
    /**
     * Take the necessary actions in response to the reception of an X2 UE CONTEXT
     * RELEASE message
     *
     * \param params the SN STATUS
     */
    ...
    /**
     * Implement the LteEnbRrcSapProvider::RecvRrcConnectionSetupCompleted
     * interface. \param msg RRC connection setup completed message
     */
    void RecvRrcConnectionSetupCompleted(LteRrcSap::RrcConnectionSetupCompleted msg);
    /**
     * Implement the
     * LteEnbRrcSapProvider::RecvRrcConnectionReconfigurationCompleted interface.
     * \param msg RRC connection reconfiguration completed message
     */
    void RecvRrcConnectionReconfigurationCompleted(
        LteRrcSap::RrcConnectionReconfigurationCompleted msg);
    /**
     * Implement the LteEnbRrcSapProvider::RecvRrcConnectionReestablishmentRequest
     * interface. \param msg the RRC connection reestablishment request message
     */
    void RecvRrcConnectionReestablishmentRequest(
        LteRrcSap::RrcConnectionReestablishmentRequest msg);
    /**
     * Implement the
     * LteEnbRrcSapProvider::RecvRrcConnectionReestablishmentComplete interface.
    ...
    /**
     * Implement the LteEnbRrcSapProvider::RecvIdealUeContextRemoveRequest
     * interface.
     *
    ...
    /**
     * Configure PdschConfigDedicated (i.e. P_A value) for UE and start
     * RrcConnectionReconfiguration to inform UE about new PdschConfigDedicated
     *
     * \param pdschConfigDedicated new pdschConfigDedicated (i.e. P_A value) to be
     * set
     */
  ...
  private:
    ...
    bool m_pendingRrcConnectionReconfiguration; ///< pending RRC connection
                                                ///< reconfiguration
    ...
    /// Define if the Carrier Aggregation was already configure for the current UE
    /// on not
...
class LteEnbRrc : public Object
{
  ...
  public:
     ...
     * \return s the X2 SAP User interface offered to the X2 entity by this RRC
     * entity
     */
     ...
     *
     * \param s the Component Carrier Management SAP Provider to be used by this
     * RRC
     */
     ...
     * \return s the Component Carrier Management SAP User interface offered to
     * the carrier component selection algorithm by this RRC
     */
    ...
    /**
     *  \brief This function acts as an interface to trigger Release indication
     * messages towards eNB and EPC \param imsi the IMSI \param rnti the RNTI
  ...
  private:
    ...
    /**
     * Part of the RRC protocol. Forwarding LteEnbRrcSapProvider::CompleteSetupUe
     * interface to UeManager::CompleteSetupUe \param rnti the RNTI \param params
     * the LteEnbRrcSapProvider::CompleteSetupUeParameters
     */
    void DoCompleteSetupUe(uint16_t rnti, LteEnbRrcSapProvider::CompleteSetupUeParameters params);
    /**
     * Part of the RRC protocol. Forwarding
     * LteEnbRrcSapProvider::RecvRrcConnectionRequest interface to
     * UeManager::RecvRrcConnectionRequest
     *
     * \param rnti the RNTI
    ...
    /**
     * Part of the RRC protocol. Forwarding
     * LteEnbRrcSapProvider::RecvRrcConnectionSetupCompleted interface to
     ...
     * Part of the RRC protocol. Forwarding
     * LteEnbRrcSapProvider::RecvRrcConnectionReconfigurationCompleted interface
     * to UeManager::RecvRrcConnectionReconfigurationCompleted
     *
     * \param rnti the RNTI
    ...
    /**
     * Part of the RRC protocol. Forwarding
     * LteEnbRrcSapProvider::RecvMeasurementReport interface to
     ...
     * in connected mode is completed, then the preamble can be reused by other
     * UEs. If not, the same UE retains the preamble and other available preambles
     * is assigned to the required UEs.
     *
     * \param rnti the C-RNTI identifying the user
  ...
  private:
    ...
    uint32_t m_ulEarfcn;
    /// Downlink transmission bandwidth configuration in number of Resource
    /// Blocks.
    ...
    /// The System Information Block Type 1 that is currently broadcasted over
    /// BCH.
    ...
    /// List of measurement identities which are intended for component carrier
    /// management purposes.
    ...
    uint16_t m_lastAllocatedConfigurationIndex;      ///< last allocated configuration
                                                     ///< index
    ...
    /**
     * The `NotifyConnectionRelease` trace source. Fired when an UE leaves the
     * eNB. Exporting IMSI, cell ID, RNTI.
     *
     */
    ...
    /**
     * The 'HandoverFailureNoPreamble' Trace source. Fired upon handover failure
     * due to non-allocation of non-contention based preamble at eNB for UE to
     * handover due to max count reached
     *
     */
    TracedCallback<uint64_t, uint16_t, uint16_t> m_handoverFailureNoPreambleTrace;
    /**
     * The 'HandoverFailureMaxRach' Trace source. Fired upon handover failure due
     * to max RACH attempts from UE to target eNB
     *
     */
    TracedCallback<uint64_t, uint16_t, uint16_t> m_handoverFailureMaxRachTrace;
    /**
     * The 'HandoverFailureLeaving' Trace source. Fired upon handover failure due
     * to handover leaving timeout at source eNB
     *
     */
    TracedCallback<uint64_t, uint16_t, uint16_t> m_handoverFailureLeavingTrace;
    /**
     * The 'HandoverFailureJoining' Trace source. Fired upon handover failure due
     * to handover joining timeout at target eNB
     *
     */
