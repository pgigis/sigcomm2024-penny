...
LteUeNetDevice::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::LteUeNetDevice")
            ...
            .AddAttribute(
                "CsgId",
                "The Closed Subscriber Group (CSG) identity that this UE is "
                "associated with, "
                "i.e., giving the UE access to cells which belong to this "
                "particular CSG. "
                "This restriction only applies to initial cell selection and "
                "EPC-enabled "
                "simulation. "
