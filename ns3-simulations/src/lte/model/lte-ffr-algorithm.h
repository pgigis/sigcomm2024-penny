 ...
 *
 * Generally Frequency reuse algorithm tells the Scheduler which RB can be
 * allocated and which can not. FR policy depend on its implementation.
 *
 * The communication with the eNodeB MAC Scheduler instance is done through
 * the *LteFfrSap* interface. The frequency reuse algorithm instance corresponds
 * to the "provider" part of this interface, while the eNodeB MAC Scheduler
 * instance takes the role of the "user" part.
 *
 * The communication with the eNodeB RRC instance is done through the
 * *LteFfrRrcSap* interface. The frequency reuse algorithm instance corresponds
 * to the "provider" part of this interface, while the eNodeB RRC instance takes
 * the role of the "user" part.
 *
 */
