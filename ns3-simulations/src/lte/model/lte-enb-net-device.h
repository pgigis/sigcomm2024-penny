 ...
 * Author: Danilo Abrignani <danilo.abrignani@unibo.it> : Integrated with new
 * architecture - GSoC 2015 - Carrier Aggregation
 */
...
class LteEnbNetDevice : public LteNetDevice
{
  ...
  private:
    ...
    uint16_t m_cellId; /**< Cell Identifier. Part of the CGI, see TS 29.274,
                          section 8.21.1  */

    uint16_t m_dlBandwidth; /**<DEPRECATE - It is maintained for backward compatibility
                               after adding CA feature- downlink bandwidth in RBs */
    uint16_t m_ulBandwidth; /**<DEPRECATE - It is maintained for backward compatibility
                               after adding CA feature- uplink bandwidth in RBs */

    uint32_t m_dlEarfcn; /**<DEPRECATE - It is maintained for backward compatibility
                            after adding CA feature- downlink carrier frequency */
    uint32_t m_ulEarfcn; /**<DEPRECATE - It is maintained for backward compatibility
                            after adding CA feature- uplink carrier frequency */
