...
UeManager::RecvHandoverRequestAck(EpcX2SapUser::HandoverRequestAckParams params)
{
    ...
    if (handoverCommand.haveNonCriticalExtension)
    {
            ...
            m_rrc->m_numberOfComponentCarriers)
        {
            ...
            NS_FATAL_ERROR("The source and target eNBs have unequal number of component "
                           "carriers. "
                           "Target eNB CCs = "
                           << handoverCommand.nonCriticalExtension.sCellToAddModList.size() + 1
...
LteEnbRrc::ConfigureCarriers(std::map<uint8_t, Ptr<ComponentCarrierBaseStation>> ccPhyConf)
{
    ...
    NS_ABORT_MSG_IF(m_numberOfComponentCarriers != m_componentCarrierPhyConf.size(),
                    ...
                    "are not equal to the number of he component carrier "
    ...
    static TypeId tid =
        TypeId("ns3::LteEnbRrc")
            ...
            .AddAttribute("EpsBearerToRlcMapping",
                          "Specify which type of RLC will be used for each type "
                          "of EPS bearer.",
            ...
            .AddTraceSource("HandoverFailureNoPreamble",
                            "trace fired upon handover failure due to non-allocation of "
            ...
            .AddTraceSource("HandoverFailureMaxRach",
                            "trace fired upon handover failure due to max RACH "
            ...
            .AddTraceSource("HandoverFailureLeaving",
                            "trace fired upon handover failure due to handover "
...
LteEnbRrc::AddUeMeasReportConfig(LteRrcSap::ReportConfigEutra config)
{
    ...
    NS_ASSERT_MSG(m_ueMeasConfig.measIdToAddModList.size() ==
                  ...
                  "Measurement identities and reporting configuration should not "
                  "have different quantity");
    ...
    case LteRrcSap::ReportConfigEutra::RSRP:
        ...
        {
            NS_FATAL_ERROR("The given triggerQuantity (RSRP) does not match with the "
                           "given threshold2.choice");
        }
    ...
    case LteRrcSap::ReportConfigEutra::RSRQ:
        ...
        {
            NS_FATAL_ERROR("The given triggerQuantity (RSRQ) does not match with the "
                           "given threshold2.choice");
        }
    ...
    {
        NS_LOG_WARN("reportQuantity = BOTH will be used instead of the given "
                    "reportQuantity");
    }
...
LteEnbRrc::DoRecvHandoverRequest(EpcX2SapUser::HandoverRequestParams req)
{
    ...
    if (!anrcrv.valid)
    {
        NS_LOG_INFO(this << " failed to allocate a preamble for non-contention "
                            "based RA => cannot accept HO");
