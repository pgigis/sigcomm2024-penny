...
class LteUePhy : public LtePhy
{
  ...
  private:
     ...
     *
     * \param cqiPeriodicity The downlink CQI reporting periodicity in
     * milliseconds
     */
    ...
    std::vector<std::vector<int>> m_subChannelsForTransmissionQueue; ///< subchannels for
                                                                     ///< transmission queue
     ...
     * and whether the cell is the serving cell. Moreover it report the
    ...
    uint16_t m_numOfQoutEvalSf; ///< the downlink radio link quality is estimated
                                ///< over this period for detecting out-of-syncs
    uint16_t m_numOfQinEvalSf;  ///< the downlink radio link quality is estimated
                                ///< over this period for detecting in-syncs

    bool m_downlinkInSync;          ///< when set, DL SINR evaluation for out-of-sync
                                    ///< indications is conducted.
    uint16_t m_numOfSubframes;      ///< count the number of subframes for which the
                                    ///< downlink radio link quality is estimated
    uint16_t m_numOfFrames;         ///< count the number of frames for which the
                                    ///< downlink radio link quality is estimated
