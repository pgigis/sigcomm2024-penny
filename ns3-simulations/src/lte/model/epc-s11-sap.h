...
class EpcS11SapMme : public EpcS11Sap
{
  public:
    ...
    /**
     * Delete Bearer Request message, see 3GPP TS 29.274 Release 9 V9.3.0
     * section 7.2.9.2
     */
    ...
    /**
     * \brief As per 3GPP TS 29.274 Release 9 V9.3.0, a Delete Bearer Request
     * message shall be sent on the S11 interface by PGW to SGW and from SGW to
     * MME \param msg the message
     */
...
class EpcS11SapSgw : public EpcS11Sap
{
  public:
    ...
    /**
     * Delete Bearer Command message, see 3GPP TS 29.274 Release 9 V9.3.0
     * section 7.2.17.1
     */
    ...
    /**
     * \brief As per 3GPP TS 29.274 Release 9 V9.3.0, a Delete Bearer Command
     * message shall be sent on the S11 interface by the MME to the SGW \param msg
     * the DeleteBearerCommandMessage
     */
    ...
    /**
     * Delete Bearer Response message, see 3GPP TS 29.274 Release 9 V9.3.0
     * section 7.2.10.2
     */
