    ...
    static TypeId tid =
        TypeId("ns3::LteEnbMac")
            ...
            .AddAttribute("NumberOfRaPreambles",
                          "how many random access preambles are available for "
            ...
            .AddAttribute("RaResponseWindowSize",
                          "length of the window (in TTIs) for the reception of the random "
                          "access "
...
LteEnbMac::DoReportMacCeToScheduler(MacCeListElement_s bsr)
{
    ...
    m_ulCeReceived.push_back(bsr); // this to called when
                                   // LteUlCcmSapProvider::ReportMacCeToScheduler is called
