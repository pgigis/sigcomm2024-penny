                                        ...
                                        uint8_t bearerId)
{
    ...
    NS_ASSERT_MSG(bearerId != 1,
                  "Default bearer cannot be de-activated until "
                  "and unless and UE is released");
...
LteHelper::EnableRlcTraces()
{
    NS_ASSERT_MSG(!m_rlcStats,
                  "please make sure that LteHelper::EnableRlcTraces "
...
{
    Config::Connect("/NodeList/*/DeviceList/*/ComponentCarrierMapUe/*/LteUePhy/DlSpectrumPhy/"
                    "DlPhyReception",
...
{
    Config::Connect("/NodeList/*/DeviceList/*/ComponentCarrierMap/*/LteEnbPhy/UlSpectrumPhy/"
                    "UlPhyReception",
...
LteHelper::EnableUlPhyTraces()
{
    ...
    Config::Connect("/NodeList/*/DeviceList/*/ComponentCarrierMap/*/LteEnbPhy/"
                    "ReportInterference",
