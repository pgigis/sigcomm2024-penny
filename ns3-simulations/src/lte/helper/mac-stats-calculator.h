 ...
 * \ingroup lte
 *
 * Takes care of storing the information generated at MAC layer. Metrics saved
 * are:
...
class MacStatsCalculator : public LteStatsCalculator
{
  public:
     ...
     * @param dlSchedulingCallbackInfo the structure that contains downlink
     * scheduling fields: frameNo Frame number subframeNo Subframe number rnti
     * C-RNTI scheduled mcsTb1 MCS for transport block 1 sizeTb1 Size of transport
     * block 1 mcsTb2 MCS for transport block 2 (0 if not used) sizeTb2 Size of
     * transport block 2 (0 if not used) componentCarrierId component carrier ID
     */
     ...
     * \param macStats
     * \param path
     * \param dlSchedulingCallbackInfo DlSchedulingCallbackInfo structure
     * containing all downlink information that is generated what DlScheduling
     * traces is fired
     */
