 ...
 *         Danilo Abrignani <danilo.abrignani@unibo.it> (Modification due to new
 * Architecture - Carrier Aggregation - GSoC 2015)
 */
    ...
    static TypeId tid =
        TypeId("ns3::PhyStatsCalculator")
            ...
            .AddAttribute("UlInterferenceFilename",
                          "Name of the file where the interference statistics will be "
                          "saved.",
