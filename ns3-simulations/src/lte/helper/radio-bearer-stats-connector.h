...
class RadioBearerStatsConnector
{
  public:
     ...
     * which is fired when SRB1 is created, i.e. RLC and PDCP are created for one
     * LC = 1. It connects the callbacks for the DRB at the eNB. \param c \param
     * context \param imsi \param cellid \param rnti
     */
     ...
     * which is fired when DRB is created, i.e. RLC and PDCP are created for LC =
     * lcid. It connects the callbacks for the DRB at the eNB. \param c \param
     * context \param imsi \param cellid \param rnti \param lcid
     */
     ...
     * which is fired when DRB is created, i.e. RLC and PDCP are created for LC =
     * lcid. It connects the callbacks for the DRB at the UE. \param c \param
     * context \param imsi \param cellid \param rnti \param lcid
     */
  ...
  private:
    ...
    bool m_connected; //!< true if traces are connected to sinks, initially set
                      //!< to false
