...
class RadioBearerStatsCalculator : public LteStatsCalculator
{
  public:
     ...
     * @return the name of the file where the uplink PDCP statistics will be
     * stored
     */
     ...
     * @return the name of the file where the downlink PDCP statistics will be
     * stored
     */
    ...
    /**
     * Gets the uplink RLC to RLC statistics: average, min, max and standard
     * deviation.
     * @param imsi IMSI of the UE
     * @param lcid LCID
     * @return RLC to RLC delay statistics average, min, max and standard
     * deviation in seconds
     */
    std::vector<double> GetUlDelayStats(uint64_t imsi, uint8_t lcid);

    /**
     * Gets the uplink PDU size statistics: average, min, max and standard
     * deviation.
     * @param imsi IMSI of the UE
     * @param lcid LCID
     * @return PDU size statistics average, min, max and standard deviation in
     * seconds
     */
    ...
    /**
     * Gets the downlink RLC to RLC statistics: average, min, max and standard
     * deviation.
     * @param imsi IMSI of the UE
     * @param lcid LCID
     * @return RLC to RLC delay statistics average, min, max and standard
    ...
    /**
     * Gets the downlink PDU size statistics: average, min, max and standard
     * deviation.
     * @param imsi IMSI of the UE
     * @param lcid LCID
     * @return PDU size statistics average, min, max and standard deviation in
