    ...
    static TypeId tid =
        TypeId("ns3::RadioEnvironmentMapHelper")
            ...
            .AddAttribute("Channel",
                          "The DL spectrum channel for which the RadioEnvironment Map is "
                          "to be generated. "
            ...
            .AddAttribute("ChannelPath",
                          "The path to the channel for which the Radio Environment Map is "
                          "to be generated."
                          "This attribute is an alternative to Channel attribute and is "
                          "only used if Channel "
            ...
            .AddAttribute("Z",
                          "The value of the z coordinate for which the map is to "
                          "be generated",
                          DoubleValue(0.0),
                          MakeDoubleAccessor(&RadioEnvironmentMapHelper::m_z),
                          MakeDoubleChecker<double>())
            .AddAttribute("StopWhenDone",
                          "If true, Simulator::Stop () will be called as soon as the REM "
                          "has been generated",
                          BooleanValue(true),
                          MakeBooleanAccessor(&RadioEnvironmentMapHelper::m_stopWhenDone),
                          MakeBooleanChecker())
            .AddAttribute("NoisePower",
                          "the power of the measuring instrument noise, in Watts. Default "
                          "to a kT of -174 "
                          "dBm with a noise figure of 9 dB and a bandwidth of 25 LTE "
                          "Resource Blocks",
                          DoubleValue(1.4230e-13),
                          MakeDoubleAccessor(&RadioEnvironmentMapHelper::m_noisePower),
                          MakeDoubleChecker<double>())
            .AddAttribute("MaxPointsPerIteration",
                          "Maximum number of REM points to be calculated per iteration. "
                          "Every "
            ...
            .AddAttribute("Bandwidth",
                          "Transmission Bandwidth Configuration (in number of RBs) over "
                          "which the "
            ...
            .AddAttribute("UseDataChannel",
                          "If true, REM will be generated for PDSCH and for PDCCH "
                          "otherwise",
                          BooleanValue(false),
            ...
            .AddAttribute("RbId",
                          ...
                          "default value is -1, what means REM will be averaged "
                          "from all RBs",
                          IntegerValue(-1),
