/*
 * Copyright (c) 2011-2013 Centre Tecnologic de Telecomunicacions de Catalunya
 * (CTTC)
 *
...
class EpcHelper : public Object
{
  public:
    ...
    /**
     * Notify the EPC of the existence of a new UE which might attach at a later
     * time
     *
     ...
     * \param bearer struct describing the characteristics of the EPS bearer to be
     * activated \return bearer ID
     */
     ...
     * The primary use intended for this method is to allow the user to configure
     * the SGi interface of the PGW, i.e., to connect the PGW to the internet.
     */
     ...
     *
     * \return the interface container, \see Ipv4AddressHelper::Assign() which has
     * similar semantics
     */
     ...
     * \param ueDevices the set of UE devices
     *
     * \return the interface container, \see Ipv6AddressHelper::Assign() which has
     * similar semantics
     */
    ...
    /**
     *
     * \return the IPv4 address of the Default Gateway to be used by UEs to reach
     * the internet
     */
    ...
    /**
     *
     * \return the IPv6 address of the Default Gateway to be used by UEs to reach
     * the internet
     */
