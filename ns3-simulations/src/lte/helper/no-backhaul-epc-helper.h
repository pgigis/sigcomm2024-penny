...
/**
 * \ingroup lte
 * \brief Create an EPC network with PointToPoint links between the core network
 * nodes.
 *
...
class NoBackhaulEpcHelper : public EpcHelper
{
  ...
  protected:
    /**
     * \brief DoAddX2Interface: Call AddX2Interface on top of the Enb device
     * pointers
     *
  ...
  private:
    /**
     * helper to assign IPv4 addresses to UE devices as well as to the TUN device
     * of the SGW/PGW
     */
    Ipv4AddressHelper m_uePgwAddressHelper;
    /**
     * helper to assign IPv6 addresses to UE devices as well as to the TUN device
     * of the SGW/PGW
     */
