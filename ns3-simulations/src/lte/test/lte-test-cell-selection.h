...
class LteCellSelectionTestCase : public TestCase
{
  public:
    ...
    struct UeSetup_t
    {
        Vector position;          ///< The position, relative to the inter site distance,
                                  ///< where the UE will be spawned in the simulation.
        bool isCsgMember;         ///< Whether UE is allowed access to CSG cell.
        Time checkPoint;          ///< The time in simulation when the UE is verified by the
                                  ///< test script.
        uint16_t expectedCellId1; ///< The cell ID that the UE is expected to
                                  ///< attach to (0 means that the UE should not
                                  ///< attach to any cell).
        uint16_t expectedCellId2; ///< An alternative cell ID that the UE is
                                  ///< expected to attach to (0 means that this no
                                  ///< alternative cell is expected).
        /**
         ...
         * \param expectedCellId2 an alternative cell ID that the UE is expected to
         * attach to (0 means that this no alternative cell is expected).
         */
