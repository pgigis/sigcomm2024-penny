  ...
  public:
        ...
        : TestSuite("lte-handover-failure", TestSuite::SYSTEM)
    {
        ...
        AddTestCase(new LteHandoverFailureTestCase("REAL Handover failure due to maximum RACH "
                                                   ...
                                                   2500),
                    TestCase::QUICK);
        AddTestCase(new LteHandoverFailureTestCase("REAL Handover failure due to non-allocation of "
                    ...
                    TestCase::QUICK);
        AddTestCase(
            new LteHandoverFailureTestCase("REAL Handover failure due to HANDOVER JOINING timeout "
                                           "before reception of "
        ...
        AddTestCase(new LteHandoverFailureTestCase(
                    ...
                    TestCase::QUICK);
        AddTestCase(
            new LteHandoverFailureTestCase("REAL Handover failure due to HANDOVER LEAVING timeout "
                                           "before reception of "
                                           "RRC CONNECTION RECONFIGURATION at source eNodeB",
                                           false,
                                           Seconds(0.100),
        ...
        AddTestCase(new LteHandoverFailureTestCase("IDEAL Handover failure due to maximum RACH "
                    ...
                    TestCase::QUICK);
        AddTestCase(
            new LteHandoverFailureTestCase("IDEAL Handover failure due to non-allocation of "
            ...
            TestCase::QUICK);
        AddTestCase(
            new LteHandoverFailureTestCase("IDEAL Handover failure due to HANDOVER JOINING timeout "
                                           "before reception "
        ...
        AddTestCase(new LteHandoverFailureTestCase(
                    ...
                    TestCase::QUICK);
        AddTestCase(
            new LteHandoverFailureTestCase("IDEAL Handover failure due to HANDOVER LEAVING timeout "
                                           "before reception "
                                           "of RRC CONNECTION RECONFIGURATION at source eNodeB",
                                           true,
                                           Seconds(0.100),
