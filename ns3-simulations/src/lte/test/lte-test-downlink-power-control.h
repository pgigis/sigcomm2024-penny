 ...
 * Test if the difference in power levels are corresponding to the estamated
 * values.
 */
...
class LteDownlinkPowerControlRrcConnectionReconfigurationTestCase : public TestCase
{
  ...
  private:
    ...
    bool m_changePdschConfigDedicatedTriggered;   ///< change PDSCH config
                                                  ///< dedicated triggered?
    bool m_connectionReconfigurationUeReceived;   ///< connection reconfiguration
                                                  ///< UE received?
    bool m_connectionReconfigurationEnbCompleted; ///< connection reconfiguration
                                                  ///< ENB completed?
};
