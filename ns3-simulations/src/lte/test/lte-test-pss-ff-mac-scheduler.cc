    ...
    : TestSuite("lte-pss-ff-mac-scheduler", SYSTEM)
{
    ...
    // AddTestCase (new LenaPssFfMacSchedulerTestCase1
    ...
    AddTestCase(new LenaPssFfMacSchedulerTestCase1(6, 4800, 230500, 125000, 200, 1, errorModel),
                TestCase::EXTENSIVE);
    // AddTestCase (new LenaPssFfMacSchedulerTestCase1
    // (12,4800,115250,62000,200,1,errorModel)); // simulation time = 1.5,
    ...
    AddTestCase(new LenaPssFfMacSchedulerTestCase1(6, 6000, 198500, 97000, 200, 1, errorModel),
                TestCase::EXTENSIVE);
    // AddTestCase (new LenaPssFfMacSchedulerTestCase1 (12,6000,99250,48667,200,1,
    ...
    //   UDP header) * 1000 byte/sec -> 232000 byte/rate
    // Maximum throughput = 4 / ( 1/2196000 + 1/1191000 + 1/1383000 + 1/775000 ) =
    // 1209046 byte/s 232000 * 4 = 928000 < 1209046 -> estimated throughput in
    // downlink = 928000 / 4 = 230000 byte/sec
...
LenaPssFfMacSchedulerTestCase1::DoRun()
{
    ...
    for (uint32_t u = 0; u < ueNodes.GetN(); ++u)
    {
        ...
        UdpClientHelper dlClient(ueIpIface.GetAddress(u),
                                 dlPort); // downlink packets generator
        ...
        UdpClientHelper ulClient(remoteHostAddr,
                                 ulPort); // uplink packets generator
