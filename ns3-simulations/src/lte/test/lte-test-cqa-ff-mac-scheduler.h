 ...
 * \ingroup lte-test
 *
 * \brief This is a system test program. The test is based on a scenario with
 * single eNB and several UEs. The goal of the test is validating if the
 * obtained throughput performance is consistent with the definition of CQA
 * scheduler.
 */
 ...
 * single eNB and several UEs. The goal of the test is validating if the
 * obtained throughput performance is consistent with the definition of CQA
 * scheduler when the UEs with different SINRs.
 */
...
class LenaCqaFfMacSchedulerTestCase2 : public TestCase
{
  public:
     ...
     * \param errorModelEnabled whether the error model enabled is enabled in the
     * test case
     */
