...
{
    // Test that handover from eNB to eNB with one carrier works within this
    // framework.
    ...
    // Test that handover from second carrier of first eNB to first carrier of
    // second eNB works.
    ...
    // Test that handover from first carrier of first eNB to first carrier of
    // second eNB works.
    ...
    // Test that handover from second carrier of first eNB to second carrier of
    // second eNB works.
