    ...
    : TestSuite("lte-tta-ff-mac-scheduler", SYSTEM)
{
    ...
    // of 36.213) 1 user -> 24 PRB at Itbs 15 -> 1383 -> 1383000 bytes/sec for one
    ...
    // of 36.213) 1 user -> 24 PRB at Itbs 15 -> 1191 -> 1191000 bytes/sec for one
    ...
    // of 36.213) 1 user -> 24 PRB at Itbs 8 -> 775 -> 775000 bytes/sec for one
...
LenaTtaFfMacSchedulerTestCase::DoRun()
{
    ...
    /**
     * Check that the downlink assignment is done in a "Throughput to Average"
     * manner
     */
    ...
    /**
     * Check that the assignment is done in a "Throughput to Average" manner among
     * users with maximum SINRs: without fading, current FD MT always assign all
     * resources to one UE
     */
