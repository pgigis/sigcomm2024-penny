 ...
 * generate the correct values. Different test cases are created by specifying
 * different antenna configurations and it is tested if for the given
 * information the pathloss value is as expected.
 */
