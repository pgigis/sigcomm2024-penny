 ...
 * \ingroup lte-test
 *
 * \brief Test generation of SINR in the uplink. Test schedules the signal and
 * the interference signals and it evaluates if the obtained value for SINR
 * corresponds to the theoretical value in given conditions.
 */
...
class LteUplinkSrsSinrTestCase : public TestCase
{
  public:
    ...
    /**
     * Callback to be connected to an LteChunkProcessor to collect the reported
     * SINR
     *
     * \param sinr
     */
