    ...
    : TestSuite("lte-tdmt-ff-mac-scheduler", SYSTEM)
{
    ...
    // of 36.213) 1 user -> 24 PRB at Itbs 20 -> 1383 -> 1383000 bytes/sec for one
...
LenaTdMtFfMacSchedulerTestCase::DoRun()
{
    ...
    /**
     * Check that the downlink assignment is done in a "time domain maximum
     * throughput" manner
     */
    ...
    /**
     * Check that the assignment is done in a "time domain maximum throughput"
     * manner among users with maximum SINRs: without fading, current FD MT always
     * assign all resources to one UE
     */
