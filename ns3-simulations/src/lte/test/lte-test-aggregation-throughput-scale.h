...
/**
 * \brief Test suite for executing carrier aggregation throughput scaling test
 * case.
 *
 ...
 * \ingroup lte
 *
 * \brief Testing that UE throughput scales linearly with number of component
 * carriers. Also attaches UE to last component carrier to make sure no code
 * assumes that primary carrier is first.
 */
class LteAggregationThroughputScaleTestCase : public TestCase
{
  public:
    /**
     * \brief Creates an instance of the carrier aggregation throughput scaling
