    ...
    : TestSuite("lte-tdtbfq-ff-mac-scheduler", SYSTEM)
{
    ...
    // 6 user -> 232000 * 6 = 1392000 > 1383000 -> throughput = 1383000 / 6 =
    // 230500 byte/sec 12 user -> 232000 * 12 = 2784000 > 903000 -> throughput =
    ...
    AddTestCase(new LenaTdTbfqFfMacSchedulerTestCase1(6, 4800, 230500, 125000, 200, 1, errorModel),
                TestCase::EXTENSIVE);
    // AddTestCase (new LenaTdTbfqFfMacSchedulerTestCase1
    // (12,4800,115250,62000,200,1,errorModel));
    ...
    // 6 user -> 232000 * 6 = 1392000 > 775000 -> throughput = 775000 / 6 = 129166
    ...
    // Maximum throughput = 4 / ( 1/2196000 + 1/1383000 + 1/1191000 + 1/775000 ) =
    // 1209000 byte/s 132000 * 4 = 528000 < 1209000 -> estimated throughput in
    ...
    // Maximum throughput = 4 / ( 1/2196000 + 1/1383000 + 1/1191000 + 1/775000 ) =
    // 1209000 byte/s 332000 * 4 = 1328000 > 1209000 -> estimated throughput in
    // downlink = 1209000 / 4 = 302500 byte/sec
    ...
    // Maximum throughput = 3 / ( 1/2196000 + 1/1383000 + 1/1191000 ) = 1486666
    // byte/s 132000 + 232000 + 332000 = 696000 < 1486666 -> estimated throughput
