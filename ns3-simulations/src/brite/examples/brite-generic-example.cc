...
main(int argc, char* argv[])
{
    ...
    // The BRITE topology generator generates a topology of routers.  Here we
    // create two subnetworks which we attach to router leaf nodes generated by
    // BRITE Any NS3 topology may be used to attach to the BRITE leaf nodes but
    // here we use just one node
