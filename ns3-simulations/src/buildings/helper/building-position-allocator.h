...
class RandomBuildingPositionAllocator : public PositionAllocator
{
  ...
  private:
    bool m_withReplacement; //!< If true, the building will be randomly selected
                            //!< with replacement
    mutable std::vector<Ptr<Building>> m_buildingListWithoutReplacement; //!< List of building
                                                                         //!< without replacement
