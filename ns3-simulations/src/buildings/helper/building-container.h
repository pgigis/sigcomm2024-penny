 ...
 *
 * Author: Mathieu Lacage <mathieu.lacage@sophia.inria.fr> (original
 * node-container.h) Nicola Baldo (wrote building-container.h based on
 * node-container.h)
 */
...
class BuildingContainer
{
  public:
    ...
    /**
     * Create a BuildingContainer with exactly one building which has been
     * previously instantiated.  The single Building is specified by a smart
     * pointer.
     *
     ...
     *
     * \param buildingName The name of the Building Object to add to the
     * container.
     */
     ...
     * BuildingContainer.
     *
     * Buildings are at the heart of any ns-3 simulation.  One of the first tasks
     * that any simulation needs to do is to create a number of buildings.  This
     * method automates that task.
     *
     ...
     *
     * Whenever a Building is created, a Ptr<Building> is added to a global list
     * of all buildings in the system.  It is sometimes useful to be able to get
     * to all buildings in one place.  This method creates a BuildingContainer
     * that is initialized to contain all of the simulation buildings,
     *
