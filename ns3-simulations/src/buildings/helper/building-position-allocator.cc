    ...
    static TypeId tid =
        TypeId("ns3::RandomBuildingPositionAllocator")
            ...
            .AddAttribute("WithReplacement",
                          "If true, the building will be randomly selected with "
                          "replacement. "
                          "If false, no replacement will occur, until the list of "
                          "buildings "
...
OutdoorPositionAllocator::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::OutdoorPositionAllocator")
            ...
            .AddAttribute("X",
                          "A random variable which represents the x coordinate of a "
                          "position in a "
                          "random box.",
            ...
            .AddAttribute("Y",
                          "A random variable which represents the y coordinate of a "
                          "position in a "
                          "random box.",
                          StringValue("ns3::UniformRandomVariable[Min=0.0|Max=1.0]"),
                          ...
                          MakePointerChecker<RandomVariableStream>())
            .AddAttribute("Z",
                          "A random variable which represents the z coordinate of a "
                          "position in a "
                          "random box.",
                          StringValue("ns3::UniformRandomVariable[Min=0.0|Max=1.0]"),
            ...
            .AddAttribute("MaxAttempts",
                          "Maximum number of attempts for the rejection sampling before "
                          "giving up.",
                          UintegerValue(1000),
    ...
    : m_nodes(c)
{
    ...
    for (auto it = m_nodes.Begin(); it != m_nodes.End(); ++it)
    {
        ...
        NS_ASSERT_MSG(bmm,
                      "MobilityBuildingInfo has not been aggregated to this "
                      "node mobility model");
