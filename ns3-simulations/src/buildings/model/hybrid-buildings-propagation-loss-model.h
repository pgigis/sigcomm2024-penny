 ...
 * \ingroup propagation
 *
 *  \brief The HybridBuildingsPropagationModel is a compound of different models
 * able to evaluate the pathloss from 200 to 2600 MHz, in different environments
 * and with buildings (i.e., indoor and outdoor communications).
 *
 *  This model includes Hata model, COST231, ITU-R P.1411 (short range
 *  communications), ITU-R P.1238 (indoor communications), which are combined in
 * order to be able to evaluate the pathloss under different scenarios, in
 * detail:
 ...
 *  - Node position respect to buildings: indoor, outdoor and hybrid (indoor <->
 * outdoor)
