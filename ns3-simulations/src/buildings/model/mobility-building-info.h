...
class MobilityBuildingInfo : public Object
{
  public:
     ...
     *
     * \param building The building in which the MobilityBuildingInfo instance
     * would be placed
     */
     ...
     *
     * \return true if the MobilityBuildingInfo instance is indoor, false
     * otherwise
     */
    bool IsIndoor();
     ...
     *
     * \param building the building into which the MobilityBuildingInfo instance
     * is located \param nfloor the floor number 1...nFloors at which the
     * MobilityBuildingInfo instance is located \param nroomx the X room
     * number 1...nRoomsX at which the MobilityBuildingInfo instance is located
     * \param nroomy the Y room number 1...nRoomsY at which the
     ...
     * \brief Mark this MobilityBuildingInfo instance as indoor
     *
     * \param nfloor the floor number 1...nFloors at which the
     * MobilityBuildingInfo instance is located \param nroomx the X room
     * number 1...nRoomsX at which the MobilityBuildingInfo instance is located
     * \param nroomy the Y room number 1...nRoomsY at which the
     * MobilityBuildingInfo instance is located
    ...
    /**
     * \brief Get the floor number at which the MobilityBuildingInfo instance is
     * located
     *
    ...
    /**
     * \brief Get the room number along x-axis at which the MobilityBuildingInfo
     * instance is located
     *
    ...
    /**
     * \brief Get the room number along y-axis at which the MobilityBuildingInfo
     * instance is located
     *
     * \return The room number
     */
    ...
    /**
     * \brief Get the building in which the MobilityBuildingInfo instance is
     * located
     *
  ...
  private:
    ...
    uint8_t m_nFloor;           ///< The floor number at which the MobilityBuildingInfo
                                ///< instance is located
    uint8_t m_roomX;            ///< The room number along x-axis at which the
                                ///< MobilityBuildingInfo instance is located
    uint8_t m_roomY;            ///< The room number along y-axis at which the
                                ///< MobilityBuildingInfo instance is located
    Vector m_cachedPosition;    ///< The node position cached after making its
                                ///< mobility model consistent
};
