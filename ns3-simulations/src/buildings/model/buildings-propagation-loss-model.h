...
class BuildingsPropagationLossModel : public PropagationLossModel
{
  ...
  protected:
    ...
    mutable std::map<Ptr<MobilityModel>, std::map<Ptr<MobilityModel>, ShadowingLoss>>
        m_shadowingLossMap;
    /**
     * Calculate the Standard deviation of the normal distribution used to
     * calculate the shadowing \param a Room A data \param b Room B data \return
     * the Standard deviation of the normal distribution
     */
    double EvaluateSigma(Ptr<MobilityBuildingInfo> a, Ptr<MobilityBuildingInfo> b) const;

    /// Standard deviation of the normal distribution used to calculate the
    /// shadowing due to ext walls
    double m_shadowingSigmaExtWalls;
    /// Standard deviation of the normal distribution used to calculate the
    /// shadowing for outdoor nodes
    double m_shadowingSigmaOutdoor;
    /// Standard deviation of the normal distribution used to calculate the
    /// shadowing for indoor nodes
