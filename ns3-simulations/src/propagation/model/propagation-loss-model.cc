    ...
    static TypeId tid =
        TypeId("ns3::RandomPropagationLossModel")
            ...
            .AddAttribute("Variable",
                          "The random variable used to pick a loss every time CalcRxPower "
                          "is invoked.",
...
TwoRayGroundPropagationLossModel::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::TwoRayGroundPropagationLossModel")
            ...
            .AddAttribute("Frequency",
                          "The carrier frequency (in Hz) at which propagation "
                          "occurs  (default is 5.15 GHz).",
                          DoubleValue(5.150e9),
            ...
            .AddAttribute("MinDistance",
                          "The distance under which the propagation model "
                          "refuses to give results (m)",
                          DoubleValue(0.5),
    ...
    static TypeId tid =
        TypeId("ns3::LogDistancePropagationLossModel")
            ...
            .AddAttribute("ReferenceLoss",
                          "The reference loss at reference distance (dB). "
                          "(Default is Friis at 1m "
                          "with 5.15 GHz)",
                          DoubleValue(46.6777),
...
ThreeLogDistancePropagationLossModel::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::ThreeLogDistancePropagationLossModel")
            ...
            .AddAttribute(
                "ReferenceLoss",
                "The reference loss at distance d0 (dB). (Default is Friis at 1m "
                "with 5.15 GHz)",
                DoubleValue(46.6777),
