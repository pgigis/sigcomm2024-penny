                                            ...
                                            double hBs) const
{
    ...
    if (hBs < 10.0 || hBs > 150.0)
    {
        ...
        NS_LOG_WARN("The height of the BS should be between 10 and 150 m (see TR "
                    "38.901, Table 7.4.1-1)");
    }
                                            ...
                                            double hBs) const
{
    ...
    if (hBs != 25.0)
    {
        ...
        NS_LOG_WARN("The height of the BS should be equal to 25 m (see TR 38.901, "
                    "Table 7.4.1-1)");
    }
                                                        ...
                                                        double hBs) const
{
    ...
    if (hUt < 1.5 || hUt >= 10.0)
    {
        ...
        NS_LOG_WARN("The height of the UT should be between 1.5 and 22.5 m (see TR "
                    "38.901, Table 7.4.1-1). "
                    "We further assume hUT < hBS, then hUT is upper bounded by "
                    "hBS, which should be 10 m");
    }

    if (hBs != 10.0)
    {
        NS_ABORT_MSG_IF(m_enforceRanges, "UmiStreetCanyon BS height out of range");
        NS_LOG_WARN("The height of the BS should be equal to 10 m (see TR 38.901, "
                    "Table 7.4.1-1)");
    }
