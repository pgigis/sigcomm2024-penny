    ...
    static TypeId tid =
        TypeId("ns3::ThreeGppChannelConditionModel")
            ...
            .AddAttribute("UpdatePeriod",
                          ...
                          "condition is recomputed. If set to 0, the channel condition is "
                          "never updated.",
            ...
            .AddAttribute("O2iThreshold",
                          ...
                          "conditions. Default value is 0 that corresponds to 0 "
                          "O2I losses.",
                          DoubleValue(0.0),
            ...
            .AddAttribute("LinkO2iConditionToAntennaHeight",
                          ...
                          "be determined based on the UE height, i.e. if the UE height is "
                          "1.5 then "
                          "it is O2O, "
                          "otherwise it is O2I.",
                          BooleanValue(false),
