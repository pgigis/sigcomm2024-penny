...
class ThreeGppV2vUrbanPropagationLossModel : public ThreeGppPropagationLossModel
{
  ...
  private:
     ...
     * GetO2iLowPenetrationLoss/GetO2iHighPenetrationLoss functions.
     *
     *        TODO O2I car penetration loss (TR 38.901 7.4.3.2) not considered
     *
     * \return Returns 02i 2D distance (in meters) used to calculate low/high
     * losses.
     */
    ...
    /**
     * \brief Computes the additional loss due to an obstruction caused by a
     * vehicle \param distance3D the 3D distance between tx and rx in meters
     * \param hUt the height of the UT in meters
     * \param hBs the height of the BS in meters
     * \return pathloss value in dB
     */
    ...
    double m_percType3Vehicles;               //!< percentage of Type 3 vehicles in the
                                              //!< scenario (i.e., trucks)
