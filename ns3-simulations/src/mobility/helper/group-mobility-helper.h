...
class GroupMobilityHelper
{
  ...
  private:
    ...
    bool m_referencePositionSet{false};     //!< flag for avoiding multiple SetPosition calls on the
                                            //!< reference model
    Ptr<MobilityModel> m_referenceMobility; //!< Reference mobility model
    Ptr<PositionAllocator> m_referencePosition; //!< Position allocator for use as
                                                //!< reference position allocator
    ObjectFactory m_memberMobilityFactory;      //!< Object factory to create member
                                                //!< mobility models
    Ptr<PositionAllocator> m_memberPosition;    //!< Position allocator for use as
                                                //!< member position allocator
};
