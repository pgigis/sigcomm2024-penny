...
class MobilityHelper
{
  public:
    ...
    /**
     * \brief Layout a collection of nodes according to the current position
     * allocator type.
     *
     * For each node in the provided NodeContainer, this method creates an
     * instance of a ns3::MobilityModel subclass (the type of which was set with
  ...
  private:
    ...
    Ptr<PositionAllocator> m_position;               //!< Position allocator for use in
