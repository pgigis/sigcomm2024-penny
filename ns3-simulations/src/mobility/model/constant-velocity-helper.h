...
class ConstantVelocityHelper
{
  public:
     ...
     * \param rectangle 2D bounding rectangle for resulting position; object will
     * not move outside the rectangle
     */
    void UpdateWithBounds(const Rectangle& rectangle) const;
    /**
     * Update position, if not paused, from last position and time of last update
     * \param bounds 3D bounding box for resulting position; object will not move
     * outside the box
     */
