...
class GeographicPositions
{
  public:
     ...
     *
     * Moritz, H. "Geodetic Reference System 1980." GEODETIC REFERENCE SYSTEM
     * 1980.
     ...
     *
     * @param pos a vector containing the Cartesian coordinates (x, y, z
     * referenced in meters) of the point (origin (0, 0, 0) is center of earth)
     * @param sphType earth spheroid model to use for conversion
     *
     ...
     * a given origin point (on earth's surface, in geographic/geodetic
     * coordinates) within a given distance radius (using arc length of earth's
     * surface, not pythagorean distance). Distance radius is measured as if all
     * generated points are on earth's surface (with altitude = 0). Assumes earth
     * is a perfect sphere.
     *
