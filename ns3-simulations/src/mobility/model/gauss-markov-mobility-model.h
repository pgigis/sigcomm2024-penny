 ...
 * Thanks to Kevin Peters, faculty advisor James P.G. Sterbenz, and the
 * ResiliNets initiative at The University of Kansas, https://resilinets.org
 */
 ...
 * based upon the previous value, the mean value, and a gaussian random
 variable.
 ...
 * version of the "rectangle" field that is used in 2-dimensional ns-3 mobility
 models.
 *
 * Here is an example of how to implement the model and set the initial node
 positions:
 * \code
 ...
 ("ns3::UniformRandomVariable[Min=800|Max=1200]"), "MeanDirection", StringValue
 ("ns3::UniformRandomVariable[Min=0|Max=6.283185307]"), "MeanPitch", StringValue
 ("ns3::UniformRandomVariable[Min=0.05|Max=0.05]"), "NormalVelocity",
 StringValue ("ns3::NormalRandomVariable[Mean=0.0|Variance=0.0|Bound=0.0]"),
      "NormalDirection", StringValue
 ("ns3::NormalRandomVariable[Mean=0.0|Variance=0.2|Bound=0.4]"), "NormalPitch",
