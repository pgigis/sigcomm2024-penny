    ...
    static TypeId tid =
        TypeId("ns3::GaussMarkovMobilityModel")
            ...
            .AddAttribute("TimeStep",
                          ...
                          MakeTimeChecker())
            .AddAttribute("Alpha",
                          "A constant representing the tunable parameter in the "
                          "Gauss-Markov model.",
                          DoubleValue(1.0),
            ...
            .AddAttribute("NormalVelocity",
                          "A gaussian random variable used to calculate the next velocity "
                          "value.",
            ...
            .AddAttribute("NormalDirection",
                          "A gaussian random variable used to calculate the next direction "
                          "value.",
            ...
            .AddAttribute("NormalPitch",
                          "A gaussian random variable used to calculate the next pitch "
                          "value.",
                          StringValue("ns3::NormalRandomVariable[Mean=0.0|Variance=1.0|"
                                      "Bound=10.0]"),
