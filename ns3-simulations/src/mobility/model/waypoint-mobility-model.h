...
class WaypointMobilityModel : public MobilityModel
{
  ...
  private:
    friend class ::WaypointMobilityModelNotifyTest; // To allow Update() calls
                                                    // and access to m_current
  ...
  protected:
    /**
     * \brief This variable is set to true if there are no waypoints in the
     * std::deque
     */
    bool m_first;
    /**
