...
class Rectangle
{
  public:
     ...
     * \return true if the input position is located within the rectangle, false
     * otherwise.
     *
    ...
    /**
     * \param position the position to test.
     * \return true if the input position is located on the rectable border, false
     * otherwise.
     *
     * This method compares only the x and y coordinates of the input position.
     * It ignores the z coordinate.
     ...
     * (xMin, yMin) is the BOTTOMLEFTCORNER,  the TOP and BOTTOM sides are
     * parallel to the x-axis, the LEFT and RIGHT sides are parallel to the
     * y-axis, and the (xMax, yMax) point is the TOPRIGHTCORNER.
     *
     * Beware: the method has an ambiguity in the "center" of the rectangle.
     * Assume a rectangle between the points (0, 0) and (4, 2), i.e., wider than
     * taller. All the points on the line between (1, 1) and (3, 1) are equally
     * closer to the TOP and BOTTOM than to the other sides of the Rectangle.
     ...
     * classified as RIGHTSIDE, and for a square box, the center will return
     * RIGHTSIDE.
     */
     ...
     * \return the intersection point between the rectangle and the current+speed
     * vector.
     *
