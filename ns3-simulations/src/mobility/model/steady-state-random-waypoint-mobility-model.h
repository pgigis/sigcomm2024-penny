 ...
 * The implementation of this model is 2D-specific and with nonzero nodes
 * speeds. In the 3D ns-3 coordinate system, the movement occurs on the \f$
 * z=\overline{Z} \f$ plane, where \f$ \overline{Z} \f$ is a constant which can
 * be configured using the Z attribute.
 *
