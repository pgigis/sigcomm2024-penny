...
/// \ingroup olsr
/// This class encapsulates all data structures needed for maintaining internal
...
class OlsrState
{
  ...
  protected:
    ...
    IfaceAssocSet m_ifaceAssocSet;         //!< Interface Association Set (\RFC{3626},
                                           //!< section 4.1).
    AssociationSet m_associationSet;       //!< Association Set (\RFC{3626},
                                           //!< section12.2). Associations obtained from
                                           //!< HNA messages generated by other nodes.
    Associations m_associations;           //!< The node's local Host Network Associations
                                           //!< that will be advertised using HNA messages.
  ...
  public:
     ...
     * \returns The 2-hop neighbor tuple, if found. Else it returns a null
     * pointer.
     */
