...
//     <TAP-network-address>/<TAP-network-mask> -j MASQUERADE
//
//  3) Before running the example make sure that the tap creator binary has root
//  suid.
...
//
//     ./ns3 run fd-tap-ping --command-template="%s
//     --tapNetwork=<TAP-network-address>
