...
//     build/src/fd-net-device/ns3-dev-netmap-device-creator $ sudo chmod 4755
//     build/src/fd-net-device/ns3-dev-netmap-device-creator
...
main(int argc, char* argv[])
{
    ...
    //
    // Enable a promiscuous pcap trace to see what is coming and going on our
    // device.
    //
