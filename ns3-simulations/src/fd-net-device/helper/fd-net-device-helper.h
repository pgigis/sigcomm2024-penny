...
class FdNetDeviceHelper : public PcapHelperForDevice, public AsciiTraceHelperForDevice
{
  public:
    ...
    /**
     * This method creates a FdNetDevice and associates it to a node.
     * For each Ptr<node> in the provided container: it creates an
     * ns3::FdNetDevice (with the attributes  configured by
     * FdNetDeviceHelper::SetDeviceAttribute); adds the device to the node; and
