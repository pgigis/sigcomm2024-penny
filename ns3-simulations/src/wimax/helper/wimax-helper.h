...
class WimaxHelper : public PcapHelperForDevice, public AsciiTraceHelperForDevice
{
  public:
    ...
    /**
     * \brief Enable ascii trace output on the indicated net device for a given
     * connection \param oss The output stream object to use when logging ascii
     * traces. \param nodeid the id of the node for which you want to enable
     * tracing. \param deviceid the id of the net device for which you want to
     * enable tracing. \param netdevice the type of net device for which you want
     * to enable tracing (SubscriberStationNetDevice, BaseStationNetDevice or
     * WimaxNetDevice) \param connection the connection for which you want to
     * enable tracing (InitialRangingConnection, BroadcastConnection,
     * BasicConnection, PrimaryConnection).
     */
    ...
    /**
     * \brief Set the propagation and loss model of the channel. By default the
     * channel uses a COST231 propagation and loss model. \param propagationModel
     * The propagation and loss model to set
     */
    ...
    /**
     * \param phyType WiMAX Physical layer type
     * \param SNRTraceFilePath the path to the repository containing the SNR
     * traces files \param activateLoss set to 1 if you want ton activate losses 0
     * otherwise \return WiMAX Phy object
     *
     ...
     * \param schedulinType The service scheduling type to be used: UGS, RTPS,
     * NRTPS, BE \param classifier The classifier to be used for this service flow
     * \return ServiceFlow
     *
     */
