    ...
    static TypeId tid =
        TypeId("ns3::BaseStationNetDevice")
            ...
            .AddAttribute("InitialRangInterval",
                          "Time between Initial Ranging regions assigned by the "
                          "BS. Maximum is 2s",
            ...
            .AddAttribute("DcdInterval",
                          "Time between transmission of DCD messages. Maximum "
                          "value is 10s.",
                          TimeValue(Seconds(3)),
            ...
            .AddAttribute("UcdInterval",
                          "Time between transmission of UCD messages. Maximum "
                          "value is 10s.",
                          TimeValue(Seconds(3)),
                              ...
                              Ptr<WimaxConnection> connection)
{
    NS_ASSERT_MSG(connection,
                  "BS: Can not enqueue packet on the selected "
                  "connection: the connection is not initialized");
