...
/**
 * \ingroup wimax
 * \brief This class implements the Type-Len-Value structure channel encodings
 * as described by "IEEE Standard for Local and metropolitan area networks Part
...
/**
 * \ingroup wimax
 * \brief this class is used to implement a vector of values in one tlv value
 * field
 */
...
/**
 * \ingroup wimax
 * \brief this class implements the convergence sub-layer descriptor as a tlv
 * vector
 */
