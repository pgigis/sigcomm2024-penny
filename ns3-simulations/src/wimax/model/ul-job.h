...
/**
 * \ingroup wimax
 * \brief this class implements a structure to compute the priority of service
 * flows
 */
...
{
    /**
     * \brief this class implements an auxiliary struct to compute the priority of
     * the rtPS and nrtPS in the intermediate queue
     */
  public:
    PriorityUlJob();
    /**
