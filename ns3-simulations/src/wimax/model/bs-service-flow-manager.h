...
class BsServiceFlowManager : public ServiceFlowManager
{
  public:
     ...
     * \return the list of service flows configured with schedulingType as a QoS
     * class
     */
     ...
     * \param cid the identifier of the connection on which the message was
     * received
     */
     ...
     * \param cid the identifier of the connection on which the message was
     * received \return a pointer to the service flow
     */
