...
/**
 * \ingroup wimax
 * \brief This class implements a Migration-based Quality of Service uplink
 * scheduler(MBQoS).
 *
 ...
 * Freitag, J.; da Fonseca, N.L.S., "Uplink Scheduling with Quality of Service
 * in IEEE 802.16 Networks," Global Telecommunications Conference, 2007.
 * GLOBECOM '07. IEEE , vol., no., pp.2503-2508, 26-30 Nov. 2007 URL:
...
class UplinkSchedulerMBQoS : public UplinkScheduler
{
  public:
    ...
    /**
     * \param availableSymbols available symbols in the uplink frame.
     * \brief Check if Minimum bandwidth is guarantee. Migrate requests if
     * necessary.
     *
