...
class BaseStationNetDevice : public WimaxNetDevice
{
  public:
    ...
    /**
     * \param initialRangInterval Time between initial ranging regions assigned by
     * the BS
     */
    void SetInitialRangingInterval(Time initialRangInterval);
    /**
     * \brief initializes the BS net device and sets its parameters to the default
     * values
     */
    ...
    /**
     * \param maxRangCorrectionRetries the number of retries on contention Ranging
     * Requests
     */
