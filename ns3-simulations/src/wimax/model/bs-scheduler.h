...
class BSScheduler : public Object
{
  public:
     ...
     * be sent . \param connection will point to a connection that have packets to
    ...
    /**
     * \brief Check if the packet fragmentation is possible for transport
     * connection. \param connection the downlink connection \param
