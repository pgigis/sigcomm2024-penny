...
/**
 * \ingroup wimax
 * This class Represents the HT (Header Type) field of generic MAC and bandwidth
 * request headers \see GenericMacHeader \see BandwidthRequestHeader
 */
...
/**
 * \ingroup wimax
 * This class implements the Generic mac Header as described by IEEE Standard
 * for Local and metropolitan area networks Part 16: Air Interface for Fixed
 * Broadband Wireless Access Systems 6.3.2.1.1 Generic MAC header, page 36
 */
class GenericMacHeader : public Header
{
  ...
  private:
    ...
    uint8_t c_hcs;  ///< calculated header check sequence; this is used to check
                    ///< if the received header is correct or not
};
...
/**
 * \ingroup wimax
 * This class implements the bandwidth-request mac Header as described by IEEE
 * Standard for Local and metropolitan area networks Part 16: Air Interface for
 * Fixed Broadband Wireless Access Systems 6.3.2.1.2 Bandwidth request header,
 * page 38
 */
...
/**
 * \ingroup wimax
 * This class implements the grant management sub-header as described by IEEE
 * Standard for Local and metropolitan area networks Part 16: Air Interface for
 * Fixed Broadband Wireless Access Systems 6.3.2.2.2 Grant Management subheader,
 * page 40
 */
...
/**
 * \ingroup wimax
 * This class implements the fragmentation sub-header as described by IEEE
 * Standard for Local and metropolitan area networks Part 16: Air Interface for
 * Fixed Broadband Wireless Access Systems 6.3.2.2.1 Fragmentation subheader,
 * page 39
 */
