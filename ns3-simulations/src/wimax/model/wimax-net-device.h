 ...
 * This section documents the API of the ns-3 wimax module. For a generic
...
class WimaxNetDevice : public NetDevice
{
  public:
     ...
     * \param  connectionManager the commection manager to be installed in the
     * device
     */
     ...
     * \param burstProfileManager the burst profile manager to be installed on the
     * device
     */
    ...
    static Time m_frameStartTime; ///< temp, to determine the frame start time at
                                  ///< SS side, shall actually be determined by
  ...
  private:
    ...
    /// temp, shall be in BS. defined here to allow SS to access. SS shall
    /// actually determine it from DLFP, shall be moved to BS after DLFP is
    /// implemented
