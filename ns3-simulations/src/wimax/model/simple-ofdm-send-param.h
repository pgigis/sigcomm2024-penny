...
class SimpleOfdmSendParam
{
  public:
    ...
    /**
     * \param isFirstBlock Set to true if this fec block is the first one in the
     * burst, set to false otherwise
     */
    void SetIsFirstBlock(bool isFirstBlock);
    /**
     * \param Frequency set the frequency of the channel in which this fec block
     * will be sent
     */
    ...
    /**
     * \return true if this fec block is the first one in the burst, false
     * otherwise
     */
