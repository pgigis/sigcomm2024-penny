...
/**
 * \ingroup wimax
 * \brief This class is used by the base station to store some information
 * related to subscriber station in the cell.
 */
class SSRecord
{
  public:
  ...
  private:
    ...
    WimaxPhy::ModulationType m_modulationType;     ///< least robust burst profile
                                                   ///< (modulation type) for this SS
