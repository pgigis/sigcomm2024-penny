...
class SimpleOfdmWimaxPhy : public WimaxPhy
{
  public:
    ...
    /**
     * Public method used to fire a PhyTxBegin trace.  Implemented for
     * encapsulation purposes. \param burst the packet burst
     */
    ...
    /**
     * Public method used to fire a PhyTxDrop trace.  Implemented for
     * encapsulation purposes. \param burst the packet burst
     */
    void NotifyTxDrop(Ptr<PacketBurst> burst);

    /**
     * Public method used to fire a PhyRxBegin trace.  Implemented for
     * encapsulation purposes. \param burst the packet burst
     */
    ...
    /**
     * Public method used to fire a PhyRxDrop trace.  Implemented for
     * encapsulation purposes. \param burst the packet burst
     */
  ...
  private:
    ...
    uint16_t m_fecBlockSize;     ///< in bits, size of FEC block transmitted after
                                 ///< PHY operations
    uint32_t m_currentBurstSize; ///< current burst size

    std::list<Bvec>* m_receivedFecBlocks; ///< a list of received FEC blocks until they are
                                          ///< combined to recreate the full burst buffer
    uint32_t m_nrFecBlocksSent;           ///< counting the number of FEC blocks sent
                                          ///< (within a burst)
