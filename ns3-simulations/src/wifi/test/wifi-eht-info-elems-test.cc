...
BasicMultiLinkElementTest::DoRun()
{
    ...
    NS_TEST_EXPECT_MSG_EQ((perSta1Frame.Get<SupportedRates>() == frame.Get<SupportedRates>()),
                          true,
    ...
    NS_TEST_EXPECT_MSG_EQ((perSta1Frame.Get<HeCapabilities>() == frame.Get<HeCapabilities>()),
                          true,
    ...
    NS_TEST_EXPECT_MSG_EQ((perSta1Frame.Get<EhtCapabilities>() == frame.Get<EhtCapabilities>()),
                          true,
    ...
    NS_TEST_EXPECT_MSG_EQ((perSta2Frame.Get<SupportedRates>() == frame.Get<SupportedRates>()),
                          true,
                          "Supported Rates IE not correctly inherited by frame in second Per-STA "
                          "Profile");
    NS_TEST_EXPECT_MSG_EQ(perSta2Frame.Get<ExtendedSupportedRatesIE>().has_value(),
                          true,
    ...
    NS_TEST_EXPECT_MSG_EQ((perSta2Frame.Get<HeCapabilities>() == frame.Get<HeCapabilities>()),
                          true,
    ...
    NS_TEST_EXPECT_MSG_EQ(perSta2Frame.Get<EhtCapabilities>().has_value(),
                          false,
    ...
    NS_TEST_EXPECT_MSG_EQ((perSta3Frame.Get<SupportedRates>() == frame.Get<SupportedRates>()),
                          true,
    ...
    NS_TEST_EXPECT_MSG_EQ((perSta3Frame.Get<HeCapabilities>() == frame.Get<HeCapabilities>()),
                          true,
    ...
    NS_TEST_EXPECT_MSG_EQ(perSta3Frame.Get<EhtCapabilities>().has_value(),
                          true,
                          "Frame in third Per-STA Profile should have inherited "
                          "EHT Capabilities IE");
    NS_TEST_EXPECT_MSG_EQ((perSta3Frame.Get<EhtCapabilities>() == frame.Get<EhtCapabilities>()),
                          true,
