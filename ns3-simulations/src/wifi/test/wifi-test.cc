...
Bug730TestCase::DoRun()
{
    ...
    NS_TEST_ASSERT_MSG_EQ(result,
                          true,
                          "packet reception unexpectedly stopped after adapting "
...
{
    {
        ...
        NS_TEST_ASSERT_MSG_EQ(m_addbaPendingCount,
                              2,
                              "Incorrect number of times the ADDBA state machine "
                              "was in pending state on subtest 1");
        NS_TEST_ASSERT_MSG_EQ(m_addbaRejectedCount,
                              0,
                              "Incorrect number of times the ADDBA state machine "
                              "was in rejected state on subtest 1");
        NS_TEST_ASSERT_MSG_EQ(m_addbaNoReplyCount,
                              1,
                              "Incorrect number of times the ADDBA state machine "
                              "was in no_reply state on subtest 1");
        NS_TEST_ASSERT_MSG_EQ(m_addbaResetCount,
                              1,
                              "Incorrect number of times the ADDBA state machine "
                              "was in reset state on subtest 1");
    }
...

    {
        ...
        NS_TEST_ASSERT_MSG_EQ(m_addbaPendingCount,
                              2,
                              "Incorrect number of times the ADDBA state machine "
                              "was in pending state on subtest 2");
        NS_TEST_ASSERT_MSG_EQ(m_addbaRejectedCount,
                              0,
                              "Incorrect number of times the ADDBA state machine "
                              "was in rejected state on subtest 2");
        NS_TEST_ASSERT_MSG_EQ(m_addbaNoReplyCount,
                              1,
                              "Incorrect number of times the ADDBA state machine "
                              "was in no_reply state on subtest 2");
        NS_TEST_ASSERT_MSG_EQ(m_addbaResetCount,
                              1,
                              "Incorrect number of times the ADDBA state machine "
...
IdealRateManagerChannelWidthTest::DoRun()
{
    ...
    Config::Connect("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Phy/$ns3::WifiPhy/"
                    "PhyTxPsduBegin",
...
IdealRateManagerMimoTest::IdealRateManagerMimoTest()
    : TestCase("Test case for use of imbalanced MIMO settings with Ideal rate "
               "manager")
{
}
