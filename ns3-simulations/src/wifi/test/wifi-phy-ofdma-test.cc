...
static const uint16_t DEFAULT_GUARD_WIDTH = DEFAULT_CHANNEL_WIDTH; // MHz (expanded to channel width
                                                                   // to model spectrum mask)
...
class OfdmaSpectrumWifiPhy : public SpectrumWifiPhy
{
  ...
  private:
    ...
    TracedCallback<uint64_t> m_phyTxPpduUidTrace; //!< Callback providing UID of the PPDU that is
                                            ...
                                            uint32_t expectedBytes)
{
    ...
    NS_TEST_ASSERT_MSG_EQ(m_countRxFailureFromSta1,
                          expectedFailures,
                                            ...
                                            uint32_t expectedBytes)
{
    ...
    NS_TEST_ASSERT_MSG_EQ(m_countRxFailureFromSta2,
                          expectedFailures,
                          "The number of unsuccessfuly received packets from STA "
                          "2 is not correct!");
