...
class Wifi20MHzIndicesCoveringRuTest : public TestCase
{
  public:
    ...
    /**
     * Check that the indices of the 20 MHz channels covering the given RU as
     * computed by WifiPhyOperatingChannel::Get20MHzIndicesCoveringRu() are
     * correct.
     *
     ...
     * allocated \param indices the expected indices
     */
...
Wifi20MHzIndicesCoveringRuTest::DoRun()
{
    ...
    for (uint8_t p20Index = 0; p20Index < 8; p20Index++)
    {
        ...
        {
            // RUs can be allocated in one (or more) of the four 20 MHz channels in
            // P80/S80 (depending on the primary80MHz flag)
