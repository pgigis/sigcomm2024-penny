...
SpectrumWifiPhyListenerTest::DoRun()
{
    ...
    NS_TEST_ASSERT_MSG_EQ(m_listener->m_notifyMaybeCcaBusyStart,
                          2,
...
SpectrumWifiPhyMultipleInterfacesTest::DoRun()
{
    ...
    const auto checkResultsDelay = Seconds(0.5); ///< delay in seconds between start of test and
                                                 ///< moment results are verified
    const auto flushResultsDelay = Seconds(0.9); ///< delay in seconds between start of test and
                                                 ///< moment results are flushed
    const auto txOngoingAfterTxStartedDelay =
        MicroSeconds(50); ///< delay in microseconds between a transmission has started and a
