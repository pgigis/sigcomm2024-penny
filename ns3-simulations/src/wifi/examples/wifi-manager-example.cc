...
main(int argc, char* argv[])
{
    ...
    cmd.AddValue("standard",
                 "Set standard (802.11a, 802.11b, 802.11g, 802.11p-10MHz, "
                 "802.11p-5MHz, 802.11n-5GHz, "
                 "802.11n-2.4GHz, 802.11ac, 802.11ax-6GHz, 802.11ax-5GHz, "
                 "802.11ax-2.4GHz)",
                 standard);
    ...
    if (!infrastructure)
    {
        NS_ABORT_MSG_IF(serverNss != clientNss,
                        "In ad hoc mode, we assume sender and receiver are "
