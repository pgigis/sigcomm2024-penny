...
class VhtCapabilities : public WifiInformationElement
{
  public:
    ...
    /**
     * Set the VHT Capabilities Info field in the VHT Capabilities information
     * element.
     *
     * \param ctrl the VHT Capabilities Info field in the VHT Capabilities
     * information element
     */
     ...
     *
     * \param ctrl the MCS and NSS field in the VHT Capabilities information
     * element
     */
    void SetSupportedMcsAndNssSet(uint64_t ctrl);

    /**
     * Return the VHT Capabilities Info field in the VHT Capabilities information
     * element.
     *
     * \return the VHT Capabilities Info field in the VHT Capabilities information
     * element
  ...
  private:
    ...
    uint16_t m_rxHighestSupportedLongGuardIntervalDataRate; ///< receive highest
                                                            ///< supported long guard
                                                            ///< interval data rate
    std::vector<uint8_t> m_txMcsMap;                        ///< transmit MCS map
    uint16_t m_txHighestSupportedLongGuardIntervalDataRate; ///< transmit highest
                                                            ///< supported long guard
                                                            ///< interval data rate
};
