    ...
    static ns3::TypeId tid =
        ns3::TypeId("ns3::VhtConfiguration")
            ...
            .AddAttribute("SecondaryCcaSensitivityThresholds",
                          "Tuple {threshold for 20MHz PPDUs, threshold for 40MHz PPDUs, "
                          "threshold "
                          "for 80MHz PPDUs} "
                          "describing the CCA sensitivity thresholds for PPDUs that do not "
                          "occupy "
                          "the primary channel. "
                          "The power of a received PPDU that does not occupy the primary "
                          "channel "
                          "should be higher than "
                          "the threshold (dBm) associated to the PPDU bandwidth to allow "
                          "the PHY "
