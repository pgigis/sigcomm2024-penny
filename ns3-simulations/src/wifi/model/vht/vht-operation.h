...
class VhtOperation : public WifiInformationElement
{
  public:
     ...
     *
     * \param channelWidth the Channel Width field in the VHT Operation
     * information element
     */
    void SetChannelWidth(uint8_t channelWidth);
    /**
     * Set the Channel Center Frequency Segment 0 field in the VHT Operation
     * information element.
     *
     * \param channelCenterFrequencySegment0 the Channel Center Frequency Segment
     * 0 field in the VHT Operation information element
     */
    void SetChannelCenterFrequencySegment0(uint8_t channelCenterFrequencySegment0);
    /**
     * Set the Channel Center Frequency Segment 1 field in the VHT Operation
     * information element.
     *
     * \param channelCenterFrequencySegment1 the Channel Center Frequency Segment
     * 1 field in the VHT Operation information element
     */
    void SetChannelCenterFrequencySegment1(uint8_t channelCenterFrequencySegment1);
    /**
     * Set the Basic VHT-MCS and NSS field in the VHT Operation information
     * element.
     *
     * \param basicVhtMcsAndNssSet the Basic VHT-MCS and NSS field in the VHT
     * Operation information element
     */
    void SetBasicVhtMcsAndNssSet(uint16_t basicVhtMcsAndNssSet);
    /**
     * Set the Basic VHT-MCS and NSS field in the VHT Operation information
     * element by specifying the tuple (nss, maxMcs).
     *
     * \param nss the NSS
     * \param maxVhtMcs the maximum supported VHT-MCS value corresponding to that
     * NSS
     */
    ...
    /**
     * Return the Channel Center Frequency Segment 0 field in the VHT Operation
     * information element.
     *
     * \return the Channel Center Frequency Segment 0 field in the VHT Operation
     * information element
    ...
    /**
     * Return the Channel Center Frequency Segment 1 field in the VHT Operation
     * information element.
     *
     * \return the Channel Center Frequency Segment 1 field in the VHT Operation
     * information element
    ...
    /**
     * Return the Basic VHT-MCS And Nss field in the VHT Operation information
     * element.
     *
     * \return the Basic VHT-MCS And Nss field in the VHT Operation information
     * element
