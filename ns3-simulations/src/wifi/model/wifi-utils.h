...
/**
 * Wifi direction. Values are those defined for the TID-to-Link Mapping Control
 * Direction field in IEEE 802.11be D3.1 Figure 9-1002ap
 */
 ...
 *
 * This method checks if the MPDU's sequence number is inside the scoreboard
 * boundaries or not
 */
 ...
 * have been added.
 *
 * \param packet the packet to be encapsulated with WifiMacHeader and FCS
 * trailer \param hdr the WifiMacHeader \param isAmpdu whether packet is part of
 * an A-MPDU \return the total packet size
 */
uint32_t GetSize(Ptr<const Packet> packet, const WifiMacHeader* hdr, bool isAmpdu);

/**
 * Check if the given TID-to-Link Mappings are valid for a negotiation type
 * of 1. Specifically, it is checked whether all TIDs are mapped to the same set
 * of links.
 *
 ...
 * \return whether the given TID-to-Link Mappings are valid for a negotiation
 * type of 1
 */
...
/// Size of the half the space of sequence numbers (used to determine old
/// packets)
