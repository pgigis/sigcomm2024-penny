 ...
 * \ingroup wifi
 *
 * This class knows how to serialise and deserialise the Reduced Neighbor Report
 * element.
 */
class ReducedNeighborReport : public WifiInformationElement
{
  public:
    ...
    struct NeighborApInformation
    {
        ...
        bool hasShortSsid{false}; //!< whether Short SSID is present in all TBTT
                                  //!< Information fields
        bool hasBssParams{false}; //!< whether BSS parameters is present in all
                                  //!< TBTT Information fields
        bool has20MHzPsd{false};  //!< whether 20 MHz PSD is present in all TBTT
                                  //!< Information fields
        bool hasMldParams{false}; //!< whether MLD Parameters is present in all
                                  //!< TBTT Information fields
    };
    ...
    /**
     * Get the operating channel coded into the Operating Class and the Channel
     * Number fields of the given Neighbor AP Information field.
     *
     * \param nbrApInfoId identifier of the given Neighbor AP Information field
    ...
    /**
     * Get the number of TBTT Information fields included in the TBTT Information
     * Set field of the given Neighbor AP Information field
     *
     * \param nbrApInfoId identifier of the given Neighbor AP Information field
    ...
    /**
     * Return true if the BSSID field is present in all the TBTT Information
    ...
    /**
     * Get the BSSID field (must be present) in the <i>i</i>-th TBTT Information
    ...
    /**
     * Set the Short SSID field of the <i>i</i>-th TBTT Information field of the
     * given Neighbor AP Information field
     *
     * \param nbrApInfoId identifier of the given Neighbor AP Information field
     * \param index the index of the given TBTT Information field
    ...
    /**
     * Return true if the Short SSID field is present in all the TBTT Information
     * fields of the given Neighbor AP Information field.
     *
     * \param nbrApInfoId identifier of the given Neighbor AP Information field
    ...
    /**
     * Get the Short SSID field (must be present) in the <i>i</i>-th TBTT
     * Information field of the given Neighbor AP Information field.
     *
     * \param nbrApInfoId identifier of the given Neighbor AP Information field
     * \param index the index of the given TBTT Information field
    ...
    /**
     * Set the BSS Parameters field of the <i>i</i>-th TBTT Information field of
     * the given Neighbor AP Information field
     *
     * \param nbrApInfoId identifier of the given Neighbor AP Information field
     * \param index the index of the given TBTT Information field
    ...
    /**
     * Return true if the BSS Parameters field is present in all the TBTT
     * Information fields of the given Neighbor AP Information field.
     *
     * \param nbrApInfoId identifier of the given Neighbor AP Information field
    ...
    /**
     * Get the BSS Parameters field (must be present) in the <i>i</i>-th TBTT
     * Information field of the given Neighbor AP Information field.
     *
     * \param nbrApInfoId identifier of the given Neighbor AP Information field
     * \param index the index of the given TBTT Information field
    ...
    /**
     * Set the 20 MHz PSD field of the <i>i</i>-th TBTT Information field of the
     * given Neighbor AP Information field
     *
     * \param nbrApInfoId identifier of the given Neighbor AP Information field
     * \param index the index of the given TBTT Information field
    ...
    /**
     * Return true if the 20 MHz PSD field is present in all the TBTT Information
     * fields of the given Neighbor AP Information field.
     *
     * \param nbrApInfoId identifier of the given Neighbor AP Information field
    ...
    /**
     * Get the 20 MHz PSD field (must be present) in the <i>i</i>-th TBTT
     * Information field of the given Neighbor AP Information field.
     *
     * \param nbrApInfoId identifier of the given Neighbor AP Information field
     * \param index the index of the given TBTT Information field
    ...
    /**
     * Set the MLD Parameters subfield of the <i>i</i>-th TBTT Information field
     * of the given Neighbor AP Information field
     *
     * \param nbrApInfoId identifier of the given Neighbor AP Information field
     * \param index the index of the given TBTT Information field
    ...
    /**
     * Return true if the MLD Parameters subfield is present in all the TBTT
     * Information fields of the given Neighbor AP Information field.
     *
     * \param nbrApInfoId identifier of the given Neighbor AP Information field
    ...
    /**
     * Get the MLD ID value in the MLD Parameters subfield (must be present) in
     * the <i>i</i>-th TBTT Information field of the given Neighbor AP Information
     * field.
     *
     * \param nbrApInfoId identifier of the given Neighbor AP Information field
     * \param index the index of the given TBTT Information field
    ...
    /**
     * Get the Link ID value in the MLD Parameters subfield (must be present) in
     * the <i>i</i>-th TBTT Information field of the given Neighbor AP Information
     * field.
     *
     * \param nbrApInfoId identifier of the given Neighbor AP Information field
  ...
  private:
    /**
     * Set the TBTT Information Count field of the given Neighbor AP Information
     * field based on the size of the tbttInformationSet field.
     *
     * This method is marked as const because it needs to be called within the
     * SerializeInformationField method. In fact, only when serializing this
     * object we can set the TBTT Information Count field based on the number of
     * TBTT Information fields included in the given Neighbor AP Information
     * field.
     *
     * \param nbrApInfoId identifier of the given Neighbor AP Information field
     */
    ...
    /**
     * Get the TBTT Information Count field of the given Neighbor AP Information
     * field.
     *
     * \param nbrApInfoId identifier of the given Neighbor AP Information field
    ...
    /**
     * Set the TBTT Information Length field of the given Neighbor AP Information
     * field based on the xxxPresent flags of the NeighborApInformation struct
     *
     * This method is marked as const because it needs to be called within the
     * SerializeInformationField method. In fact, only when serializing this
     * object we can set the TBTT Information Length field based on the TBTT
    ...
    /**
     * Use the TBTT Information Length field of the given Neighbor AP Information
     * field to set the xxxPresent flags of the NeighborApInformation struct
     *
     * \param nbrApInfoId identifier of the given Neighbor AP Information field
     */
