...
class BlockAckWindow
{
  public:
    ...
    /**
     * Get a const reference to the element in the window having the given
     * distance from the current winStart. Note that the given distance must be
     * less than the window size.
     *
     * \param distance the given distance
     * \return a const reference to the element in the window having the given
     * distance from the current winStart
     */
     ...
     *
     * \param count the number of positions the current winStart must be advanced
     * by
     */
