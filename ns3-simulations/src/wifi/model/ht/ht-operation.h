...
class HtOperation : public WifiInformationElement
{
  public:
     ...
     *
     * \param ctrl the Primary Channel field in the HT Operation information
     * element
     */
     ...
     *
     * \param ctrl the Information Subset 1 field in the HT Operation information
     * element
     */
     ...
     *
     * \param ctrl the Information Subset 2 field in the HT Operation information
     * element
     */
     ...
     *
     * \param ctrl the Information Subset 3 field in the HT Operation information
     * element
     */
     ...
     *
     * \param ctrl1 the first 64 bytes of the Basic MCS Set field in the HT
     * Operation information element \param ctrl2 the last 64 bytes of the Basic
     * MCS Set field in the HT Operation information element
     */
    ...
    /**
     * Return the Information Subset 1 field in the HT Operation information
     * element.
     *
     * \return the Information Subset 1 field in the HT Operation information
     * element
    ...
    /**
     * Return the Information Subset 2 field in the HT Operation information
     * element.
     *
     * \return the Information Subset 2 field in the HT Operation information
     * element
    ...
    /**
     * Return the Information Subset 3 field in the HT Operation information
     * element.
     *
     * \return the Information Subset 3 field in the HT Operation information
     * element
    ...
    /**
     * Return the first 64 bytes of the Basic MCS Set field in the HT Operation
     * information element.
     *
     * \return the first 64 bytes of the Basic MCS Set field in the HT Operation
     * information element
    ...
    /**
     * Return the last 64 bytes of the Basic MCS Set field in the HT Operation
     * information element.
     *
     * \return the last 64 bytes of the Basic MCS Set field in the HT Operation
     * information element
