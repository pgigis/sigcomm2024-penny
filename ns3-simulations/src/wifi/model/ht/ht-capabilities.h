 ...
 * \ingroup wifi
 *
 * This class knows how to serialise and deserialise the HT Capabilities
 * Information Element
 */
class HtCapabilities : public WifiInformationElement
{
  public:
    ...
    /**
     * Set the HT Capabilities Info field in the HT Capabilities information
     * element.
     *
     * \param ctrl the HT Capabilities Info field in the HT Capabilities
     * information element
     */
     ...
     *
     * \param ctrl the A-MPDU Parameters field in the HT Capabilities information
     * element
     */
     ...
     *
     * \param ctrl1 the first 64 bytes of the Supported MCS Set field in the HT
     * Capabilities information element \param ctrl2 the last 64 bytes of the
     * Supported MCS Set field in the HT Capabilities information element
     */
    void SetSupportedMcsSet(uint64_t ctrl1, uint64_t ctrl2);
    /**
     * Set the Extended HT Capabilities field in the HT Capabilities information
     * element.
     *
     * \param ctrl the Extended HT Capabilities field in the HT Capabilities
     * information element
     */
    void SetExtendedHtCapabilities(uint16_t ctrl);
    /**
     * Set the Transmit Beamforming (TxBF) Capabilities field in the HT
     * Capabilities information element.
     *
     * \param ctrl the Transmit Beamforming (TxBF) Capabilities field in the HT
     * Capabilities information element
     */
    void SetTxBfCapabilities(uint32_t ctrl);
    /**
     * Set the the Antenna Selection (ASEL) Capabilities field in the HT
     * Capabilities information element.
     *
     * \param ctrl the Antenna Selection (ASEL) Capabilities field in the HT
     * Capabilities information element
     */
    ...
    /**
     * Return the HT Capabilities Info field in the HT Capabilities information
     * element.
     *
     * \return the HT Capabilities Info field in the HT Capabilities information
     * element
    ...
    /**
     * Return the A-MPDU Parameters field in the HT Capabilities information
     * element.
     *
     * \return the A-MPDU Parameters field in the HT Capabilities information
     * element
    ...
    /**
     * Return the first 64 bytes of the Supported MCS Set field in the HT
     * Capabilities information element.
     *
     * \return the first 64 bytes of the Supported MCS Set field in the HT
     * Capabilities information element
    ...
    /**
     * Return the last 64 bytes of the Supported MCS Set field in the HT
     * Capabilities information element.
     *
     * \return the last 64 bytes of the Supported MCS Set field in the HT
     * Capabilities information element
    ...
    /**
     * Return the Extended HT Capabilities field in the HT Capabilities
     * information element.
     *
     * \return the Extended HT Capabilities field in the HT Capabilities
     * information element
    ...
    /**
     * Return the Transmit Beamforming (TxBF) Capabilities field in the HT
     * Capabilities information element.
     *
     * \return the Transmit Beamforming (TxBF) Capabilities field in the HT
     * Capabilities information element
    ...
    /**
     * Return the Antenna Selection (ASEL) Capabilities field in the HT
     * Capabilities information element.
     *
     * \return the Antenna Selection (ASEL) Capabilities field in the HT
     * Capabilities information element
  ...
  private:
    ...
    uint8_t m_explicitNoncompressedSteeringCapable;      ///< explicit non compressed
                                                         ///< steering capable
    uint8_t m_explicitCompressedSteeringCapable;         ///< explicit compressed
                                                         ///< steering capable
    uint8_t m_explicitTxBfCsiFeedback;                   ///< explicit transmit BF CSI feedback
    uint8_t m_explicitNoncompressedBfFeedbackCapable;    ///< explicit non compressed
                                                         ///< BF feedback capable
    uint8_t m_explicitCompressedBfFeedbackCapable;       ///< explicit compressed BF
                                                         ///< feedback capable
    uint8_t m_minimalGrouping;                           ///< minimal grouping
    uint8_t m_csiNBfAntennasSupported;                   ///< CSI NBF antenna supported
    uint8_t m_noncompressedSteeringNBfAntennasSupported; ///< non compressed steering
                                                         ///< NBF antenna supported
    uint8_t m_compressedSteeringNBfAntennasSupported;    ///< compressed steering
                                                         ///< NBF antenna supported
    ...
    uint8_t m_explicitCsiFeedbackBasedTxASelCapable;    ///< explicit CSI feedback
                                                        ///< based transmit antenna
                                                        ///< selection capable
    uint8_t m_antennaIndicesFeedbackBasedTxASelCapable; ///< antenna indices feedback
                                                        ///< based transmit antenna
                                                        ///< selection capable
