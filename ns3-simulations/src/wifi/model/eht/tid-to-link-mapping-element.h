...
/// size in bytes of the Link Mapping Presence Indicator field (IEEE 802.11be
/// D2.0 9.4.2.314)
...
class TidToLinkMapping : public WifiInformationElement
{
  public:
    ...
    struct Control
    {
      ...
      private:
        /**
         * These members are private to prevent users to manipulate them directly
         * (their values depend on the values of other fields)
         */
     ...
     *
     * \param mappingSwitchTime the time when the new mapping is established
     * (rounded to a multiple of a TU)
     */
     ...
     *
     * \param expectedDuration the value for the Expected Duration field (rounded
     * to a multiple of a TU)
     */
    ...
    /**
     * Set the Link Mapping field of the given TID such that the given TID is
     * mapped to the links associated with the given link IDs.
     *
