    ...
    static ns3::TypeId tid =
        ns3::TypeId("ns3::EhtConfiguration")
            ...
            .AddAttribute("EmlsrActivated",
                          "Whether EMLSR option is activated. If activated, EMLSR mode can "
                          "be "
            ...
            .AddAttribute(
                ...
                MakeEnumChecker(
                    ...
                    "ANY_LINK_SET"))
            .AddAttribute("TidToLinkMappingDl",
                          "A list-of-TIDs-indexed map of the list of links where the TIDs "
                          "are mapped to "
                          "for the downlink direction. "
                          "In case a string is used to set this attribute, the string "
                          "shall contain the "
                          "(TID list, link list) pairs separated by a semicolon (;); in "
                          "every pair, the "
                          "TID list and the link list are separated by a blank space, and "
                          "the elements of "
                          "each list are separated by a comma (,) without spaces. "
                          "E.g., \"0,4 1,2,3; 1 0;2 0,1\" means that TIDs 0 and 4 are "
                          "mapped on links "
                          "1, 2 and 3; TID 1 is mapped on link 0 and TID 2 is mapped on "
                          "links 0 and 1. "
                          "An empty map indicates the default mapping, i.e., all TIDs are "
                          "mapped to all "
                          "setup links. If the map contains the mapping for some TID(s), "
                          "the mapping "
                          "corresponding to the missing TID(s) remains unchanged. "
                          "A non-AP MLD includes this mapping in the Association Request "
                          "frame sent to "
                          "an AP MLD, unless the AP MLD advertises a negotiation support "
                          "of 1 and this "
                          "mapping is such that TIDs are mapped to distinct link sets, in "
                          "which case "
                          ...
                          MakeAttributeContainerChecker<TidLinkMapValue, ';'>(
                              MakePairChecker<AttributeContainerValue<UintegerValue>,
                                  ...
                                  MakeAttributeContainerChecker<UintegerValue>(
                                      MakeUintegerChecker<uint8_t>()))))
            .AddAttribute("TidToLinkMappingUl",
                          "A list-of-TIDs-indexed map of the list of links where the TIDs "
                          "are mapped to "
