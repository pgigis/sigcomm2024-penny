...
struct CommonInfoBasicMle
{
    ...
    struct MediumSyncDelayInfo
    {
        ...
        uint8_t mediumSyncOfdmEdThreshold : 4; //!< Medium Synchronization OFDM ED
                                               //!< Threshold
        uint8_t mediumSyncMaxNTxops : 4;       //!< Medium Synchronization MAximum Number
                                               //!< of TXOPs
    };
    ...
    struct MldCapabilities
    {
        ...
        uint8_t tidToLinkMappingSupport : 2; //!< TID-To-Link Mapping Negotiation
                                             //!< Supported
        uint8_t freqSepForStrApMld : 5;      //!< Frequency Separation For STR/AP MLD
                                             //!< Type Indication
     ...
     *
     * \param start iterator pointing to where the Common Info field should be
     * written to
     */
     ...
     *
     * \param start iterator pointing to where the Common Info field should be
     * read from \param presence the value of the Presence Bitmap field indicating
     * which subfields are present in the Common Info field \return the number of
     * bytes read
     */
...
class MultiLinkElement : public WifiInformationElement
{
  public:
    ...
    /// \return a reference to the Common Info field (the MLE variant must be
    /// Basic)
    CommonInfoBasicMle& GetCommonInfoBasic();

    /// \return a const reference to the Common Info field (the MLE variant must
    /// be Basic)
    ...
    /**
     * Return the MLD MAC Address subfield in the Common Info field. Make sure
     * that this is a Basic Multi-Link Element.
     *
    ...
    /**
     * Return true if the Link ID Info subfield in the Common Info field is
     * present and false otherwise. Make sure that this is a Basic Multi-Link
     * Element.
     *
     * \return true if the Link ID Info subfield in the Common Info field is
     ...
     * this is a Basic Multi-Link Element and the Link ID Info subfield is
     * present.
     *
    ...
    /**
     * Set the BSS Parameters Change Count subfield in the Common Info field. Make
     * sure that this is a Basic Multi-Link Element.
     *
     * \param count the BSS Parameters Change Count
     */
    void SetBssParamsChangeCount(uint8_t count);
    /**
     * Return true if the BSS Parameters Change Count subfield in the Common Info
     * field is present and false otherwise. Make sure that this is a Basic
     * Multi-Link Element.
     *
     * \return true if the BSS Parameters Change Count subfield in the Common Info
     * field is present and false otherwise
     */
    bool HasBssParamsChangeCount() const;
    /**
     * Return the BSS Parameters Change Count subfield in the Common Info field.
     * Make sure that this is a Basic Multi-Link Element and the BSS Parameters
     * Change Count subfield is present.
     *
     * \return the BSS Parameters Change Count subfield in the Common Info field
     */
    ...
    /**
     * Set the Medium Synchronization Duration subfield of the Medium
     * Synchronization Delay information in the Common Info field. Make sure that
     * this is a Basic Multi-Link Element.
     *
    ...
    /**
     * Set the Medium Synchronization OFDM ED Threshold subfield of the Medium
     * Synchronization Delay information in the Common Info field. Make sure that
     * this is a Basic Multi-Link Element.
     *
    ...
    /**
     * Set the Medium Synchronization Maximum Number of TXOPs subfield of the
     * Medium Synchronization Delay information in the Common Info field. Make
     * sure that this is a Basic Multi-Link Element.
     *
     * \param nTxops the maximum number of TXOPs a non-AP STA is allowed to
     * attempt to initiate while the MediumSyncDelay timer is running at a non-AP
     * STA
     */
    void SetMediumSyncMaxNTxops(uint8_t nTxops);
    /**
     * Return true if the Medium Synchronization Delay Information subfield in the
     * Common Info field is present and false otherwise. Make sure that this is a
     * Basic Multi-Link Element.
     *
     * \return true if the Medium Synchronization Delay Information subfield in
     * the Common Info field is present and false otherwise
     */
    bool HasMediumSyncDelayInfo() const;
    /**
     * Get the Medium Synchronization Duration subfield of the Medium
     * Synchronization Delay information in the Common Info field. Make sure that
     * this is a Basic Multi-Link Element and the Medium Synchronization Duration
     * subfield is present.
     *
    ...
    /**
     * Get the Medium Synchronization OFDM ED Threshold in dBm. Make sure that
     * this is a Basic Multi-Link Element and the Medium Synchronization Duration
     * subfield is present.
     *
    ...
    /**
     * Get the maximum number of TXOPs a non-AP STA is allowed to attempt to
     * initiate while the MediumSyncDelay timer is running at a non-AP STA. Make
     * sure that this is a Basic Multi-Link Element and the Medium Synchronization
     * Duration subfield is present.
     *
    ...
    /**
     * Set the EMLSR Support subfield of the EML Capabilities subfield in the
     * Common Info field to 1 if EMLSR mode is supported and set it to 0
     * otherwise. Make sure that this is a Basic Multi-Link Element.
     *
     * \param supported whether EMLSR mode is supported
     */
    void SetEmlsrSupported(bool supported);
    /**
     * Set the EMLSR Padding Delay subfield of the EML Capabilities subfield in
     * the Common Info field. Make sure that this is a Basic Multi-Link Element.
     *
     * \param delay the EMLSR Padding delay (0us, 32us, 64us, 128us or 256us)
     */
    void SetEmlsrPaddingDelay(Time delay);
    /**
     * Set the EMLSR Transition Delay subfield of the EML Capabilities subfield in
     * the Common Info field. Make sure that this is a Basic Multi-Link Element.
     *
     * \param delay the EMLSR Transition delay (0us, 16us, 32us, 64us, 128us or
     * 256us)
     */
    ...
    /**
     * Return true if the EML Capabilities subfield in the Common Info field is
     * present and false otherwise. Make sure that this is a Basic Multi-Link
     * Element.
     *
     * \return whether the EML Capabilities subfield in the Common Info field is
     * present
     */
    bool HasEmlCapabilities() const;
    /**
     * Return true if the EMLSR Support subfield of the EML Capabilities subfield
     * in the Common Info field is set to 1 and false otherwise. Make sure that
     * this is a Basic Multi-Link Element and the EML Capabilities subfield is
     * present.
     *
    ...
    /**
     * Get the EMLSR Padding Delay subfield of the EML Capabilities subfield in
     * the Common Info field. Make sure that this is a Basic Multi-Link Element
     * and the EML Capabilities subfield is present.
     *
     * \return the EMLSR Padding Delay
     */
    Time GetEmlsrPaddingDelay() const;
    /**
     * Get the EMLSR Transition Delay subfield of the EML Capabilities subfield in
     * the Common Info field. Make sure that this is a Basic Multi-Link Element
     * and the EML Capabilities subfield is present.
     *
     ...
     * Common Info field. Make sure that this is a Basic Multi-Link Element and
     * the EML Capabilities subfield is present.
     *
     ...
     *
     * The frame body of the management frame included in the Per-STA Profile
     * field is stored as a (unique) pointer to the Header base class, because we
     * cannot include mgt-headers.h here (otherwise, we would create a circular
     * dependency).
     *
     * TODO:
    ...
    class PerStaProfileSubelement : public WifiInformationElement
    {
      public:
        ...
        /**
         * Return true if the STA MAC Address subfield in the STA Info field is
         * present
         *
         * \return true if the STA MAC Address subfield in the STA Info field is
         * present
        ...
        /**
         * Include the given (Re)Association Request frame body in the STA Profile
        ...
        /**
         * Include the given (Re)Association Response frame body in the STA Profile
         * field of this Per-STA Profile subelement
         *
      ...
      private:
        ...
        std::variant<std::monostate,
            ...
            m_staProfile; /**< STA Profile field, containing the frame body of a
    ...
    /**
     * Get a reference to the <i>i</i>-th Per-STA Profile Subelement in the Link
     * Info field
     *
     * \param i the index of the Per-STA Profile Subelement in the Link Info field
     * \return a reference to the <i>i</i>-th Per-STA Profile Subelement in the
     * Link Info field
     */
