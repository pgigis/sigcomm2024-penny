...
struct EhtMacCapabilities
{
    ...
    uint8_t triggeredTxopSharingMode1Support : 1; //!< Triggered TXOP Sharing
                                                  //!< Mode 1 Support
    uint8_t triggeredTxopSharingMode2Support : 1; //!< Triggered TXOP Sharing
                                                  //!< Mode 2 Support
...
struct EhtPhyCapabilities
{
    ...
    uint8_t nSoundingDimensionsBwNotLargerThan80Mhz : 3; //!< Beamformee SS (≤ 80
                                                         //!< MHz)
    ...
    uint8_t codebooksizeMuFeedback : 1;         //!< Support for a codebook size for MU
                                                //!< feedback.
    uint8_t triggeredSuBeamformingFeedback : 1; //!< Triggered SU Beamforming
                                                //!< Feedback
    uint8_t triggeredMuBeamformingPartialBwFeedback : 1; //!< Triggered MU
                                                         //!< Beamforming Partial
                                                         //!< BW Feedback
    ...
    uint8_t muPpdu4xEhtLtfAnd800nsGi : 1;                //!< EHT MU PPDU With 4x EHT-LTF And
                                                         //!< 0.8 μs GI
    ...
    uint8_t support20MhzOperatingStaReceivingNdpWithWiderBw : 1; //!< Support For 20
                                                                 //!< MHz Operating
                                                                 //!< STA Receiving
                                                                 //!< NDP With Wider
                                                                 //!< Bandwidth
...
class EhtCapabilities : public WifiInformationElement
{
  ...
  private:
    ...
    bool m_is2_4Ghz; //!< flag indicating whether PHY is operating in 2.4 GHz
                     //!< based on other IEs contained in the same management
                     //!< frame
    std::optional<HeCapabilities> m_heCapabilities; //!< HE capabilities contained in the same
                                                    //!< management frame if present
};
