...
class NonInheritance : public WifiInformationElement
{
  public:
    ...
    /**
     * Add the Information Element specified by the given Element ID and Element
     * ID Extension.
     *
     ...
     * \param elemId the given Element ID
     * \param elemIdExt the given Element ID Extension
     * \return whether the Information Element specified by the given Element ID
     * and Element ID Extension is present
     */
