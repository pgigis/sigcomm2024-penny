...
class WifiPsdu : public SimpleRefCount<WifiPsdu>
{
  public:
    ...
    /**
     * \brief Get a copy of the i-th A-MPDU subframe (includes subframe header,
     * MPDU, and possibly padding) \param i the index in the list of A-MPDU
     * subframes \return the i-th A-MPDU subframe.
     */
    ...
    /**
     * Get the duration from the Duration/ID field, which is common to all the
     * MPDUs \return the duration from the Duration/ID field.
     */
     ...
     * \return the QoS Ack Policy common to all QoS Data frames having the given
     * TID.
     */
