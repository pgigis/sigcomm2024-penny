...
class WifiMacHeader : public Header
{
  public:
     ...
     *
     * \return true if the header is an Association Request header, false
     * otherwise
     */
     ...
     *
     * \return true if the header is an Association Response header, false
     * otherwise
     */
     ...
     *
     * \return true if the header is a Reassociation Request header, false
     * otherwise
     */
     ...
     *
     * \return true if the header is a Reassociation Response header, false
     * otherwise
     */
  ...
  protected:
    ...
    uint8_t m_ctrlOrder;           ///< control order (set to 1 for QoS Data and Management
                                   ///< frames to signify that HT/VHT/HE control field is
                                   ///< present, knowing that the latter are not
                                   ///< implemented yet)
