...
class WifiNetDevice : public NetDevice
{
  public:
     ...
     *
     * This GetRemoteStationManager variant is needed to keep using
     * "RemoteStationManager" in the path names.
     */
    Ptr<WifiRemoteStationManager> GetRemoteStationManager() const;
    /**
     * \param linkId the ID (starting at 0) of the link of the
     * RemoteStationManager object to retrieve \returns the requested remote
     * station manager
     */
