...
class HeCapabilities : public WifiInformationElement
{
  public:
    ...
    /**
     * Set the HE MAC Capabilities Info field in the HE Capabilities information
     * element.
     *
     * \param ctrl1 the HE MAC Capabilities Info field 1 in the HE Capabilities
     * information element \param ctrl2 the HE MAC Capabilities Info field 2 in
     * the HE Capabilities information element
     */
    void SetHeMacCapabilitiesInfo(uint32_t ctrl1, uint16_t ctrl2);
    /**
     * Set the HE PHY Capabilities Info field in the HE Capabilities information
     * element.
     *
     * \param ctrl1 the HE PHY Capabilities Info field 1 in the HE Capabilities
     * information element \param ctrl2 the HE PHY Capabilities Info field 2 in
     * the HE Capabilities information element \param ctrl3 the HE PHY
     * Capabilities Info field 3 in the HE Capabilities information element
     */
     ...
     *
     * \param ctrl the MCS and NSS field in the HE Capabilities information
     * element
     */
    void SetSupportedMcsAndNss(uint16_t ctrl);

    /**
     * Return the 4 first octets of the HE MAC Capabilities Info field in the HE
    ...
    /**
     * Return the last 2 octets of the HE MAC Capabilities Info field in the HE
     * Capabilities information element.
     *
     * \return the last 2 octets of the HE MAC Capabilities Info field in the HE
     * Capabilities information element
    ...
    /**
     * Return the 8 first octets of the HE PHY Capabilities Info field in the HE
     * Capabilities information element.
     *
     * \return the 8 first octets of the HE PHY Capabilities Info field in the HE
     * Capabilities information element
    ...
    /**
     * Return the octets 9-10 of the HE PHY Capabilities Info field in the HE
     * Capabilities information element.
     *
     * \return the octets 9-10 of the HE PHY Capabilities Info field in the HE
     * Capabilities information element
    ...
    /**
     * Return the last octet of the HE PHY Capabilities Info field in the HE
     * Capabilities information element.
     *
     * \return the last octet of the HE PHY Capabilities Info field in the HE
     * Capabilities information element
    ...
    /**
     * Set indication whether the transmission and reception of LDPC encoded
     * packets is supported.
     *
     * \param ldpcCodingInPayload indication whether the transmission and
     * reception of LDPC encoded packets is supported
     */
    void SetLdpcCodingInPayload(uint8_t ldpcCodingInPayload);
    /**
     * Set 1xHE-LTF and 800ns GI in HE SU PPDU reception support
     *
     * \param heSuPpdu1xHeLtf800nsGi 1xHE-LTF and 800ns GI in HE SU PPDU reception
     * support
     */
     ...
     *
     * \param heSuPpdu4xHeLtf800nsGi 4xHE-LTF and 800ns GI in HE SU PPDU and HE MU
     * PPDU reception support
     */
    ...
    /**
     * Indicates support for the transmission and reception of LDPC encoded
     * packets.
     *
     * \returns indication whether the transmission and reception of LDPC encoded
     * packets is supported
     */
     ...
     *
     * \returns true if 1xHE-LTF and 800ns GI in HE SU PPDU reception is
     ...
     *
     * \returns true if 4xHE-LTF and 800ns GI in HE SU PPDU and HE MU PPDU
     * reception is supported, false otherwise
     */
  ...
  private:
    ...
    uint8_t m_maximumNumberOfFragmentedMsdus;    //!< maximum number of
                                                 //!< fragmentation MSDUs
    ...
    uint8_t m_amsduNotUnderBaInAmpduSupport;     //!< AMSDU not under BA in Ack
                                                 //!< enabled A-MPDU support
    uint8_t m_multiTidAggregationTxSupport;      //!< Multi-TID aggregation TX support
    uint8_t m_heSubchannelSelectiveTxSupport;    //!< HE subchannel selective
                                                 //!< transmission support
    uint8_t m_ul2x996ToneRuSupport;              //!< UL 2x996 tone RU support
    uint8_t m_omControlUlMuDataDisableRxSupport; //!< OM control UL MU data
                                                 //!< disable RX support
    ...
    uint8_t m_beamformeeStsForSmallerOrEqualThan80Mhz; //!< beam formee STS for <
                                                       //!< 80 MHz
    uint8_t m_beamformeeStsForLargerThan80Mhz;         //!< beamformee STS for > 80MHz
    uint8_t m_numberOfSoundingDimensionsForSmallerOrEqualThan80Mhz; //!< # of
                                                                    //!< sounding
                                                                    //!< dimensions
                                                                    //!< for < 80 MHz
    uint8_t m_numberOfSoundingDimensionsForLargerThan80Mhz;         //!< # of sounding
                                                                    //!< dimensions for >
                                                                    //!< 80 MHz
    ...
    uint8_t m_hePpdu4xHeLtf800nsGi;           //!< 4 times HE-LFT and 800ns GI support for
                                              //!< HE-PPDUs
    ...
    uint8_t m_longerThan16HeSigbOfdm;         //!< Longer than 16 HE SIG-=B OFDM symbols
                                              //!< support
    ...
    uint8_t m_rxFullBwSuInHeMuCompressedSigB; //!< RX full BW SU using HE MU PPDU
                                              //!< with compressed SIGB
    uint8_t m_rxFullBwSuInHeMuNonCompressedSigB; //!< RX full BW SU using HE MU PPDU
                                                 //!< with non-compressed SIGB
    uint8_t m_nominalPacketPadding;              //!< Nominal packet padding
    uint8_t m_maxHeLtfRxInHeMuMoreThanOneRu;     ///< max HE-LTF symbols STA can Rx in
                                                 ///< HE MU PPDU with more than one RU
