...
class MuEdcaParameterSet : public WifiInformationElement
{
  public:
     ...
     *
     * \param qosInfo the QoS Info field in the MuEdcaParameterSet information
     * element
     */
    void SetQosInfo(uint8_t qosInfo);
    /**
     * Set the AIFSN subfield of the ACI/AIFSN field in the MU AC Parameter Record
     * field corresponding to the given AC Index (<i>aci</i>). Note that
     * <i>aifsn</i> can either be zero (EDCA disabled) or in the range from 2
     * to 15.
     *
    ...
    /**
     * Set the ECWmin subfield of the ECWmin/ECWmax field in the MU AC Parameter
     * Record field corresponding to the given AC Index (<i>aci</i>). Note that
     * <i>cwMin</i> must be a power of 2 minus 1 in the range from 0 to 32767.
     *
     * \param aci the AC Index
    ...
    /**
     * Set the ECWmax subfield of the ECWmin/ECWmax field in the MU AC Parameter
     * Record field corresponding to the given AC Index (<i>aci</i>). Note that
     * <i>cwMax</i> must be a power of 2 minus 1 in the range from 0 to 32767.
     *
     * \param aci the AC Index
    ...
    /**
     * Set the MU EDCA Timer field in the MU AC Parameter Record field
     * corresponding to the given AC Index (<i>aci</i>). Note that <i>timer</i>
     * must be an integer multiple of 8 TUs (i.e., 8 * 1024 = 8192 microseconds)
     * in the range from 8.192 milliseconds to 2088.96 milliseconds. A value of 0
     * is used to indicate that the MU EDCA Parameter Set element must not be sent
     * and therefore it is only allowed if the MU EDCA Timer is set to 0 for all
     * ACs.
     *
     * \param aci the AC Index
    ...
    /**
     * Get the CWmin value encoded by the ECWmin subfield of the ECWmin/ECWmax
     * field in the MU AC Parameter Record field corresponding to the given AC
     * Index (<i>aci</i>).
     *
     * \param aci the AC Index
    ...
    /**
     * Get the CWmax value encoded by the ECWmax subfield of the ECWmin/ECWmax
     * field in the MU AC Parameter Record field corresponding to the given AC
     * Index (<i>aci</i>).
     *
     * \param aci the AC Index
    ...
    /**
     * Get the MU EDCA Timer value encoded in the MU AC Parameter Record field
     * corresponding to the given AC Index (<i>aci</i>).
     *
     * \param aci the AC Index
