    ...
    static ns3::TypeId tid =
        ns3::TypeId("ns3::HeConfiguration")
            ...
            .AddAttribute("GuardInterval",
                          "Specify the shortest guard interval duration that can "
                          "be used for HE "
                          "transmissions."
            ...
            .AddAttribute("MaxTbPpduDelay",
                          ...
                          "delay with which a TB PPDU can be received after the reception "
                          "of "
                          "the first TB PPDU. If the delay is higher than this value, the "
                          "TB PPDU is dropped and considered interference. The maximum "
                          "delay "
                          "is anyway capped at the duration of the training fields in the "
                          "PPDU. "
            ...
            .AddAttribute("BeMuEdcaTimer",
                          ...
                          "0 is a reserved value, but we allow to use this value to "
                          "indicate "
                          "that an MU EDCA Parameter Set element must not be sent. "
                          "Therefore, "
                          "0 can only be used if the MU EDCA Timer for all ACs is set to "
                          "0.",
