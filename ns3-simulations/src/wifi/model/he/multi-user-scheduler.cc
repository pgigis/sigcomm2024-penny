    ...
    static TypeId tid =
        TypeId("ns3::MultiUserScheduler")
            ...
            .AddAttribute("AccessReqInterval",
                          ...
                          "channel access made by the MultiUserScheduler. Such requests "
                          "are "
                          "made independently of the presence of frames in the queues of "
                          "the "
                          "AP and are intended to allow the AP to coordinate UL MU "
                          "transmissions "
            ...
            .AddAttribute("AccessReqAc",
                          "The Access Category for which the MultiUserScheduler "
                          "makes requests "
                          "for channel access.",
