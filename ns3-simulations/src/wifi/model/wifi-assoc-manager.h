...
class WifiAssocManager : public Object
{
    ...
    struct ApInfoCompare
    {
        ...
        /**
         * Function call operator. Calls the Compare method of the Association
         * Manager.
         *
         * \param lhs left hand side ApInfo object
         * \param rhs right hand side ApInfo object
         * \return true if the left hand side ApInfo object should be placed before
         * the right hand side ApInfo object in the sorted list maintained by the
  ...
  public:
    /**
     * Struct to identify a specific TBTT Information field of a Neighbor AP
     * Information field in a Reduced Neighbor Report element.
     */
    struct RnrLinkInfo
    {
     ...
     *
     * Note that the given ApInfo object is moved to the sorted list of ApInfo
     * objects.
     *
     ...
     * \param rhs right hand side ApInfo object
     * \return true if the left hand side ApInfo object should be placed before
     * the right hand side ApInfo object in the sorted list of ApInfo objects,
     *         false otherwise
     */
    ...
    /**
     * Find all the APs affiliated to the same AP MLD as the reporting AP that
     * sent the given RNR element.
     *
     * \param rnr the given RNR element
     * \return a list containing the index of the Neighbor AP Information field
     * and the index of the TBTT Information field containing all the affiliated
     * APs
     */
  ...
  protected:
    ...
    /**
     * Get a reference to the list of the links to setup with the given AP. This
     * method allows subclasses to modify such a list.
     *
    ...
    /**
     * Check whether the given AP information match the current scanning
     * parameters.
     *
     * \param apInfo the given AP information
     * \return whether the given AP information match the current scanning
     * parameters
     */
    ...
    /**
     * Check whether 11be Multi-Link setup can be established with the current
     * best AP.
     *
     ...
     * \param[out] rnr const reference to the Reduced Neighbor Report Element
     * present in the Beacon/Probe Response received from the best AP, if any.
     * \return whether 11be Multi-Link setup can be established with the current
     * best AP
     */
  ...
  private:
    ...
    /// hash table to help locate ApInfo objects in the sorted list based on the
    /// BSSID
