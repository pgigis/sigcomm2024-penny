...
class WifiSpectrumPhyInterface : public SpectrumPhy
{
  public:
    ...
    /**
     * Get the frequency range covered by the spectrum channel this interface is
     * attached to
     *
     * \return the frequency range covered by the spectrum channel this interface
     * is attached to
     */
    const FrequencyRange& GetFrequencyRange() const;

    /**
     * Get the center frequency in MHz of the the spectrum channel this interface
     * is attached to
     *
     * \return the center frequency in MHz of the the spectrum channel this
     * interface is attached to to
     */
    uint16_t GetCenterFrequency() const;

    /**
     * Get the channel width in MHz covered by the spectrum channel this interface
     * is attached to
     *
     * \return the channel width in MHz covered by the spectrum channel this
     * interface is attached to to
     */
  ...
  private:
    ...
    WifiSpectrumBands m_bands; /**< Store all the distinct spectrum bands
                                  associated with every channels widths */
    HeRuBands m_heRuBands;     /**< Store all the distinct spectrum bands associated
                                  with every RU */
};
