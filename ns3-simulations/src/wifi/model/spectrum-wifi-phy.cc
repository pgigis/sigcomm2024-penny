    ...
    static TypeId tid =
        TypeId("ns3::SpectrumWifiPhy")
            ...
            .AddAttribute("DisableWifiReception",
                          ...
                          MakeBooleanChecker())
            .AddAttribute("TrackSignalsFromInactiveInterfaces",
                          "Enable or disable tracking signals coming from "
