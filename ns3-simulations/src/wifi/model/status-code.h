...
class StatusCode
{
  public:
    ...
    /**
     * \param start an iterator which points to where the status code should be
     * written
     *
     * \return Buffer::Iterator
     *
     * This method is used to store a status code into the byte buffer.
     * The data written is expected to match bit-for-bit the representation of
     * this header in a real network.
     */
