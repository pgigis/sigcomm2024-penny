...
class WifiTxParameters
{
  public:
    ...
    /**
     * Record that an MPDU is being added to the current frame. If an MPDU
     * addressed to the same receiver already exists in the frame, A-MPDU
     ...
     * \return a pair (size in bytes of the current A-MSDU, size in bytes of the
     frame) in case the given MSDU is aggregated
     */
