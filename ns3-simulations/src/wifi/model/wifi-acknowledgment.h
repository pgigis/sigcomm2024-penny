 ...
 * \ingroup wifi
 *
 * WifiAcknowledgment is an abstract base struct. Each derived struct defines an
 * acknowledgment method and stores the information needed to perform
 * acknowledgment according to that method.
 */
struct WifiAcknowledgment
{
  ...
  private:
    ...
    /// Qos Ack Policy to set for MPDUs addressed to a given receiver and having a
    /// given TID
 ...
 * \ingroup wifi
 *
 * WifiBarBlockAck specifies that a BlockAckReq is sent to solicit a Block Ack
 * response.
 */
 ...
 * to reply a SIFS after the DL MU PPDU by sending either a Normal Ack or a
 * BlockAck.
 */
struct WifiDlMuBarBaSequence : public WifiAcknowledgment
{
    ...
    /// Set of stations receiving a BlockAckReq frame and replying with a BlockAck
    /// frame
 ...
 * solicit TB PPDUs that will be acknowledged through a multi-STA BlockAck
 * frame.
 */
