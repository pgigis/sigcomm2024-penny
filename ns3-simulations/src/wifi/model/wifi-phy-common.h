 ...
 * \return true if the start/stop frequencies of left are lower than the
 * start/stop frequencies of right, false otherwise
 */
inline bool
...
enum WifiPpduField
{
    ...
    WIFI_PPDU_FIELD_TRAINING, //!< STF + LTF fields (excluding those in preamble
                              //!< for HT-GF)
 ...
 *
 * \param preamble the given preamble type (must be one defined by HT standard
 * or later) \return the modulation class corresponding to the given preamble
 * type
 */
 ...
 *
 * \param preamble the preamble
 * \return true if the provided preamble corresponds to a multi-user
 * transmission
 */
 ...
 *
 * \param preamble the preamble
 * \return true if the provided preamble corresponds to a downlink multi-user
 * transmission
 */
 ...
 *
 * \param preamble the preamble
 * \return true if the provided preamble corresponds to a uplink multi-user
 * transmission
 */
 ...
 * \return the maximum channel width in MHz allowed for the given modulation
 * class
 */
