 ...
 * \ingroup wifi
 *
 * This class knows how to serialise and deserialise the ErpInformation
 * Information Element.
 */
class ErpInformation : public WifiInformationElement
{
  public:
    ...
    /**
     * Set the Barker_Preamble_Mode field in the ErpInformation information
     * element.
     *
     * \param barkerPreambleMode the Barker_Preamble_Mode field in the
     * ErpInformation information element
     */
    void SetBarkerPreambleMode(uint8_t barkerPreambleMode);
    /**
     * Set the Use_Protection field in the ErpInformation information element.
     *
     * \param useProtection the Use_Protection field in the ErpInformation
     * information element
     */
     ...
     *
     * \param nonErpPresent the Non_Erp_Present field in the ErpInformation
     * information element
     */
    void SetNonErpPresent(uint8_t nonErpPresent);

    /**
     * Return the Barker_Preamble_Mode field in the ErpInformation information
     * element.
     *
     * \return the Barker_Preamble_Mode field in the ErpInformation information
     * element
