...
class WifiMode
{
  public:
    ...
    /**
     *
     * \returns the Modulation Class (Section 9.7.8 "Modulation classes"; IEEE
     * 802.11-2012) to which this WifiMode belongs.
     */
...
class WifiModeFactory
{
  ...
  private:
    ...
    struct WifiModeItem
    {
        ...
        CodeRateCallback GetCodeRateCallback; ///< Callback to retrieve code rate
                                              ///< of this WifiModeItem
        ConstellationSizeCallback
            GetConstellationSizeCallback;     ///< Callback to retrieve constellation
                                              ///< size of this WifiModeItem
        PhyRateCallback GetPhyRateCallback;   ///< Callback to calculate PHY rate in
                                              ///< bps of this WifiModeItem
        DataRateCallback GetDataRateCallback; ///< Callback to calculate data rate
                                              ///< in bps of this WifiModeItem
        NonHtReferenceRateCallback
            GetNonHtReferenceRateCallback; ///< Callback to calculate non-HT
                                           ///< reference rate of this WifiModeItem
