...
class WifiAckManager : public Object
{
  public:
     ...
     *
     * \param linkId the ID of the link this Acknowledgment Manager is associated
     * with
     */
     ...
     *
     * \param item the MPDU
     * \param acknowledgment the WifiAcknowledgment object storing the QoS Ack
     * policy to set
     */
    static void SetQosAckPolicy(Ptr<WifiMpdu> item, const WifiAcknowledgment* acknowledgment);

    /**
     * Set the QoS Ack policy for the given PSDU, which must include at least a
     * QoS data frame.
     *
     * \param psdu the PSDU
     * \param acknowledgment the WifiAcknowledgment object storing the QoS Ack
    ...
    /**
     * Determine the acknowledgment method to use if the given MPDU is added to
     * the current frame. Return a null pointer if the acknowledgment method is
     * unchanged or the new acknowledgment method otherwise.
     *
    ...
    /**
     * Determine the acknowledgment method to use if the given MSDU is aggregated
     * to the current frame. Return a null pointer if the acknowledgment method is
     * unchanged or the new acknowledgment method otherwise.
     *
