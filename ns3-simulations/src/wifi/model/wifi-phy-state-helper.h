...
class WifiPhyStateHelper : public Object
{
  public:
     ...
     * \param psdus the PSDUs in the transmitted PPDU (only one unless it is a MU
     * PPDU) \param txPowerDbm the nominal TX power in dBm \param txVector the TX
     * vector for the transmission
     */
  ...
  private:
    ...
    /**
     * Notify all WifiPhyListener that the transmission has started for the given
     * duration.
     *
    ...
    /**
     * Notify all WifiPhyListener that the reception has started for the given
     * duration.
     *
    ...
    void NotifyCcaBusyStart(Time duration,
                            ...
                            const std::vector<Time>& per20MhzDurations);
    /**
     * Notify all WifiPhyListener that we are switching channel with the given
