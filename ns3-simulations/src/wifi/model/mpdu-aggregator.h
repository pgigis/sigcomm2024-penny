...
class MpduAggregator : public Object
{
  public:
     ...
     * in bytes
     *
     * Calculates how much padding must be added to the end of an A-MPDU of the
     * given size (once another MPDU is aggregated). Each A-MPDU subframe is
     * padded so that its length is multiple of 4 octets.
     */
