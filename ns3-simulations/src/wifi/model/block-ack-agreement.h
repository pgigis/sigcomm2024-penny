...
class BlockAckAgreement
{
  ...
  public:
    ...
    /**
     * Get the type of the Block Ack Requests sent by the originator of this
     * agreement.
     *
     * \return the type of the Block Ack Requests sent by the originator of this
     * agreement
     */
     ...
     * \return the distance of the given sequence number from the given starting
     * sequence number
     */
