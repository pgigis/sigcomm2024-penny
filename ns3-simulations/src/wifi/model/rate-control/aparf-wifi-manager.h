...
class AparfWifiManager : public WifiRemoteStationManager
{
  ...
  private:
    ...
    uint32_t m_successMax1; //!< The minimum number of successful transmissions in
                            //!< \"High\" state to try a new power or rate.
    uint32_t m_successMax2; //!< The minimum number of successful transmissions in
                            //!< \"Low\" state to try a new power or rate.
    uint32_t m_failMax;     //!< The minimum number of failed transmissions to try a
                            //!< new power or rate.
