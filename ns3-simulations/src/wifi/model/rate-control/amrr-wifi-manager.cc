    ...
    static TypeId tid =
        TypeId("ns3::AmrrWifiManager")
            ...
            .AddAttribute("MaxSuccessThreshold",
                          "Maximum number of consecutive success periods needed to switch "
                          "to a higher rate",
                          UintegerValue(10),
                          MakeUintegerAccessor(&AmrrWifiManager::m_maxSuccessThreshold),
                          MakeUintegerChecker<uint32_t>())
            .AddAttribute("MinSuccessThreshold",
                          "Minimum number of consecutive success periods needed to switch "
                          "to a higher rate",
                          UintegerValue(1),
