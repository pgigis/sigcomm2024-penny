...
RrpaaWifiManager::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::RrpaaWifiManager")
            ...
            .AddAttribute("Basic",
                          "If true the RRPAA-BASIC algorithm will be used, "
                          "otherwise the RRPAA will be used.",
                          BooleanValue(true),
            ...
            .AddAttribute("FrameLength",
                          "The Data frame length (in bytes) used for calculating "
                          "mode TxTime.",
                          UintegerValue(1420),
                          MakeUintegerAccessor(&RrpaaWifiManager::m_frameLength),
                          MakeUintegerChecker<uint32_t>())
            .AddAttribute("AckFrameLength",
                          "The Ack frame length (in bytes) used for calculating "
                          "mode TxTime.",
                          UintegerValue(14),
