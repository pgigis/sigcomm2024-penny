    ...
    static TypeId tid =
        TypeId("ns3::AarfcdWifiManager")
            ...
            .AddAttribute("SuccessK",
                          "Multiplication factor for the success threshold in "
                          "the AARF algorithm.",
                          DoubleValue(2.0),
                          MakeDoubleAccessor(&AarfcdWifiManager::m_successK),
                          MakeDoubleChecker<double>())
            .AddAttribute("TimerK",
                          "Multiplication factor for the timer threshold in the "
                          "AARF algorithm.",
                          DoubleValue(2.0),
            ...
            .AddAttribute("MinTimerThreshold",
                          "The minimum value for the 'timer' threshold in the AARF "
                          "algorithm.",
                          UintegerValue(15),
                          MakeUintegerAccessor(&AarfcdWifiManager::m_minTimerThreshold),
                          MakeUintegerChecker<uint32_t>())
            .AddAttribute("MinSuccessThreshold",
                          "The minimum value for the success threshold in the AARF "
                          "algorithm.",
                          UintegerValue(10),
            ...
            .AddAttribute("TurnOffRtsAfterRateDecrease",
                          "If true the RTS mechanism will be turned off when the "
            ...
            .AddAttribute("TurnOnRtsAfterRateIncrease",
                          "If true the RTS mechanism will be turned on when the "
