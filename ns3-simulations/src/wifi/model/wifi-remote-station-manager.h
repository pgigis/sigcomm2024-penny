...
struct WifiRemoteStation
{
    ...
    std::pair<double, Time> m_rssiAndUpdateTimePair; //!< RSSI (in dBm) of the most recent packet
                                                     //!< received from the remote station along
                                                     //!< with update time
};
...
struct WifiRemoteStationState
{
    ...
    bool m_aggregation;       //!< Flag if MPDU aggregation is used by the remote
                              //!< station
...
class WifiRemoteStationManager : public Object
{
  ...
  private:
    ...
    bool m_useNonHtProtection;          //!< flag if protection for non-HT stations
                                        //!< against HT transmissions is enabled
    ...
    ProtectionMode m_erpProtectionMode; //!< Protection mode for ERP stations
                                        //!< when non-ERP stations are detected
