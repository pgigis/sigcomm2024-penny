 ...
 * WifiPhyHelper
 *
 * This helper will install an instance of a WifiBandwidthFilter on any
 * SpectrumChannel added to this helper (via one of the SetChannel methods),
 * unless one has previously been installed on the channel object.
 */
class SpectrumWifiPhyHelper : public WifiPhyHelper
{
  public:
     ...
     *
     * Every PHY created by a call to Install is associated to this default
     * spectrum channel.
     */
    void SetChannel(const Ptr<SpectrumChannel> channel);
    /**
     * \param channelName The name of the default spectrum channel to associate to
     * this helper
     *
     * Every PHY created by a call to Install is associated to this default
     * spectrum channel.
     ...
     * If a PHY is requested to operate or scan a channel with the specified
     * frequency and width combination, it will activate that channel and
     * deactivate the current channel for that PHY.
     */
    ...
    /**
     * Add a given spectrum PHY interface to the PHY instance corresponding of a
     * given link. If no mapping has been specified for a given link, all spectrum
     * PHY interfaces will be added to the PHY instance of that link.
     *
  ...
  private:
     ...
     *
     * This method will add a WifiBandwidthFilter object to the SpectrumChannel,
     * only if one has not yet been added.
     */
    ...
    std::map<uint8_t /* linkId */, std::set<FrequencyRange>>
        m_interfacesMap; ///< map of the spectrum PHY interfaces to be added to
                         ///< the PHY instance corresponding to a given link ID
};
