 ...
 *
 * This class can create MACs of type ns3::ApWifiMac, ns3::StaWifiMac and
 * ns3::AdhocWifiMac. Its purpose is to allow a WifiHelper to configure and
 * install WifiMac objects on a collection of nodes. The WifiMac objects
 * themselves are mainly composed of TxMiddle, RxMiddle, ChannelAccessManager,
 * FrameExchangeManager, WifiRemoteStationManager, MpduAggregator and
 * MsduAggregartor objects, so this helper offers the opportunity to configure
 * attribute values away from their default values, on a per-NodeContainer
 * basis. By default, it creates an Adhoc MAC layer without QoS. Typically, it
 * is used to set type and attribute values, then hand this object over to the
 * WifiHelper that finishes the job of installing.
 *
...
class WifiMacHelper
{
  public:
     ...
     *
     * \tparam Args \deduced Template type parameter pack for the sequence of
     * name-value pairs. \param type the type of Association Manager \param args A
     ...
     *
     * \tparam Args \deduced Template type parameter pack for the sequence of
     * name-value pairs. \param type the type of MAC queue scheduler \param args A
     * sequence of name-value pairs of the attributes to set.
     */
    template <typename... Args>
     ...
     *
     * \tparam Args \deduced Template type parameter pack for the sequence of
     * name-value pairs. \param type the type of Protection Manager \param args A
     * sequence of name-value pairs of the attributes to set.
     */
    template <typename... Args>
     ...
     *
     * \tparam Args \deduced Template type parameter pack for the sequence of
     * name-value pairs. \param type the type of Acknowledgment Manager \param
     * args A sequence of name-value pairs of the attributes to set.
     */
    template <typename... Args>
     ...
     *
     * \tparam Args \deduced Template type parameter pack for the sequence of
     * name-value pairs. \param type the type of Multi User Scheduler \param args
    ...
    /**
     * Helper function used to set the EMLSR Manager that can be installed on an
     * EHT non-AP MLD.
     *
     * \tparam Args \deduced Template type parameter pack for the sequence of
     * name-value pairs. \param type the type of EMLSR Manager \param args A
     * sequence of name-value pairs of the attributes to set.
     */
    template <typename... Args>
     ...
     *
     * This allows the ns3::WifiHelper class to create MAC objects from
