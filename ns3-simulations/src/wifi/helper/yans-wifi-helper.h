 ...
 * in "Yet Another Network Simulator"; an author-prepared version of this paper
...
class YansWifiChannelHelper
{
  public:
     ...
     * propagation models are dependent of the "txPower" (e.g. Nakagami model),
     * and are therefore not commutative. The final receive power (excluding
     * receiver gains) are calculated in the order the models are added.
     */
