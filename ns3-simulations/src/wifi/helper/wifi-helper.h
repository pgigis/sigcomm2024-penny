 ...
 *
 * This base class must be implemented by new PHY implementation which wish to
 * integrate with the \ref ns3::WifiHelper class.
 */
class WifiPhyHelper : public PcapHelperForDevice, public AsciiTraceHelperForDevice
{
  public:
     ...
     * name-value pairs. \param type the type of interference helper \param args A
     * sequence of name-value pairs of the attributes to set.
     */
     ...
     *
     * \tparam Args \deduced Template type parameter pack for the sequence of
     * name-value pairs. \param type the type of error rate model \param args A
     * sequence of name-value pairs of the attributes to set.
     */
    template <typename... Args>
    ...
    /**
     * \tparam Args \deduced Template type parameter pack for the sequence of
     * name-value pairs. \param linkId ID of the link to configure (>0 only for
     * 11be devices) \param type the type of the error rate model to set. \param
     * args A sequence of name-value pairs of the attributes to set.
     *
     * Set the error rate model and its attributes to use for the given link when
     * Install is called.
     */
    template <typename... Args>
     ...
     *
     * \tparam Args \deduced Template type parameter pack for the sequence of
     * name-value pairs. \param type the type of frame capture model \param args A
     * sequence of name-value pairs of the attributes to set.
     */
    template <typename... Args>
     ...
     * \tparam Args \deduced Template type parameter pack for the sequence of
     * name-value pairs. \param linkId ID of the link to configure (>0 only for
     * 11be devices) \param type the type of the frame capture model to set.
     * \param args A sequence of name-value pairs of the attributes to set.
     *
     * Set the frame capture model and its attributes to use for the given link
     ...
     *
     * \tparam Args \deduced Template type parameter pack for the sequence of
     * name-value pairs. \param type the type of preamble detection model \param
     * args A sequence of name-value pairs of the attributes to set.
     */
    template <typename... Args>
     ...
     * \tparam Args \deduced Template type parameter pack for the sequence of
     * name-value pairs. \param linkId ID of the link to configure (>0 only for
     * 11be devices) \param type the type of the preamble detection model to set.
     * \param args A sequence of name-value pairs of the attributes to set.
     *
     * Set the preamble detection model and its attributes to use for the given
     * link when Install is called.
     */
    template <typename... Args>
    ...
    enum SupportedPcapDataLinkTypes
    {
        ...
        DLT_PRISM_HEADER = PcapHelper::DLT_PRISM_HEADER,        /**< Include Prism monitor
                                                                   mode information */
        DLT_IEEE802_11_RADIO = PcapHelper::DLT_IEEE802_11_RADIO /**< Include Radiotap link layer
                                                                   information */
    };
...
class WifiHelper
{
  public:
     ...
     * control algorithm and both objects using their default attribute values. By
     * default, configure MAC and PHY for 802.11a.
     */
    WifiHelper();
     ...
     *
     * \tparam Args \deduced Template type parameter pack for the sequence of
     * name-value pairs. \param type the type of station manager \param args A
     * sequence of name-value pairs of the attributes to set.
     */
    template <typename... Args>
     ...
     * \param args A sequence of name-value pairs of the attributes to set.
     *
     * Set the remote station manager model and its attributes to use for the
     * given link. If the helper stored a remote station manager model for the
     * first N links only (corresponding to link IDs from 0 to N-1) and the given
     * linkId is M >= N, then a remote station manager model using the given
     * attributes is configured for all links with ID from N to M.
     */
    template <typename... Args>
     ...
     *
     * \tparam Args \deduced Template type parameter pack for the sequence of
     * name-value pairs. \param type the type of OBSS-PD algorithm \param args A
     * sequence of name-value pairs of the attributes to set.
     */
    template <typename... Args>
     ...
     * \code
     * Config::Set ("/NodeList/0/DeviceList/0/$ns3::WifiNetDevice/Mac/Slot",
     * TimeValue (MicroSeconds (slot))); \endcode
     *
     ...
     *
     * \tparam Args \deduced Template type parameter pack for the sequence of
     * name-value pairs. \param args A sequence of name-value pairs of the
     * attributes to set.
     */
    template <typename... Args>
