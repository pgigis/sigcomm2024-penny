 ...
 * papers:
 * <ul>
 * <li>Parrish, "System Design Considerations for Undersea Networks: Link and
 * Multiple Access Protocols" <li>Siderius, "Effects of Ocean Thermocline
 * Variability on Noncoherent Underwater Acoustic Communications" <li>Rao,
 * "Channel Coding Techniques for Wireless Communications", ch 2
 * </ul>
 */
