...
Ns3TcpSocketTestCaseP2P::Ns3TcpSocketTestCaseP2P()
    : TestCase("Check that ns-3 TCP successfully transfers an application data "
               "write of various "
...
Ns3TcpSocketTestCaseCsma::Ns3TcpSocketTestCaseCsma()
    : TestCase("Check to see that ns-3 TCP successfully transfers an "
               "application data write of "
               "various sizes (CSMA)"),
      m_writeResults(false)
{
}
