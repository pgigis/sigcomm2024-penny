 ...
 * \ingroup lr-wpan
 *
 * Contains common parameters about LR-WPAN that can be reused in multiple
 * files. These parameters are defined in the IEEE 802.15.4-2011 standard and
 * adopt the same names as in the standard.
 *
 * @{
 */
...
/**
 * The turnaround time in symbol periods for switching the transceiver from RX
 * to TX or vice-versa. See Table 22 in section 6.4.1 of IEEE 802.15.4-2006
 */
 ...
 * superframe slot. See IEEE 802.15.4-2011, section 6.4.1, Table 51.
 */
...
/**
 * Length of a superframe in symbols. Defaults to aBaseSlotDuration *
 * aNumSuperframeSlots in symbols. See IEEE 802.15.4-2011, section 6.4.1,
 * Table 51.
 */
 ...
 * receiving device to declare a loss of synchronization. See IEEE
 * 802.15.4-2011, section 6.4.1, Table 51.
 */
constexpr uint32_t aMaxLostBeacons{4};

/**
 * The maximum size of an MPDU, in octets, that can be followed by a Short
 * InterFrame Spacing (SIFS) period. See IEEE 802.15.4-2011, section 6.4.1,
 * Table 51.
 */
...
/**
 * The maximum number of octets added by the MAC sublayer to the MAC payload o a
 * a beacon frame. See IEEE 802.15.4-2011, section 6.4.1, Table 51.
 */
