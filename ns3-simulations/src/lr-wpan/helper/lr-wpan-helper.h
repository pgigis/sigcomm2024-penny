...
class LrWpanHelper : public PcapHelperForDevice, public AsciiTraceHelperForDevice
{
  public:
     ...
     * \param useMultiModelSpectrumChannel use a MultiModelSpectrumChannel if
     * true, a SingleModelSpectrumChannel otherwise
     *
    ...
    /**
     * \brief Install a LrWpanNetDevice and the associated structures (e.g.,
     * channel) in the nodes. \param c a set of nodes \returns A container holding
     * the added net devices.
     */
    NetDeviceContainer Install(NodeContainer c);

    /**
     * \brief Creates an PAN with associated nodes and assigned addresses(16 and
     * 64) from the nodes in the node container. The first node in the container
     * becomes the PAN coordinator.
     *
    ...
    /**
     * \brief Transform the LrWpanPhyEnumeration enumeration into a printable
     * string. \param e the LrWpanPhyEnumeration \return a string
     */
