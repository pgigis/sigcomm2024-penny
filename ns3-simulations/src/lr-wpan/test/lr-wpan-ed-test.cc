...
LrWpanEdTestCase::DoRun()
{
    ...
    // Configure the RX Power to be -107.58 dBm, i.e. 1 dB below receiver
    // sensitivity.
    ...
    // Configure the RX Power to be -106.58 dBm, i.e. exectly to receiver
    // sensitivity.
    ...
    // Configure the RX Power to be -81.58 dBm, i.e. 25 dB above receiver
    // sensitivity.
    ...
    // Configure the RX Power to be -66.58 dBm, i.e. 40 dB above receiver
    // sensitivity.
