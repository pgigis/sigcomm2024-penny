...
main(int argc, char* argv[])
{
    ...
    // params2.m_txOptions = TX_OPTION_ACK;  // Enable direct transmission with
    // Ack

    /////////////////////////////////////////////////////////////////////////////////////
    // Examples of time parameters for transmissions in the first incoming
    // superframe. //
    /////////////////////////////////////////////////////////////////////////////////////

    // 2.981 sec      No time to finish CCA in CAP, the transmission at this time
    // will cause
    //                the packet to be deferred to the next superframe.

    // 2.982 sec      No time to finish random backoff delay in CAP, the
    // transmission at this
    //                time will cause the packet to be deferred to the next
    //                superframe.

    // 2.93 sec       Enough time, the packet can be transmitted within the CAP of
