...
NixVectorRoutingTest::DoRun()
{
    ...
    const std::string p_nSrcnAnCnDstv4 =
        ...
        "10.1.0.1                 (Node 0)  ---->   10.1.0.2                 "
        "(Node 1)\n"
        "10.1.4.1                 (Node 1)  ---->   10.1.4.2                 "
        "(Node 3)\n"
        "10.1.3.1                 (Node 3)  ---->   10.1.3.2                 "
        "(Node 4)\n\n";
    ...
    const std::string p_nSrcnAnCnDstv6 =
        "Time: +3s, Nix Routing\n"
        "Route path from Node 0 to Node 4, Nix Vector: 01001 (5 bits left)\n"
        "2001::200:ff:fe00:1      (Node 0)  ---->   fe80::200:ff:fe00:2      "
        "(Node 1)\n"
        "fe80::200:ff:fe00:9      (Node 1)  ---->   fe80::200:ff:fe00:a      "
        "(Node 3)\n"
        "fe80::200:ff:fe00:7      (Node 3)  ---->   2001:3::200:ff:fe00:8    "
        "(Node 4)\n\n";
    ...
    const std::string p_nSrcnAnBnCnDstv6 =
        ...
        "2001::200:ff:fe00:1      (Node 0)  ---->   fe80::200:ff:fe00:2      "
        "(Node 1)\n"
        "fe80::200:ff:fe00:3      (Node 1)  ---->   fe80::200:ff:fe00:4      "
        "(Node 2)\n"
        "fe80::200:ff:fe00:5      (Node 2)  ---->   fe80::200:ff:fe00:6      "
        "(Node 3)\n"
        "fe80::200:ff:fe00:7      (Node 3)  ---->   2001:3::200:ff:fe00:8    "
        "(Node 4)\n\n";
