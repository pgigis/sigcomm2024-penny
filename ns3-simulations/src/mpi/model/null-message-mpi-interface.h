 ...
 * \file
 * \ingroup mpi
 * Declaration of classes ns3::NullMessageSentBuffer and
...
class NullMessageMpiInterface : public ParallelCommunicationInterface, Object
{
  ...
  private:
     ...
     *
     * This method should be called after all links have been added to the
     * RemoteChannelBundle manager to setup any required send and receive buffers.
     */
