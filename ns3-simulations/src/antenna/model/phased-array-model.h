...
class PhasedArrayModel : public Object
{
  public:
    ...
    /**
     * Returns a pointer to the AntennaModel instance used to model the elements
     * of the array \return pointer to the AntennaModel instance
     */
  ...
  protected:
    ...
    static uint32_t m_idCounter;        //!< the ID counter that is used to determine
                                        //!< the unique antenna array ID
