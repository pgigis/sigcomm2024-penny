...
class UniformPlanarArray : public PhasedArrayModel
{
  public:
     ...
     * For example, an antenna with 2 rows and 3 columns will be ordered as
     * follows: ^ z |  3 4 5 |  0 1 2
     * ----------> y
     *
  ...
  private:
    ...
    double m_disV{0.5};        //!< antenna spacing in the vertical direction in
                               //!< multiples of wave length
    double m_disH{0.5};        //!< antenna spacing in the horizontal direction in
                               //!< multiples of wave length
