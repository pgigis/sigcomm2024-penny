...
class Angles
{
  public:
     ...
     * Note: azimuth and inclination angles for a zero-length vector are not
     * defined and are thus initialized to NAN
     *
     ...
     *
     * \param v the point (in cartesian coordinates) for which the angles are
     * determined \param o the origin (in cartesian coordinates) of the spherical
     * coordinate system
     *
     */
  ...
  private:
     ...
     * Warns the user if the Angle is undefined (non-finite azimuth or
     * inclination), throws an assert if the inclination angle is invalid (not in
     * [0, M_PI])
     */
