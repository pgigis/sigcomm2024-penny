...
class PacketSink : public Application
{
  ...
  private:
    ...
    struct AddressHash
    {
         ...
         *
         * It calculates the hash taking the uint32_t hash value of the IPv4 or IPv6
         * address. It works only for InetSocketAddresses (IPv4 version) or
         * Inet6SocketAddresses (IPv6 version)
         */
