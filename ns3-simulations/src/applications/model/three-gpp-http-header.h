 ...
 * ThreeGppHttpServer applications. In received, split packets, only the first
 * packet of transmitted object contains the header, which helps to identify how
 * many bytes are left to be received.
 *
 ...
 * packet is sent by the ThreeGppHttpClient, while the *server TS* field
 * indicates the time when the response packet is sent by the
 * ThreeGppHttpServer.
 */
