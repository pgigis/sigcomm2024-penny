 ...
 * (the 2 first lines of the file should be removed) A valid trace file is a
 * file with 4 columns: \li -1- the first one represents the frame index \li -2-
 * the second one indicates the type of the frame: I, P or B \li -3- the third
 * one indicates the time on which the frame was generated by the encoder
 * (integer, milliseconds) \li -4- the fourth one indicates the frame size in
 * byte
 *
...
class UdpTraceClient : public Application
{
  ...
  private:
    ...
    uint16_t m_maxPacketSize;             //!< Maximum packet size to send (including the
                                          //!< SeqTsHeader)
