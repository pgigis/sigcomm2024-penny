...
UdpClientServerTestCase::UdpClientServerTestCase()
    : TestCase("Test that all the udp packets generated by an udpClient "
               "application are correctly "
...
UdpTraceClientServerTestCase::UdpTraceClientServerTestCase()
    : TestCase("Test that all the udp packets generated by an udpTraceClient "
               "application are "
               "correctly received by an udpServer application")
{
}
...
/**
 * Test that all the PacketLossCounter class checks loss correctly in different
 * cases
 */
...
PacketLossCounterTestCase::PacketLossCounterTestCase()
    : TestCase("Test that all the PacketLossCounter class checks loss "
...
UdpEchoClientSetFillTestCase::UdpEchoClientSetFillTestCase()
    : TestCase("Test that the UdpEchoClient::SetFill class sets packet size "
               "(bug 1378)")
{
}
