...
/**
 * \ingroup packetsink
 * \brief A helper to make it easier to instantiate an
...
class PacketSinkHelper
{
  public:
    /**
     * Create a PacketSinkHelper to make it easier to work with
     * PacketSinkApplications
     *
     ...
     * configured with all the attributes set with SetAttribute.
     *
     * \param nodeName The name of the node on which a PacketSinkApplication will
     * be installed. \returns Container of Ptr to the applications installed.
     */
