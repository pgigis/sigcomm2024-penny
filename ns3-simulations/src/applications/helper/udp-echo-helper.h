...
class UdpEchoClientHelper
{
  public:
     ...
     *
     * \param app Smart pointer to the application (real type must be
     * UdpEchoClient). \param fill The string to use as the actual echo data
     * bytes.
     */
     ...
     *
     * \param app Smart pointer to the application (real type must be
     * UdpEchoClient). \param fill The byte to be repeated in constructing the
     * packet data.. \param dataLength The desired length of the resulting echo
     * packet data.
     */
     ...
     *
     * \param app Smart pointer to the application (real type must be
     * UdpEchoClient). \param fill The fill pattern to use when constructing
     * packets. \param fillLength The number of bytes in the provided fill
     * pattern. \param dataLength The desired length of the final echo data.
     */
