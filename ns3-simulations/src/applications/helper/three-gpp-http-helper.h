 ...
 * Helper to make it easier to instantiate an ThreeGppHttpClient on a set of
 * nodes.
 */
class ThreeGppHttpClientHelper
{
  public:
    /**
     * Create a ThreeGppHttpClientHelper to make it easier to work with
     * ThreeGppHttpClient applications. \param address The address of the remote
     * server node to send traffic to.
     */
    ...
    /**
     * Install a ThreeGppHttpClient on each node of the input container configured
     * with all the attributes set with SetAttribute(). \param c NodeContainer of
     * the set of nodes on which an ThreeGppHttpClient will be installed. \return
...
/**
 * \ingroup http
 * Helper to make it easier to instantiate an ThreeGppHttpServer on a set of
 * nodes.
 */
