...
class FlowMonitorHelper
{
  public:
    ...
    /**
     * \brief Retrieve the FlowClassifier object for IPv4 created by the Install*
     * methods \returns a pointer to the FlowClassifier object
     */
    Ptr<FlowClassifier> GetClassifier();

    /**
     * \brief Retrieve the FlowClassifier object for IPv6 created by the Install*
     * methods \returns a pointer to the FlowClassifier object
     */
