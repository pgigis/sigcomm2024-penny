  ...
  private:
    ...
    class EchoRequestData
    {
      public:
         ...
         * \param ackedPar True if the Echo request has been acknowledged at least
         * once.
         */
    ...
    /// All sent but not answered packets. Map icmp seqno -> when sent, acked at
    /// least once.
    ...
    /// App signature: ID of the node where the app is installed || ID of the
    /// Application.
