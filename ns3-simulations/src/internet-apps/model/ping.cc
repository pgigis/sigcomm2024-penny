    ...
    static TypeId tid =
        TypeId("ns3::Ping")
            ...
            .AddAttribute("Interval",
                          ...
                          MakeTimeChecker())
            .AddAttribute("Size",
                          "The number of data bytes to be sent, before ICMP and "
...
Ping::Send()
{
    ...
    else
    {
        ...
        // Loose routing could have changed (temporarily) the protocol. Set it again
...
Ping::PrintReport()
{
    ...
    if (m_verbose == VerboseMode::VERBOSE || m_verbose == VerboseMode::QUIET)
    {
        ...
        // note: integer math to match Linux implementation and avoid turning
        // a 99.9% into a 100%.
    ...
    // note: integer math to match Linux implementation and avoid turning a 99.9%
    // into a 100%.
