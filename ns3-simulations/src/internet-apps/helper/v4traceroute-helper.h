 ...
 *
 * This class creates one or multiple instances of ns3::V4TraceRoute and
 * associates it/them to one/multiple node(s).
 */
class V4TraceRouteHelper
{
  public:
    /**
     * Create a V4TraceRouteHelper which is used to make life easier for people
     * wanting to use TraceRoute
     *
    ...
    /**
     * Install a TraceRoute application on each Node in the provided
     * NodeContainer.
     *
     * \param nodes The NodeContainer containing all of the nodes to get a
     * V4TraceRoute application.
     *
    ...
    /**
     * Install a TraceRoute application on the provided Node.  The Node is
     * specified directly by a Ptr<Node>
     *
     * \param node The node to install the V4TraceRouteApplication on.
     *
     * \returns An ApplicationContainer holding the TraceRoute application
     * created.
     */
    ...
    /**
     * Install a TraceRoute application on the provided Node.  The Node is
     * specified by a string that must have previously been associated with a Node
