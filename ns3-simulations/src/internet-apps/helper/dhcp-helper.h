 ...
 *
 * \class DhcpHelper
 * \brief The helper class used to configure and install DHCP applications on
 * nodes
 */
class DhcpHelper
{
  public:
     ...
     *
     * \param netDevice The NetDevice on which DHCP server application has to be
     * installed \param serverAddr The Ipv4Address of the server \param poolAddr
     * The Ipv4Address (network part) of the allocated pool \param poolMask The
     * mask of the allocated pool \param minAddr The lower bound of the
     * Ipv4Address pool \param maxAddr The upper bound of the Ipv4Address pool
  ...
  private:
     ...
     * \param netDevice The NetDevice on which DHCP client application has to be
     * installed \return The pointer to the installed DHCP client
     */
