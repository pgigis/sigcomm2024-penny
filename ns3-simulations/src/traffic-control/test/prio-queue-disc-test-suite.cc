...
class PrioQueueDiscTestFilter : public PacketFilter
{
  ...
  private:
    ...
    bool m_cls;    //!< whether this filter is able to classify a
                   //!< PrioQueueDiscTestItem
...
PrioQueueDiscTestCase::DoRun()
{
    ...
    /*
     * Test 2: classify packets based on priomap because no packet filter is
     * installed
     */
    ...
    /*
     * Test 4: classify packets based on the value returned by the installed
     * packet filter
     */
    ...
    /*
     * Test 5: classify packets into the band specified by the first element of
     * the priomap array because the value returned by the installed packet filter
     * is not less than the number of bands
     */
