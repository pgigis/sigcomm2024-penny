                                                   ...
                                                   uint32_t nDbeBytes)
{
    ...
    NS_TEST_ASSERT_MSG_EQ(stats.nTotalDroppedPacketsBeforeEnqueue,
                          nDbePackets,
                          "Verify that the number of packets dropped before "
                          "enqueue is computed correctly");
    NS_TEST_ASSERT_MSG_EQ(m_counter[qd].m_nDbePackets,
                          nDbePackets,
                          "Verify that the number of packets dropped before "
                          "enqueue is computed correctly");

    NS_TEST_ASSERT_MSG_EQ(stats.nTotalDroppedBytesBeforeEnqueue,
                          nDbeBytes,
                          "Verify that the number of bytes dropped before "
                          "enqueue is computed correctly");
    NS_TEST_ASSERT_MSG_EQ(m_counter[qd].m_nDbeBytes,
                          nDbeBytes,
                          "Verify that the number of bytes dropped before "
                          "enqueue is computed correctly");
}
                                                  ...
                                                  uint32_t nDadBytes)
{
    ...
    NS_TEST_ASSERT_MSG_EQ(stats.nTotalDroppedPacketsAfterDequeue,
                          nDadPackets,
                          "Verify that the number of packets dropped after "
                          "dequeue is computed correctly");
    NS_TEST_ASSERT_MSG_EQ(m_counter[qd].m_nDadPackets,
                          nDadPackets,
                          "Verify that the number of packets dropped after "
                          "dequeue is computed correctly");

    NS_TEST_ASSERT_MSG_EQ(stats.nTotalDroppedBytesAfterDequeue,
                          nDadBytes,
                          "Verify that the number of bytes dropped after dequeue "
                          "is computed correctly");
    NS_TEST_ASSERT_MSG_EQ(m_counter[qd].m_nDadBytes,
                          nDadBytes,
                          "Verify that the number of bytes dropped after dequeue "
                          "is computed correctly");
}
