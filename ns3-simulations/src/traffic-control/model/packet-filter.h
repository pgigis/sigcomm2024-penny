...
class PacketFilter : public Object
{
  public:
    ...
    /**
     * Standard value used by packet filters to indicate that no match was
     * possible.
     */
     ...
     *
     * \return -1 if this filter is not able to classify packets of the same
     * protocol as item or the item does not match the filter conditions, the
     * configured return value otherwise.
     */
  ...
  private:
     ...
     * \param item the packet to classify.
     *
     * \return -1 if the item does not match the filter conditions, or the
     * configured return value otherwise.
     */
