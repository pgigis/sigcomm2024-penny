...
/*
 * This is a basic example that compares CoDel and PfifoFast queues using a
 * simple, single-flow topology:
 *
 * source -------------------------- router ------------------------ sink
 ...
 * protocol. Packets transmitted during a simulation run are captured into a
 * .pcap file, and congestion window values are also traced.
 */
