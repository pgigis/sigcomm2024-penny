 ...
 * This section documents the API of the ns-3 click module. For a generic
...
class Ipv4ClickRouting : public Ipv4RoutingProtocol
{
  ...
  public:
    ...
    /**
     * \brief Name of the routing table element being used by Click. Required for
     * RouteOutput () \param name Name of the routing table element.
     */
  ...
  private:
    ...
    /**
     * \brief Provide a mapping between the node reference used by Click and the
     * corresponding Ipv4ClickRouting instance.
     */
    static std::map<simclick_node_t*, Ptr<Ipv4ClickRouting>> m_clickInstanceFromSimNode;

  public:
    /**
     * \brief Allows the Click service methods, which reside outside
     * Ipv4ClickRouting, to get the required Ipv4ClickRouting instances. \param
     * simnode The Click simclick_node_t instance for which the Ipv4ClickRouting
     * instance is required \return A Ptr to the required Ipv4ClickRouting
     * instance
     */
  ...
  private:
    /**
     * \brief Used internally in DoInitialize () to Add a mapping to
     * m_clickInstanceFromSimNode mapping
     */
    ...
    /**
     * \brief This method has to be scheduled every time Click calls
     * SIMCLICK_SCHEDULE
     */
    void RunClickEvent();
  ...
  public:
    ...
    /**
     * \brief Allow a higher layer to send data through Click. (From
     * Ipv4ExtRouting) \param p The packet to be sent \param src The source IP
     * Address \param dest The destination IP Address
     */
