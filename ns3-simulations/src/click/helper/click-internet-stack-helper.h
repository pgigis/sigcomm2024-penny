...
class ClickInternetStackHelper : public PcapHelperForIpv4, public AsciiTraceHelperForIpv4
{
  public:
    /**
     * Create a new ClickInternetStackHelper which uses Ipv4ClickRouting for
     * routing
     */
    ...
    /**
     * Aggregate implementations of the ns3::Ipv4L3ClickProtocol,
     * ns3::ArpL3Protocol, ns3::Udp, and ns3::Tcp classes onto the provided node.
     * This method will assert if called on a node that already has an Ipv4 object
     * aggregated to it.
     *
     ...
     * ns3::Ipv4L3ClickProtocol, ns3::ArpL3Protocol, ns3::Udp, and, ns3::Tcp
     * classes. The program will assert if this method is called on a container
     * with a node that already has an Ipv4 object aggregated to it.
     *
  ...
  private:
     ...
     * tracing. \param explicitFilename Whether the filename is explicit or not.
     */
