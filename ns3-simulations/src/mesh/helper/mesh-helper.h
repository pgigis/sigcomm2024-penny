...
class MeshHelper
{
  public:
    /**
     * Construct a MeshHelper used to make life easier when creating 802.11s
     * networks.
     */
    MeshHelper();
     ...
     * \param c NetDeviceContainer of the set of devices for which the mesh
     * devices should be modified to use a fixed stream \return the number of
     * stream indices assigned by this helper
     */
