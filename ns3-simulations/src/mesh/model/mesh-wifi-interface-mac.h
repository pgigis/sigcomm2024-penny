 ...
 * \ingroup mesh
 *
 * \brief Basic MAC of mesh point Wi-Fi interface. Its function is extendable
 * through plugins mechanism.
 *
...
class MeshWifiInterfaceMac : public WifiMac
{
  public:
     ...
     * \return TBTT time
     *
     * This is supposed to be used by any entity managing beacon collision
     * avoidance (e.g. Peer management protocol in 802.11s)
     */
    Time GetTbtt() const;
    /**
     * \brief Shift TBTT.
    ...
    /*
     * Channel center frequency = Channel starting frequency + 5 * channel_id
     * (MHz), where Starting channel frequency is standard-dependent as defined in
     * IEEE 802.11-2007 17.3.8.3.2.
     *
