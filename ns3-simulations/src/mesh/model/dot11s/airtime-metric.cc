                                             ...
                                             Ptr<MeshWifiInterfaceMac> mac)
{
     ...
     * o  -- the PHY dependent channel access which includes frame headers,
     * training sequences, access protocol frames, etc. bt -- the test packet
     * length in bits (8192 by default), r  -- the current bitrate of the packet,
     *
     * Final result is expressed in units of 0.01 Time Unit = 10.24 us (as
     * required by 802.11s draft)
     */
