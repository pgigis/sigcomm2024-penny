    ...
    static TypeId tid =
        TypeId("ns3::dot11s::HwmpProtocol")
            ...
            .AddAttribute("Dot11MeshHWMPmaxPREQretries",
                          "Maximum number of retries before we suppose the "
            ...
            .AddAttribute("Dot11MeshHWMPnetDiameterTraversalTime",
                          "Time we suppose the packet to go from one edge of the network "
                          "to another",
