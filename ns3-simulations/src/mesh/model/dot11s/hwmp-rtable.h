...
class HwmpRtable : public Object
{
  ...
  public:
    ...
    /**
     * Find proactive path to tree root. Note that calling this method has side
     * effect of deleting expired proactive path \return The lookup result
     */
    ...
    /**
     * When peer link with a given MAC-address fails - it returns list of
     * unreachable destination addresses \param peerAddress the peer address
