...
class IeBeaconTimingUnit : public SimpleRefCount<IeBeaconTimingUnit>
{
  ...
  private:
    ...
    uint8_t m_aid;
    /// Last time we received a beacon in accordance with a local TSF measured in
    /// 256 microseconds unit
...
class IeBeaconTiming : public WifiInformationElement
{
  public:
    /**
     * \ingroup dot11s
     * This type is a list of timing elements obtained from neighbours with their
     * beacons:
     */
