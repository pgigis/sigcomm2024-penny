...
class SixLowPanIphc : public Header
{
  public:
     ...
     * \param [in] nhField False (Next Header carried in-line), true (compressed
     * NH).
     */
     ...
     * \param srcInlinePart The inline portion of the compressed source address
     * (16 bytes) \param size The number of inline bytes
     */
     ...
     * \param dstInlinePart The inline portion of the compressed destination
     * address (16 bytes) \param size The number of inline bytes
     */
...
class SixLowPanUdpNhcExtension : public Header
{
  public:
     ...
     * \param [in] cField False (All checksum carried in-line), true (Checksum
     * elided).
     */
...
class SixLowPanMesh : public Header
{
  public:
     ...
     * \param [in] originator The Originator address (Mac64Address or
     * Mac16Address).
     */
     ...
     * \param [in] finalDst The Final Destination address (Mac64Address or
     * Mac16Address).
     */
