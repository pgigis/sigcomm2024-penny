...
class AdhocAlohaNoackIdealPhyHelper
{
  public:
    ...
    /**
     *
     * @param txPsd the Power Spectral Density to be used for transmission by all
     * created PHY instances
     */
    void SetTxPowerSpectralDensity(Ptr<SpectrumValue> txPsd);

    /**
     *
     * @param noisePsd the Power Spectral Density to be used for transmission by
     * all created PHY instances
     */
