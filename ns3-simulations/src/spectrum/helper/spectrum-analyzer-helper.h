...
class SpectrumAnalyzerHelper
{
  public:
    ...
    /**
     * Set the SpectrumChannel that will be used by SpectrumPhy instances created
     * by this helper
     *
     * @param channel
     */
    ...
    /**
     * Set the spectrum model used by the created SpectrumAnalyzer instances to
    ...
    /**
     * Enable ASCII output. This will create one filename for every created
     * SpectrumAnalyzer instance.
     *
     * @param prefix the prefix of the filename of the traces that will be
     * created.
     */
