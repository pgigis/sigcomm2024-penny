 ...
 * \param params A structure that holds the parameters that are needed to
 * perform calculations in ComputeSnr
 */
static void
...
main(int argc, char* argv[])
{
    ...
    // create and configure the factories for the channel condition and
