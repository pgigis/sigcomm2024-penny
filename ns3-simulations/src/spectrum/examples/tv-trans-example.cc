...
main(int argc, char** argv)
{
    ...
    nodePositionList->Add(Vector(128000.0,
                                 0.0,
                                 0.0)); // TV Transmitter 1; 128 km away from spectrum analyzer
    nodePositionList->Add(Vector(0.0,
                                 24000.0,
                                 0.0)); // TV Transmitter 2; 24 km away from spectrum analyzer
    ...
    // 22.22 dBm/Hz from 1000 kW ERP transmit power, flat 6 MHz PSD spectrum
