...
class SpectrumValue : public SimpleRefCount<SpectrumValue>
{
  public:
     ...
     *
     * @param sm pointer to the SpectrumModel which implements the set of
     * frequencies to which the values will be referring.
     *
    ...
    /**
     * Subtract the Right Hand Side of the operator from *this, component by
     * component
     *
     * @param rhs the Right Hand Side
     *
    ...
    /**
     * Multiply *this by the Right Hand Side of the operator, component by
     * component
     *
     * @param rhs the Right Hand Side
     *
