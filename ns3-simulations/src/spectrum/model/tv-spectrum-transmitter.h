...
class TvSpectrumTransmitter : public SpectrumPhy
{
  ...
  private:
    ...
    double m_basePsd;           //!< Base power spectral density value (in dBm/Hz) of TV
                                //!< transmitter's signal
    Ptr<SpectrumValue> m_txPsd; //!< Pointer to power spectral density of TV
                                //!< transmitter's signal
    Time m_startingTime;        //!< Timepoint after simulation begins that TV
                                //!< transmitter will begin transmitting
    Time m_transmitDuration;    //!< Length of time that TV transmitter will
                                //!< transmit for
