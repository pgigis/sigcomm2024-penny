...
class SpectrumConverter : public SimpleRefCount<SpectrumConverter>
{
  ...
  private:
    ...
    std::vector<size_t> m_conversionColInd; //!< column of each non-zero element
                                            //!< in m_conversionMatrix

    Ptr<const SpectrumModel> m_fromSpectrumModel; //!<  the SpectrumModel this SpectrumConverter
                                                  //!<  instance can convert from
    Ptr<const SpectrumModel> m_toSpectrumModel;   //!<  the SpectrumModel this SpectrumConverter
                                                  //!<  instance can convert to
};
