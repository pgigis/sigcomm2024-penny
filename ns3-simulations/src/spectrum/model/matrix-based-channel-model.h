...
class MatrixBasedChannelModel : public Object
{
  public:
    ...
    struct ChannelParams : public SimpleRefCount<ChannelParams>
    {
        ...
        /**
         * The first element is the s-node ID (the transmitter when the channel
         * params were generated), the second element is the u-node ID (the receiver
         * when the channel params were generated generated).
         */
        std::pair<uint32_t, uint32_t> m_nodeIds;
     ...
     * where the order does not matter, i.e., the same value will be returned for
     * (a,b) and (b,a). \param a the first value \param b the second value \return
