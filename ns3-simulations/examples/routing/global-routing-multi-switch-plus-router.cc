...
main(int argc, char* argv[])
{
    ...
    Ptr<Node> ts4 = CreateObject<Node>(); // <no IP>     : Top switch #4 (bridge)
                                          //             :
    Ptr<Node> tr = CreateObject<Node>();  // 192.168.1.1 : Router connecting top
                                          // LAN & WAN 76.1.1.1    :
                                          //             :
    Ptr<Node> br = CreateObject<Node>();  // 76.1.1.2    : Router connecting WAN &
                                          // bottom LANs 192.168.2.1 :
                                          //             :
    ...
    Ptr<Node> b3 = CreateObject<Node>(); // 192.168.2.3 : Bottom single-switch udp
                                         // echo client
                                         // - - - - - - - - - - - - - - - -
