 ...
 *
 * \param enableCtsRts if true, enable RTS/CTS for packets larger than 100
 * bytes. \param wifiManager WiFi manager to use.
 */
void
experiment(bool enableCtsRts, std::string wifiManager)
{
    ...
    // athstats.EnableAthstats(enableCtsRts ? "rtscts-athstats-node" :
    // "basic-athstats-node" , nodes);
